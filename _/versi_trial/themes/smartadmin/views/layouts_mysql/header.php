...
/*konfigurasi yang disesuaikan dari SmartAdmin*/
	...
	$page_body_prop = array(
			"class"=>"fixed-ribbon smart-style-3 fixed-header",
			"style"=>"font-family: Montserrat, 'Open Sans',Arial,Helvetica,Sans-Serif"
		); //optional properties for <body>
	if( defined('LOGIN') )
		$page_body_prop = array(
			"id"=>"login",
			"class"=>"animated fadeInDown bg",
			"style"=>"min-height: 618px; background: url(".ASSETS_URL."/img/images/bg.jpg);background-size:cover;"
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo ASSETS_URL; ?>/css/font-oswald.css">
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo ASSETS_URL; ?>/css/font-montserrat.css">
		<?php /*<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=Oswald|Montserrat">*/ ?>
		<style type="text/css">
		...
		<header id="header" style="background-image: linear-gradient(to bottom,#1B7150,rgba(32, 139, 103, 1));border-bottom: 2px solid #D5C7C7;box-shadow: 1px 1px 2px #DDDB18;">
				...
				<!-- search mobile button (this is hidden till mobile view port) -->
						...
						<?php if (!Yii::app()->user->isGuest): ?>
							...
							<div id="tampil-berkas" class="btn-header pull-right" style="<?php //echo $displ; ?>">
								<span>
									<a href="#" id="cek_berkas" onclick="cekBelumDataPajak();cekBelumPenetapanPajak();cekBelumPenyetoranPajak();cekBelumVerifikasi();cekBerkasTolak();cekBPHTBTerbayar();" title="Cek Berkas">Cek Berkas</a>
								</span>
							</div>
						<?php endif ?>
			...
			<div id="shortcut">
				<ul>
					...
					<?php if (Tblrole::isRole("BO")): ?>
					<li>
						<a href="#pendaftaran/berkas/belumverifikasi" class="jarvismetro-tile big-cubes double bg-color-magenta">
							<span class="badge  bounceIn animated bg-color-red pull-right" id="number_of_bphtbdatax" style="padding: 10px!important;">0</span>
							<span class="iconbox"> <i class="fa fa-book fa-4x"></i>
								<span class="text-align-center">Berkas BPHTB Masuk</span>
							</span>
						</a>
					</li>
					<?php endif; ?>

					<?php if (Tblrole::isRole("NOTARIS")): ?>
					<li>
						<a href="#pendaftaran/berkas/berkastolakbphtb" class="jarvismetro-tile big-cubes double bg-color-yellow">
							<span class="badge  bounceIn animated bg-color-red pull-right" id="number_of_tolakbphtbdatax" style="padding: 10px!important;">0</span>
							<span class="iconbox"> <i class="fa fa-book fa-4x"></i>
								<span class="text-align-center">Data BPHTB Ditolak </span>
							</span>
						</a>
					</li>

					<li>
						<a href="#pendaftaran/berkas/berkasterbayar" class="jarvismetro-tile big-cubes double bg-color-green">
							<span class="badge  bounceIn animated bg-color-red pull-right" id="number_of_bayarx" style="padding: 10px!important;">0</span>
							<span class="iconbox"> <i class="fa fa-book fa-4x"></i>
								<span class="text-align-center">Data BPHTB Terbayar</span>
							</span>
						</a>
					</li>
					<?php endif ?>

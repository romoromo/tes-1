		...
		<div class="row" >
			...
			<article class="col-sm-12 col-md-4 col-lg-4">
				...
				<div class="well no-padding">
					<form action="" id="login-form" class="smart-form client-form" style="box-shadow: 0px 0px 6px #D5C2C2;">

						<fieldset>
							<section>
								<center>
									<p class="text-center" style="color: initial;" style="color: initial;font-size: 14px;"><strong style="font-size: 18px;">Sistem Informasi Manajemen Pajak Daerah </strong></p>
									<p><strong style="font-size: 16px;">Badan Pengelolaan Keuangan dan Aset Daerah</strong></p>
				...
				<p align="center" style="color: black;">2017 © Badan Pengelolaan Keuangan dan Aset Daerah.</p>

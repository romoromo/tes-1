...
jQuery(document).ready(function($) {
    $("#smart-menu-on-top").prop('checked', true)
    $("body").removeClass('fixed-navigation');
    if (localStorage['posisimenu'] == 'menu-on-top') {
 ...
 * Menu Bar Setting
 */
$("#smart-menu-on-top").click(function(){
    if($("#smart-menu-on-top").prop('checked')) {
        localStorage['posisimenu']='menu-on-top';
        $("body").addClass('menu-on-top');
    } else {
        localStorage['posisimenu']='';
        $("body").removeClass('menu-on-top');
    }
})

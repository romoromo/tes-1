  ...
  <center>
	<div style="max-width:1000px; padding:5px;">
		<table width="90%" class="outer" cellspacing="0">
			...
			<tr>
			  <td>1.</td>
			  <td colspan="5">Harap penyetoran dilakukan melalui Bendahara Penerimaan Dispenda Kota Tegal </td>
			  <td colspan="2">&nbsp;</td>
		  </tr>
			<tr>
			  <td>2.</td>
			...
			<tr>
			  <td>&nbsp;</td>
			  <td colspan="5">kantor Dispenda Kota Tegal, setiap hari jam kerja </td>
			  <td colspan="2">&nbsp;</td>
		  </tr>
			<tr>
			  <td>&nbsp;</td>
			...
			<tr>
			  <td>&nbsp;</td>
			  <td colspan="4">&nbsp;</td>
			  <td colspan="3" align="center">KOTA TEGAL </td>
		  </tr>
			<tr>
			  <td>&nbsp;</td>
			  <td colspan="4">&nbsp;</td>

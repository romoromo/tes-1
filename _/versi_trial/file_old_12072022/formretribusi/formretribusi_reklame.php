<form id="form-retribusi" class="smart-form ng-pristine ng-valid">
	...
	<fieldset id="sss">
		<div>
			...
			<div id="jumlah_minggu" class="col col-md-12" style="display: none;">
				...
				<div class="form-group">
					...
					<label class="col col-2">
					<label class="input">
						<input id="tblretribusireklame_jumlahminggu" name="param[tblretribusireklame_jumlahminggu]" type="text" class="form-control text-align-right format-ribuan" placeholder="Jumlah Minggu">
					</label>
					</label>
				</div>
				...
				<div class="form-group">
					<div id="harga_baliho" style="display: none;">
						<label class="col control-label">Rp. 7000/hari</label>
					</div>
					<div id="harga_kain" style="display: none;">
						<label class="col control-label">Rp. 3500/hari</label>
					</div>
				</div>
			...
			<div id="jumlah_reklame" class="col col-md-12" style="display: none;">
				<div class="form-group">
					<label class="col control-label"> Jumlah Reklame</label>
					<label class="col control-label">:</label>
					<label class="col col-2">
					<label class="input">
						<input id="tblretribusireklame_jumlahreklame" name="param[tblretribusireklame_jumlahreklame]" type="text" class="form-control text-align-right format-ribuan" placeholder="Jumlah Reklame">
					</label>
					</label>
				</div>
			<br>
			...
			<div class="col col-md-12">
				<div class="form-group">
					...
					<div id="tarif_jalan">
						<label class="col control-label">X</label>
						<label class="col col-2 control-label">Tarif Jalan </label>
					</div>
					<div id="jumlah_reklame_label" style="display: none;">
						<label class="col control-label">X</label>
						<label class="col col-2 control-label">Jumlah Reklame</label>
						<label class="col control-label">X</label>
						<label class="col col-2 control-label">Tarif Perminggu</label>
					</div>
				</div>
				<label class="col control-label"></label>
			<br>
			...
			<div class="col col-md-12">
				<div class="form-group">
					...
					<div id="label_tarif_jalan">
						<label class="col control-label">X</label>
						<label class="col col-2 control-label retribusitarif">. . . . .</label>
					</div>
					<div id="retribusihari_total_label" style="display: none;">
						<label class="col control-label">X</label>
						<label class="col col-2 control-label jumlahreklame">. . . . .</label>
						<label class="col control-label">X</label>
					...
					<input type="hidden" name="param[tblretribusireklame_jumlahreklame]" id="tblretribusireklame_jumlahreklame">
					<input type="hidden" name="param[tblretribusireklame_jumlahminggu]" id="tblretribusireklame_jumlahminggu">
				</div>
				<label class="col control-label"></label>
			<br>
			<br>
	...
	<script type="text/javascript">
		...
		$("#pendataanreklame_kodelokasi").change(function(event) {
			...
			$.ajax({
					...
					success: function (respon) {
						...
						keterangan = $("#retrefjenisreklame_id option:selected").attr('keterangan');

						if (keterangan=='Non Permanen') {
							setTimeout(function() {
							$("#jumlah_minggu").show('slow');
							$("#jumlah_reklame").show('slow');
							$("#jumlah_reklame_label").show('slow');
							$("#retribusihari_total_label").show('slow');

							$("#tarif_jalan").hide('slow');
							$("#label_tarif_jalan").hide('slow');

							if (respon.refjenisreklame_id==1) {
								$("#harga_baliho").show('slow');
								$("#harga_kain").hide('slow');
							} else if (respon.refjenisreklame_id==2 || refjenisreklame_id==12 || refjenisreklame_id==16) {
								$("#harga_kain").show('slow');
								$("#harga_baliho").hide('slow');
							}
							...
							setTimeout(function() {
							$("#jumlah_minggu").hide('slow');
							$("#jumlah_reklame").hide('slow');
							$("#jumlah_reklame_label").hide('slow');
							$("#retribusihari_total_label").hide('slow');
		...
		function hitungRetribusiRekl() {
			...
			if (keterangan=='Permanen') {
				...
				, jumlh_minggu = $("#tblretribusireklame_jumlahminggu").val()

				, total_minggu = jumlh_minggu*7
				, tarifperminggu = total_minggu*tarifperhari

				, jumlahrek = $("#tblretribusireklame_jumlahreklame").val()

				// , total = luas*tarif*tarifperminggu*jumlahrek
				, total = luas*tarifperminggu*jumlahrek
				;
			...
			$(".jumlahreklame").html(jumlahrek);

			$(".retribusihari").html(toRp(tarifperminggu));
			
			$("#tblretribusireklame_total").val(total);
			$(".retribusittotal").html(toRp(total));
			$("#tbltransaksiretribusi_pajak").val(total);
		}
		$("#rettblpendataanreklame_lebar, #rettblpendataanreklame_ketinggian, #tblretribusireklame_jumlahreklame, #tblretribusireklame_jumlahminggu").keyup(function(event) {
			hitungRetribusiRekl();
		});

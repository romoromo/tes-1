	...
	<fieldset id="sss">
		<div>
			...
			<div class="col col-md-12">
				...
				<div class="form-group">
					<label class="col control-label">Tarif</label>
					<label class="col control-label">:</label>
					<label class="col col-2">
					<label class="input">
						<input id="rettblpendataanreklame_tarif" name="param[tblretribusireklame_tarif]" type="text" class="form-control text-align-right format-ribuan" placeholder="Tarif Reklame">
					</label>
					</label>
				</div>
			</div>
			...
			<div class="col col-md-12">
			  <div class="form-group">
					...
					<label class="col control-label">X</label>
					<label class="col col-2 control-label">Tarif Pajak</label>
				</div>
				<label class="col control-label"></label>
			</div>

			...
			<div class="col col-6" style="border-right: 1px solid #000;">
				...
				<div class="row" >
					...
					<div class="col col-6">
						...
						<label class="input">
							<input value="<?= "1" ?>" type="text" name="param[tbltransaksiketetapan_notransaksi]" id="tbltransaksiketetapan_notransaksi" placeholder="No Transaksi (default: 1)" maxlength="4" />
...
<script type="text/javascript">
	...
	function hitungPajak() {
		...
		omzmin = <?= ($omzmin = $rek['tblmasterrekening_omzetminimal'])!=null ? $omzmin : 0; ?>;
		if (omzet1 <= omzmin) {
			pajak = 0;
		}

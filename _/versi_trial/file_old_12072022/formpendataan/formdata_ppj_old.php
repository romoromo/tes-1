	...
	<fieldset id="sss">
		<div>
			<div class="col col-6" style="border-right: 1px solid #000;">
				...
				<div class="row" >
					...
					<div class="col col-6">
						...
						<label class="input">
							<input type="text" name="param[tbltransaksiketetapan_notransaksi]" id="tbltransaksiketetapan_notransaksi" placeholder="No Transaksi" maxlength="4" />
			...
			<section class="col col-6 pull-right">
				<div class="row" >
					<div class="col col-6">
						<label for="label" class="input">Besar Omzet Industri</label>
						<label class="input">
							<input class="format-rupiah" type="text" name="param[tbltransaksiketetapan_omzetindustri]" id="tbltransaksiketetapan_omzetindustri" placeholder="Besar Omzet Industri" />
				...
				<div class="row" >
					<div class="col col-8">
						...
						<label class="input">
							<input class="disabled format-rupiah" readonly="" type="text" name="param[tbltransaksiketetapan_pajak]" id="tbltransaksiketetapan_pajak" placeholder="Nominal Besaran Pajak" />
							<i class="icon-append fa fa-money "></i>
						</label>
					</div>
				</div>
...
<script type="text/javascript">
	...
	$("#tbltransaksiketetapan_omzetindustri, #tbltransaksiketetapan_omzetnonindustri,#tbltransaksiketetapan_omzetnonindustri, #tbltransaksiketetapan_tarif, #tbltransaksiketetapan_tarifnonid, #tbltransaksiketetapan_rupiahdenda").keyup(function(event) {
		hitungPajak();
	});

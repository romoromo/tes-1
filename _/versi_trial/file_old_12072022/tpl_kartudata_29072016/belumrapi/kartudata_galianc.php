...
<body>
  <table width="100%" border="0" style="border-collapse:collapse">
    <tr>
      <td colspan="10"><div align="center" class="style3">KARTU DATA PAJAK MINERAL BUKAN LOGAM DAN BEBATUAN <br />
        ...
        <tr>
          <td colspan="10"><table width="100%" border="1" cellpadding="3" cellspacing="0" style="border-collapse:collapse">
            <tr>
              ...
              <td width="94" class="style5"><div align="center">Nama Bahan </div></td>
              <td width="94" class="style5"><div align="center">Volume Tonase </div></td>
              <td width="94" class="style5"><div align="center">Harga Standar </div></td>
              <td width="94" class="style5"><div align="center">Omzet</div></td>
              ...
              <td width="78" class="style5"><div align="center">Tanggal Setor </div></td>
              <td width="78" class="style5"><div align="center">No. Bukti Setor </div></td>
    ...
    <div class="dotter">	
      <table width="100%" border="0" style="border-collapse:collapse">
        <tr>
          <td colspan="10"><p class="style5">Keterangan : <br />27 : PASIR DAN KERIKIL<br />40 : TANAH TIMBUN/PASIR TIMBUN<br /></p>
            <p class="style5">Hasil Pemeriksaan : </p></td>
          </tr>
        </table>
      </div>
      <div class="dotter">	

...
<body>
  <table width="100%" border="0" style="border-collapse:collapse">
    <tr>
      <td colspan="10"><div align="center" class="style3">KARTU DATA PAJAK RESTO<br />
    ...
    <div class="dotter">	
      <table width="100%" border="0" style="border-collapse:collapse">
        <tr>
          <td colspan="10"><span class="style5">OBJEK RESTORAN : <?php echo "--" ?></span></td>
        </tr>
      </table>
    </div>
    <div class="dotter">	
      <table width="100%" border="0" style="border-collapse:collapse">
        <tr>
          ...
          <td width="229"><span class="style5">E. Nomor SPTPD Yang Dikirim </span></td>
          <td width="10"><span class="style5">:</span></td>
          <td width="10" colspan="3"><span class="style5"><?php echo $data['surat']['tblobyek_nomorsptpd'] ?></span><span class="style5"></span><span class="style5"></span></td>
        </tr>
        <tr>
          <td><span class="style5">B. Tarif Pajak Sesuai Perda </span></td>
          <td><span class="style5">:</span></td>
          <td><span class="style5"><?php echo $data['surat']['tblmasterrekening_tarif']*100 ?>%</span></td>
          <td colspan="2"><span class="style5"></span><span class="style5"></span></td>
          <td><span class="style5">F. Tanggal Kirim SPTPD </span></td>
          <td><span class="style5">:</span></td>
          <td colspan="3"><span class="style5"><?php echo $tgl->TanggalHari($data['surat']['tgl_kirim']) ?></span><span class="style5"></span><span class="style5"></span></td>
        </tr>
        <tr>
          <td><span class="style5">C. Menggunakan Kas Register </span></td>
          <td><span class="style5">:</span></td>
          <td><span class="style5"><?php echo $list['tbltransaksiketetapan_isregister']=="T" ? "Ya" : "Tidak" ?></span></td>
          <td colspan="2"><span class="style5"></span><span class="style5"></span></td>
          <td><span class="style5">G. Tanggal Batas</span></td>
          <td><span class="style5">:</span></td>
          <td colspan="3"><span class="style5"><?php echo $tgl->TanggalHari($data['surat']['tblobyek_tglbataskirim']) ?></span><span class="style5"></span><span class="style5"></span></td>
        </tr>
        <tr>
          <td><span class="style5">D. Melakukan Pembukuan</span></td>
          <td><span class="style5">:</span></td>
    ...
    <div class="dotter">	
      <table width="100%" border="0" style="border-collapse:collapse">
        <tr>
          <td width="229"><span class="style5">H. Nomor Surat Teguran SPTPD </span></td>
          <td width="10"><span class="style5">:</span></td>
          <td width="273"><span class="style5"><?php echo "--" ?></span></td>
          <td colspan="2"><span class="style5"></span> <span class="style5"></span></td>
          <td width="229">&nbsp;</td>
          <td width="397">&nbsp;</td>
        ...
        <tr>
          <td><span class="style5">I. Tanggal Surat Teguran SPTPD</span></td>
          <td><span class="style5">:</span></td>
        ...
        <tr>
          <td><span class="style5">J. Terlambat Memasukan SPTPD </span></td>
          <td><span class="style5">:</span></td>
          <td><span class="style5"><?php echo "--" ?></span></td>
          <td colspan="2"><span class="style5"></span><span class="style5"></span></td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td><span class="style5">Jumlah Meja </span></td>
          <td><span class="style5">:</span></td>
          <td><span class="style5"><?php echo "--" ?></span></td>
          <td colspan="2"><span class="style5"></span><span class="style5"></span></td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td><span class="style5">Jumlah Pengunjung </span></td>
          <td><span class="style5">:</span></td>
          <td><span class="style5"><?php echo "--" ?></span></td>
          <td colspan="2"><span class="style5"></span><span class="style5"></span></td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td colspan="10"><table width="100%" border="1" cellpadding="3" cellspacing="0" style="border-collapse:collapse">
            <tr>
              ...
              <td width="71" class="style5"><div align="center">Omzet </div></td>
            ...
            <tr>
              ...
              <td class="style5"><div align="right"><?php echo $key['tbltransaksiketetapan_omzettotal'] ?></div></td>
        ...
        <tr>
          <td colspan="10"><table width="100%" border="1" cellpadding="3" cellspacing="0" style="border-collapse:collapse">
            <tr>
              ...
              <td width="172" class="style5"><div align="center">Omzet<br />
                Hasil Pemeriksaan  </div></td>
                <td width="205" class="style5"><div align="center">Omzet<br />

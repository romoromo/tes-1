...
<body>
  <table width="100%" border="0" style="border-collapse:collapse">
    <tr>
      <td colspan="10"><div align="center" class="style3">KARTU DATA PAJAK PENERANGAN JALAN<br />
    ...
    <div class="dotter">	
      <table width="100%" border="0" style="border-collapse:collapse">
        <tr>
          <td colspan="10"><span class="style5">OBJEK PAJAK PENERANGAN </span></td>
        </tr>
      </table>
    </div>
    <div class="dotter">	
      <table width="100%" border="0" style="border-collapse:collapse">
        <tr>
          <td colspan="10"><table width="100%" border="0">
            <tr>
              <td width="20%" class="style5">Nilai Perolehan Untuk Industri </td>
              <td width="12%" class="style5"><?php echo "--" ?></td>
              <td width="9%" class="style5">&nbsp;</td>
              <td width="31%" class="style5">Jumlah pajak Untuk Industri (nilai perolehan x 3%) </td>
              <td width="28%" class="style5"><?php echo "--" ?></td>
            </tr>
          </table></td>
        </tr>
      </table>
        ...
        <tr>
          <td colspan="10"><table width="100%" border="1" cellpadding="3" cellspacing="0" style="border-collapse:collapse">
            <tr>
              ...
              <td width="71" class="style5"><div align="center">Nilai Jual </div></td>
        ...
        <tr>
          <td colspan="10"><table width="100%" border="1" cellpadding="3" cellspacing="0" style="border-collapse:collapse">
            <tr>
              ...
              <td width="172" class="style5"><div align="center">Nilai Perolehan Pajak<br />Hasil Pemeriksaan  </div></td>
              <td width="205" class="style5"><div align="center">Nilai Perolehan Pajak<br />yang dilaporkan WP </div></td>
            ...
            <?php foreach ($data['hasil_transaksi'] as $key => $value): ?>
              <tr>
                <td class="style5"><div align="center"><?php echo $no++ ?></div></td>
                <td class="style5"><?php echo date('d/m/Y', strtotime($key['tbltransaksiketetapan_masaawal'])) ?> s/d <?php echo date('d/m/Y', strtotime($key['tbltransaksiketetapan_masaakhir'])) ?></td>

...
<body>
  <table width="100%" border="0" style="border-collapse:collapse">
    ...
    <div class="dotter">	
      <table width="100%" border="0" style="border-collapse:collapse">
        <tr>
          <td colspan="10"><span class="style5">OBJEK PAJAK HOTEL </span></td>
        </tr>
      </table>
    </div>
    <div class="dotter">	
        ...
        <tr>
          <td colspan="10"><table width="100%" border="1" cellpadding="3" cellspacing="0" style="border-collapse:collapse">
            <tr>
              ...
              <td width="71" class="style5"><div align="center">Nilai Perolehan Pajak Hotel </div></td>
        ...
        <tr>
          <td colspan="10"><table width="100%" border="1" cellpadding="3" cellspacing="0" style="border-collapse:collapse">
            <tr>
              ...
              <td width="172" class="style5"><div align="center">Nilai Perolehan Pajak Hotel<br />Hasil Pemeriksaan  </div></td>
              <td width="205" class="style5"><div align="center">Nilai Perolehan Pajak Hotel<br />yang dilaporkan WP </div></td>

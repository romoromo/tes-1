						...
						<fieldset>
							...
							<div class="row">
								...
								<div class="row">
									...
									<section class="col col-md-1">
										<label class="input">
											<input type="jenis_pajak" name="" id="jenis_pajak">
										</label>
...
<script type="text/javascript">
	...
	function cari() {
		$.ajax({
			url: 'pendataan/cetak_kartudata_pajakreklame/cari',
			type: 'POST',
			data: {
	...
	function cetak (jenis) {
		...
		window.TBLDAFTREKLAME_REKJENIS= $("#TBLREKENING_KODESUB").val().split('.').reverse()[0];
		var URL_APLIKASI = "<?php echo Yii::app()->getBaseUrl(1); ?>";
		window.open(URL_APLIKASI+"/pendataan/cetak_kartudata_pajakreklame/cetak?jenis="+jenis+"&TBLPENDATAAN_THNPAJAK="+window.TBLPENDATAAN_THNPAJAK+"&TBLPENDATAAN_BLNPAJAK="+window.TBLPENDATAAN_BLNPAJAK+"&TBLPENDATAAN_TGLPAJAK="+window.TBLPENDATAAN_TGLPAJAK+"&TBLREKENING_KODESUB="+window.TBLREKENING_KODESUB+"&TBLDAFTREKLAME_THNSPTPD="+window.TBLDAFTREKLAME_THNSPTPD+"&TBLDAFTREKLAME_BLNSPTPD="+window.TBLDAFTREKLAME_BLNSPTPD+"&TBLDAFTREKLAME_TGLSPTPD="+window.TBLDAFTREKLAME_TGLSPTPD+"&TBLKECAMATAN_ID="+window.TBLKECAMATAN_ID+"&REFJALAN_ID="+window.REFJALAN_ID+"&TBLDAFTREKLAME_ISJNSPENETAPAN="+window.TBLDAFTREKLAME_ISJNSPENETAPAN+"&TBLDAFTREKLAME_REKJENIS="+window.TBLDAFTREKLAME_REKJENIS);

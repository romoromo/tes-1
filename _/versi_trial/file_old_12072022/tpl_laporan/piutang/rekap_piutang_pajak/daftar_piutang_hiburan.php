...
//		);
	...
	tbltransaksiketetapan
	WHERE
	kode_obyek LIKE "%41103%" AND tbltransaksiketetapan_isterbayar LIKE "%F%" AND tbltransaksiketetapan_pajak <> 0
...
<table border="0" align="center" cellspacing="0">
	...
	<tr>
		<td colspan=4 height="17" align="center" valign=bottom>PAJAK HIBURAN</td>
  </tr>
	<tr>
  ...
  <?php $total= array('tbltransaksiketetapan_pajak'=>0); $no = 1; foreach($data['laporan'] as $row): ?>
	<tr>
		...
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="right" sdval="2013" sdnum="1033;"><?= $data['tbltransaksiketetapan_tahunpajak'] ?></td>

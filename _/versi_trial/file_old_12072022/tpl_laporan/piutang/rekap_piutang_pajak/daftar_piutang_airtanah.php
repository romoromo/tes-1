...
//		);
	...
	tbltransaksiketetapan
	WHERE
	kode_obyek LIKE "%41108%" AND tbltransaksiketetapan_isterbayar LIKE "%F%" AND tbltransaksiketetapan_pajak <> 0
	AND tbltransaksiketetapan_tahunpajak = '.$data['tahun_pajak'].'
	';
...
<table border="0" align="center" cellspacing="0">
	...
	<tr>
		<td colspan=4 height="17" align="center" valign=bottom>PAJAK AIR TANAH</td>
  </tr>
	<tr>
  ...
  <?php $total= array('tbltransaksiketetapan_pajak'=>0); $no = 1; foreach($data['laporan'] as $row): ?>
	<tr>
		...
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="right" sdval="2013" sdnum="1033;"><?= $row['tbltransaksiketetapan_tahunpajak']; ?></td>
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="right" sdval="2000" sdnum="1033;0;_(* #,##0_);_(* (#,##0);_(* &quot;-&quot;_);_(@_)"><?= LokalIndonesia::ribuan($row['tbltransaksiketetapan_pajak']); $total['tbltransaksiketetapan_pajak']+= $row['tbltransaksiketetapan_pajak']; ?></td>
  ...
  <?php endforeach; ?>
	<tr>
		...
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="right" sdval="2302000" sdnum="1033;0;_(* #,##0_);_(* (#,##0);_(* &quot;-&quot;_);_(@_)"> <?= LokalIndonesia::ribuan($total['tbltransaksiketetapan_pajak']) ?> </td>
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left"><br></td>
	</tr>
	<tr>
		<td height="17" align="left"><br></td>

...
//		);
	...
	SELECT
		...
		tblsetoran_subyeknama AS subyek_nama,
		tblsetoran_subyekalamat AS subyek_alamat,
		tblsetoran_subyeknpwpd AS subyek_npwpd,
		tblsetoran_obyeknama AS obyek_nama,
		tblsetoran_obyekalamat AS obyek_alamat,
		tblsetoran_obyeknop AS obyek_nop,
		"PENERANGAN JALAN" AS rekening_nama,
		tblsetoran_ketetapanmasaawal AS ketetapan_masaawal,
		tblsetoran_ketetapanmasaakhir AS ketetapan_masaakhir,
	...
	tblsetoran
	WHERE
		tblsetoran_rekeningkode LIKE "41105%"
		AND YEAR(tblsetoran_tglsetor) = '.$data['tahun_setor'].'
		AND YEAR(tbltransaksiketetapan.tbltransaksiketetapan_tahunpajak) = '.($data['tahun_setor']-1).'
	ORDER BY
		setoran_kohir
	';
...
<table cellspacing="0" border="0">
	...
	<tr>
		<td colspan=10 height="18" align="center" valign=bottom><font face="Arial" color="#000000">DAFTAR REALISASI SETORAN MASA </font></td>
		</tr>
	<tr>
		<td colspan=10 height="18" align="center" valign=bottom><font face="Arial" color="#000000">PAJAK PENERANGAN JALAN</font></td>
  </tr>
	<tr>

	...
	<div style="max-width:1000px; padding:5px;">
		<table width="90%" class="outer" cellspacing="0">
		  ...
		  <tr class="bottom">
			...
			<tr>
			  <td>4.</td>
			  <td colspan="4">Jumlah Pajak Bayar </td>
			  <td>&nbsp;</td>
			  <td>Rp.</td>
			  <td align="right"><?= LokalIndonesia::ribuan( $tblketetapannihil_pajaktotalkb); ?> <!-- $kekurangan_pajak --></td>
		  </tr>
			<tr>
			  <td>5.</td>
			...
			<tr>
			  ...
			  <td width="21%">&nbsp;</td>
			  <td width="4%">Rp.</td>
		      <td align="right"><?=  LokalIndonesia::ribuan( $tblketetapannihil_pajak ) ?></td>
		  </tr>
			<tr>
			  <td>&nbsp;</td>
			  ...
			  <td>&nbsp;</td>
			  <td>Rp.</td>
		      <td align="right"><?=  LokalIndonesia::ribuan( $tblketetapannihil_rupiahbunga ) ?></td>
		  </tr>
			...
			<tr class="top bottom">
			  ...
			  <td>&nbsp;</td>
			  <td>Rp.</td>
		      <td align="right"><?=  LokalIndonesia::ribuan( $tblketetapannihil_pajaktotalkb ) ?></td>
		  </tr>
			...
			<tr>
			  <td colspan="8"><?= $tblketetapannihil_pajaktotalkb_terbilang ?></td>
		  </tr>
			<tr class="bottom">
			  <td colspan="8">&nbsp;</td>
		  </tr>

...
$no = 1;
$nomor_kohir = strtoupper( $ts['tblketetapankurangbayar_nokohirketetapan'] );;
$masa_awal = LokalIndonesia::TGLID($ts['tblketetapankurangbayar_masaawal'],'/');
$masa_akhir = LokalIndonesia::TGLID($ts['tblketetapankurangbayar_masaakhir'],'/');
...
$tblketetapankurangbayar_pajak =  $ts['tblketetapankurangbayar_pajak'];
$tblketetapankurangbayar_rupiahbunga =  $ts['tblketetapankurangbayar_rupiahbunga'];
$tblketetapankurangbayar_pajakketetapan =  $ts['tblketetapankurangbayar_pajaktotalkb'];
$tblketetapankurangbayar_tglketetapan =  $ts['tblketetapankurangbayar_tglketetapankb'];
$tblketetapankurangbayar_pajakketetapan_terbilang = LokalIndonesia::terbilangangka(floatval( $ts['tblketetapankurangbayar_pajaktotalkb'] )) . " rupiah";
$dasar_pajak = LokalIndonesia::ribuan( $ts['tblketetapankurangbayar_pajakperiksa'] );
 ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<title>Surat Ketetapan Pajak Daerah Kurang Bayar </title>
</head>
<style>
	...
	<div style="max-width:1000px; padding:5px;">
		<table width="90%" class="outer" cellspacing="0">
		  ...
		  <tr class="bottom">
			...
			<tr>
			  <td>4.</td>
			  <td colspan="4">Jumlah Kekurangan Pajak Kurang Bayar </td>
			  <td>&nbsp;</td>
			  <td>Rp.</td>
			  <td align="right"><?= "0"; ?> <!-- $kekurangan_pajak --></td>
		  </tr>
			<tr>
			  <td>5.</td>
			...
			<tr>
			  ...
			  <td width="21%">&nbsp;</td>
			  <td width="4%">Rp.</td>
		      <td align="right"><?=  LokalIndonesia::ribuan( $tblketetapankurangbayar_pajak ) ?></td>
		  </tr>
			<tr>
			  <td>&nbsp;</td>
			  ...
			  <td>&nbsp;</td>
			  <td>Rp.</td>
		      <td align="right"><?=  LokalIndonesia::ribuan( $tblketetapankurangbayar_rupiahbunga ) ?></td>
		  </tr>
			...
			<tr class="top bottom">
			  ...
			  <td>&nbsp;</td>
			  <td>Rp.</td>
		      <td align="right"><?=  LokalIndonesia::ribuan( $tblketetapankurangbayar_pajakketetapan ) ?></td>
		  </tr>
			...
			<tr>
			  <td colspan="8"><?= $tblketetapankurangbayar_pajakketetapan_terbilang ?></td>
		  </tr>
			<tr class="bottom">
			  <td colspan="8">&nbsp;</td>
		  </tr>
			...
			<tr>
			  <td>&nbsp;</td>
			  <td colspan="4">&nbsp;</td>
			  <td colspan="3" align="center"><?= strtoupper( AppConfig::model()->getValue('APLIKASI_CETAK_WILAYAH') ) ?>, <?=  LokalIndonesia::TanggalUmum( $tblketetapankurangbayar_tglketetapan ) ?></td>
		  </tr>
			<tr>
			  <td>&nbsp;</td>
			  <td colspan="4">&nbsp;</td>

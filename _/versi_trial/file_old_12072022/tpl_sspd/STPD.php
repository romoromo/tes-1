...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=672
 ...
 <tr style='height:71.5pt'>
  ...
  text-align:center;line-height:normal'>SURAT TAGIHAN PAJAK DAERAH</p>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal'>SKPD : REKLAME<br>
  TAHUN PAJAK : <?php echo $data['stpd']['tbltransaksiretribusi_tahunpajak'] ?></p>
  </td>
  ...
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><?php echo $data['stpd']['tblsetoran_nomorsetor'] ?></p>
  </td>
 </tr>
 <tr style='height:85.0pt'>
  ...
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'> NAMA  : <?php echo $data['stpd']['tblsubyek_nama'] ?></p>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'> ALAMAT  : <?php echo $data['stpd']['tblsubyek_alamat'] ?></p>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'> NPWPD  : <?php echo $data['stpd']['tblobyek_npwpd'] ?></p>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'>&nbsp;</p>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'> Tanggal Jatuh Tempo : <?php echo date('d-m-Y',strtotime($data['stpd']['tbltransaksiretribusi_tgljatuhtempo'])) ?></p>
  </td>
 </tr>
 <tr style='height:206.5pt'>
  ...
  </span>I.<span style='font:5.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <p class=MsoListParagraphCxSpMiddle style='margin-bottom:0in;margin-bottom:
  .0001pt;line-height:normal'>Kode Rekening : <?php echo $data['stpd']['tblsetoran_rekeningkode'] ?></p>
  <p class=MsoListParagraphCxSpMiddle style='margin-bottom:0in;margin-bottom:
  .0001pt;line-height:normal'>Nama : <?php echo $data['stpd']['tblmasterrekening_nama'] ?></p>
  <p class=MsoListParagraphCxSpMiddle style='margin-bottom:0in;margin-bottom:
  .0001pt;line-height:normal'>TAHUN PAJAK : TAHUN <?php echo $data['stpd']['tbltransaksiretribusi_tahunpajakn'] ?></p>
  <p class=MsoListParagraphCxSpLast style='margin-bottom:0in;margin-bottom:
  .0001pt;text-indent:-.5in;line-height:normal'><span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  </span>II.<span style='font:5.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  2. Sanksi administrasi :<br>
   a. Biaya tambahan (Psl.19(2)) Rp. <?php echo number_format( round($data['stpd']['tblsetoran_bungasetor']),2,',','.') ?><br>
   ----------------------<br>
   b. Jumlah Biaya -<br>
   tambahan (a) Rp. <?php echo number_format( round($data['stpd']['tblsetoran_bungasetor']),2,',','.') ?><br>
  3. Jumlah Pajak/Ret. yang masih -<br>
   harus dibayar (1+2b) Rp. <?php echo number_format( round($data['stpd']['tblsetoran_bungasetor']),2,',','.') ?> </p>
  </td>
 </tr>
 <tr style='height:17.5pt'>
  ...
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'> Dengan Huruf : <?php echo LokalIndonesia::terbilangangka(round($data['stpd']['tblsetoran_bungasetor'])) ?> rupiah</p>
  </td>
 </tr>
 <tr style='height:80.5pt'>
  ...
  style='font:5.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span><span
 ...
 <tr style='height:168.25pt'>
  ...
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal'>KABID PENDATAAN PENETAPAN DAN PENAGIHAN</p>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'> <span class="MsoNormal" style="margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal">Ka. Sub. Bid. Penetapan</span><br>
  <br>
  Tgl.terima : </p>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'>Nama WP/WR  :</p>

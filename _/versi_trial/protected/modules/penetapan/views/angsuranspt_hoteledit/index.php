	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="well well-sm well-light bg-color-greenLight txt-color-white">
				<h4><i class="fa fa-file-text-o"></i> Angsuran SPTPD - Pajak Hotel </h4>
			</div>
		</div>
	</div>
									...
									<fieldset>
										...
										<div class="row">
											<section class="col col-md-12">
												<h4 align="center">Data Perhitungan</h4>
											</section>
										</div>
										<div class="row">
										...
										<div class="row">
											...
											<section style="display: none;" class="col col-md-1">
										...
										<div class="row">
											...
											<section class="col col-md-2">
												<label class="input"> <i class="icon-append fa fa-calendar"></i>
													<input type="text" readonly="" name="<?= $this->namatabel ?>_TGLBATASSPTPD" data-dateformat="dd-mm-yy" id="<?= $this->namatabel ?>_TGLBATASSPTPD" style="
										background-color: beige;
										">
												</label>
											</section>
								...
								<section class="col col-md-2">
									<label class="select">
										...
										<div class="row">
											...
											<section class="col col-md-2">
												<label class="input"> <i class="icon-append fa fa-calendar"></i>
													<input type="text" name="<?= $this->namatabel ?>_TGLBATAS" value="<?= date('d-m-Y', strtotime('+ 1 months')) ?>" data-dateformat="dd-mm-yy" id="<?= $this->namatabel ?>_TGLBATAS">
												</label>
											</section>
										...
										<div class="row">
											<section class="col col-md-2" style="margin-left: 2%;">Set Angsuran Pertama</section>
											<section class="col col-md-2">
												<label class="input">
													<input type="text" name="setangsuranpertama" class="form-control format-rupiah" id="setangsuranpertama">
												</label>
											</section>
										</div>
										<div class="row">
		...
		<script type="text/javascript">
			...
			function hitungAngsuran() {
				...
				byterhutangsekarang = byterhutang = Number(toAngka($("#<?= $this->namatabel ?>_TOTALPAJAK").val())) -
					Number(toAngka($("#setangsuranpertama").val()));
				tapawal = Number(toAngka($("#<?= $this->namatabel ?>_TOTALPAJAK").val()))

				kaliangsur = parseInt($("#<?= $this->namatabel ?>_JUMLAHANGSUR").val()) - 1;
				totalangs = toAngka($("#<?= $this->namatabel ?>_TOTALPAJAK").val());
				tglangsurawal = $("#<?= $this->namatabel ?>_TGLBATAS").val();

				rs1 = {
					"ke": 1,
					"tgljatuhtempoangsur": tglangsaw[0],
					"blnjatuhtempoangsur": Number(tglangsaw[1]),
					"thnjatuhtempoangsur": tglangsaw[2]
						// ,"pokokangsur" : totalangsur
						,
					"pokokangsur": Number(toAngka($("#setangsuranpertama").val())),
					"rpskp": tapawal,
					"bungaangsur": 0
					// ,"totalang" : totalang
				};
				tabeldetail.push(rs1);

				for (var i = 1; i <= kaliangsur; i++) {
					...
					tarifangsur = (byterhutangsekarang - ((i - 1) * pokokangsur)) * (2 / 100);
			...
			function getNoANG(tahun) {
				$.ajax({
					url: 'penetapan/angsuranspt_hotel/GetNoANG',
					type: 'POST',
					dataType: 'json',
					data: {
						tahun: tahun

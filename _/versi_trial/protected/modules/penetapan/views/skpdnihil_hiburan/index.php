	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="well well-sm well-light bg-color-greenLight txt-color-white">
				<h4><i class="fa fa-file-text-o"></i> SKPD Nihil - Pajak Hiburan </h4>
			</div>
		</div>
	</div>
	...
	<section id="widget-grid" class="" >
		...
		<div class="row">
			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<div class="jarviswidget jarviswidget-color-teal" id="wid-id-Pajak_Hiburan" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
					<header>
					...
					<div>
						...
						<div class="widget-body no-padding">
							<form id="form-skpdn-hiburan" class="smart-form" novalidate="">
								<fieldset>
									...
									<div class="row">
										...
										<section class="col col-md-2">
											<label class="select">
												<select class="select2" name="TBLDAFTHIBURAN_BLNKBAWAL" id="TBLDAFTHIBURAN_BLNKBAWAL">
													<option value="0">-- Silahkan Pilih --</option>
										...
										<section class="col col-md-2">
											<label class="select">
												<select class="select2" name="TBLDAFTHIBURAN_BLNKBAKHIR" id="TBLDAFTHIBURAN_BLNKBAKHIR">
													<option value="0">-- Silahkan Pilih --</option>
									...
									<hr><br>
									<div class="row">
										<section class="col col-md-12"><h4 align="center">Entry SKPDN Pajak Hiburan</h4></section>
									</div>
									...
									<div class="row">
										...
										<section class="col col-md-2">
											<label class="input"> <i class="icon-append fa fa-calendar"></i>
												<input type="text" name="TBLDAFTHIBURAN_TGLPERIKSA" class="datepicker" data-dateformat="dd-mm-yy" id="TBLDAFTHIBURAN_TGLPERIKSA">
											</label>
										</section>
									</div>
									<div class="row">
										...
										<section class="col col-md-4">
											<label class="input">
												<input class="form-control format-rupiah" type="text" id="TBLDAFTHIBURAN_RUPIAHPERIKSA" name="TBLDAFTHIBURAN_RUPIAHPERIKSA">
											</label>
										</section>
									</div>
									<div class="row">
									...
									<div class="row">
										...
										<section class="col col-md-2">
											<label class="input">
												<input class="form-control" type="text" id="TBLDAFTHIBURAN_REGNIHIL" name="TBLDAFTHIBURAN_REGNIHIL">
											</label>
										</section>
										<section class="col col-md-2">Tanggal SKPDKN</section>
										<section class="col col-md-2">
											<label class="input"> <i class="icon-append fa fa-calendar"></i>
												<input type="text" name="TBLDAFTHIBURAN_TANGGLNIHIL" class="datepicker" value="<?= date('d-m-Y') ?>"  data-dateformat="dd-mm-yy" id="TBLDAFTHIBURAN_TANGGLNIHIL">
											</label>
										</section>
									</div>
								</fieldset>
								<footer id="footer-hiburan">
									<div id="tbl_simpan">
	...
	<script type="text/javascript">
		...
		function generateAutocomplete() {
			$('#TBLDAFTAR_NOPOK').autocomplete({
				serviceUrl: 'penetapan/skpdnihil_hiburan/autocomplete',
		...
		function runFormValidation() {
			var $FormData = $("#form-skpdn-hiburan").validate({
			...
			rules : {
				...
				"TBLDAFTHIBURAN_RUPIAHPERIKSA" : {
					required : true
				},
				"TBLDAFTHIBURAN_REGNIHIL" : {
					required : true
				},
				"TBLDAFTHIBURAN_TGLPERIKSA" : {
					required : true
				},
				"TBLDAFTHIBURAN_TANGGLNIHIL" : {
					required : true
				},
			},
			...
			var param = jQuery.param(
				{
					...
					, TBLPENDATAAN_BLNPAJAK: $("#TBLDAFTHIBURAN_BLNKBAKHIR").select2('val')
					, TBLPENDATAAN_THNPAJAK: $("#TBLPENDATAAN_THNPAJAK").val()
				}
			);
			window.open('<?php echo Yii::app()->getBaseUrl(1); ?>/penetapan/skpdnihil_hiburan/cetakword?'+param);
		}

		function cari () {
			var CARI_NOPOK = $('#TBLDAFTAR_NOPOK').val();
			var BULAN_AKHIR = $('#TBLDAFTHIBURAN_BLNKBAKHIR').select2('val');
			...
			if (CARI_NOPOK=='') {
				...
				$.ajax({
					url: 'penetapan/skpdnihil_hiburan/getdata',
					type: 'POST',
					dataType: 'json',
					data: {
						TBLDAFTAR_NOPOK : CARI_NOPOK,
						bulan_akhir : $('#TBLDAFTHIBURAN_BLNKBAKHIR').select2('val'),
						...
						if (respon.data=='sudah entri') {
							$.SmartMessageBox({
								...
								buttons : '[Tidak][Ya]' // pengaturan tombol
									...
									$('#TBLDAFTHIBURAN_RUPIAHPERIKSA').val(respon.TBLDAFTHIBURAN_RUPIAHPERIKSA);
									$('#TBLDAFTHIBURAN_NOMORPERIKSA').val(respon.TBLDAFTHIBURAN_NOMORPERIKSA);
									$('#TBLDAFTHIBURAN_REGNIHIL').val(respon.TBLDAFTHIBURAN_REGNIHIL);

									$('#TBLDAFTHIBURAN_PAJAKPERIKSA').attr('disabled', 'disabled');
									$('#TBLDAFTHIBURAN_PAJAKPERIKSA').attr('style', 'background:#eee');

									if (respon.TBLDAFTHIBURAN_TGLPERIKSA==undefined) {
										$('#TBLDAFTHIBURAN_TGLPERIKSA').val('<?= date('d-m-Y') ?>');
									} else {
									...
									// $('#TBLDAFTHIBURAN_TANGGLNIHIL').val(respon.TBLDAFTHIBURAN_TANGGLNIHIL +'-'+ respon.TBLDAFTHIBURAN_BULANNIHIL +'-20'+ respon.TBLDAFTHIBURAN_TAHUNNIHIL);
							...
							if (respon.TBLDAFTHIBURAN_TGLPERIKSA==undefined || respon.TBLDAFTHIBURAN_TGLPERIKSA==0) {
								$('#TBLDAFTHIBURAN_TGLPERIKSA').val('<?= date('d-m-Y') ?>');
							} else {
								$('#TBLDAFTHIBURAN_TGLPERIKSA').val(respon.TBLDAFTHIBURAN_TGLPERIKSA +'-'+ respon.TBLDAFTHIBURAN_BLNPERIKSA +'-20'+respon.TBLDAFTHIBURAN_THNPERIKSA);
							}
		...
		function getNoSKPDNihil(tahun) {
			$.ajax({
				url: 'penetapan/skpdnihil_hiburan/getNoSKPDNihil',
				type: 'POST',
				dataType: 'json',
				data: {
					tahun: tahun
				...
				success: function(respon) {
					if (respon=='') {
						$('#TBLDAFTHIBURAN_REGNIHIL').val(1);
						
					}
					else{
						$('#TBLDAFTHIBURAN_REGNIHIL').val(respon.NOLB);
		...
		function simpanskpdnihil () {
			$.ajax({
				url: 'penetapan/skpdnihil_hiburan/SimpanSKPDNHiburan',
				type: 'post',
				dataType: "json",
				data:  $("#form-skpdn-hiburan").serialize(),

...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Keringanan Pajak Parkir</h4>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	...
	function generateAutocompleteWP() {
		$('#nomor_pajak').autocomplete({
			serviceUrl: 'penetapan/keringanan_parkir/autocompletewp',
	...
	if (TBLDAFTAR_NOPOK=='') {
		notifikasi('Informasi','Mohon isikan No Pokok WP','failed',1,0);
			...
			$.ajax({
				url: 'penetapan/keringanan_parkir/CekPernahDaftar',
				type: 'POST',
				dataType: 'json',
				data: {
	...
	function cari() {
		...
		if (CARI_NOPOK=='') {
			...
			$.ajax({
				url: 'penetapan/keringanan_parkir/getdata',
				type: 'POST',
				dataType: 'json',
				data: {
								...
								buttons : '[Tidak][Ya]' // pengaturan tombol
									...
									if (ButtonPressed === "Ya") {
										...
										if (respon.data=='proses selanjutnya') {
											...
											window.BUNGASPTPD = respon.TBLDAFTPARKIR_BUNGASPTPD
	...
	$.ajax({
		url: 'penetapan/keringanan_parkir/GetTGLBatas',
		type: 'POST',
		dataType: 'json',
		data: {
			 THNPAJAK : THNPAJAK
	...
	function simpan() {
		...
		$.ajax({
			url: 'penetapan/keringanan_parkir/simpandata',
			type: 'POST',
			dataType: 'json',
			data: {

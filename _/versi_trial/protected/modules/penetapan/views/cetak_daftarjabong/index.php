...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Cetak Daftar Jabong Reklame
</h4>
		</div>
	</div>
</div>
				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<form action="" id="form_sumber_pajak" class="smart-form" novalidate>
							...
							<footer><button type="button" class="btn btn-sm btn-primary"> Cetak Format Kecil</button>
							<button type="button" onclick="cetak()" class="btn btn-sm btn-primary"> Cetak</button></footer>					
						</form>
...
<script type="text/javascript">
	...
	function cetak(){
		 ...
		 window.open('<?php echo Yii::app()->getBaseUrl(1) ?>/penetapan/cetak_daftarjabong/cetak?THP='+THP+'&BLP='+BLP+'&HRP='+HRP+'&NOPOK='+NOPOK+'&lokasi='+lokasi+'&TREKENINGSUB_KODE='+TREKENINGSUB_KODE+'&THANG1='+THANG1+'&THANG2='+THANG2+'&THANG3='+THANG3);
	}

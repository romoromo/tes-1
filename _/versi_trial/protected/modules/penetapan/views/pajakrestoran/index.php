...
<script type="text/javascript">
	...
	function generateAutocompleteWPResto() {
		$('#nomor_pajak').autocomplete({
			serviceUrl: 'pendataan/pajakrestoran/autocompletewphotel',
	...
	function cari() {
		...
		if (CARI_NOPOK=='') {
			...
			$.ajax({
				url: 'pendataan/pajakrestoran/getdata',
				type: 'POST',
				dataType: 'json',
				data: {
					...
					tanggal : $('#is_tanggal').prop('checked') ? $('#masapajak_tanggal').val() : '0'
				},
	...
	function simpan() {
		...
		$.ajax({
			url: 'pendataan/pajakrestoran/simpandata',
			type: 'POST',
			dataType: 'json',
			data: {

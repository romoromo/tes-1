...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file fa-fw"></i> Keringanan Pajak Air Tanah 2017</h4>
		</div>
	</div>
</div>
							...
							<div class="row">
								...
								<section class="col col-md-2">
									<button class="btn btn-sm btn-default" type="button" onclick="cekPernahDaftar()" id="tombol_proses">
										<i class="fa fa-forward"></i> Proses Keringanan
									</button>
								</section>
							</div>
							...
							<div class="row">
								...
								<section class="col col-md-2">
									<label class="input">
										...
										<input disabled="disabled" type="text" id="TBLDAFTTANAH_TGLSPTPD" value="<?php echo date('d-m-Y'); ?>" name="TBLDAFTTANAH_TGLSPTPD" class="datepicker" data-dateformat="dd-mm-yy">
									</label>
								</section>
							</div>
								...
								<div id="myTabContent1" class="tab-content padding-10" style="">
									<div class="tab-pane fade active in" id="s1">
										<div class="row">
											...
											<section class="col col-md-2">
												<label class="input">
													<input style="background-color: #d8ddcf;" readonly="readonly" type="text" name="TBLDAFTTANAH_TOTALVOLUME" id="TBLDAFTTANAH_TOTALVOLUME">
												</label>
											</section>
										</div>
										<div class="row">
											...
											<section class="col col-md-2">
												<label class="input">
													<input style="background-color: #d8ddcf;" readonly="readonly" type="text" class="format-ribuan" name="TBLDAFTTANAH_NILAIAIR1" id="TBLDAFTTANAH_NILAIAIR1">
												</label>
											</section>
										</div>
										<div class="row">
											...
											<section class="col col-md-2">
												<div class="input-group state-success">
													<label class="input">
														<input style="background-color: #d8ddcf;" readonly="readonly" class="form-control" id="TBLREKENING_PERSEN" name="TBLREKENING_PERSEN" type="text">
													</label>
											...
											<section class="col col-md-2">
												<label class="input">
													<input style="background-color: #d8ddcf;" type="text" class="format-ribuan" readonly="readonly" id="TBLDAFTTANAH_NPATARIF" name="TBLDAFTTANAH_NPATARIF">
												</label>
											</section>
										</div>
										<div class="row">
											...
											<section class="col col-md-2">
												<div class="input-group state-success">
													<label class="input">
														<input class="form-control" id="TBLDAFTTANAH_PERSENKERINGANAN" name="TBLDAFTTANAH_PERSENKERINGANAN" type="text">
													</label>
													<span class="input-group-addon">%</span>
												</div>
											</section>
											...
											<section class="col col-md-3">
												<button class="btn btn-sm btn-default" type="button" onclick="hitungpajak()">
													<i class="fa fa-money"></i> Hitung Keringanan
												</button>
											</section>
										</div>
										<div class="row" style="display: none;">
											<section class="col col-md-2">
												<div class="input-group state-success">
													<label class="input">
														<input class="form-control" id="TBLDAFTTANAH_RPKERINGANAN" name="TBLDAFTTANAH_RPKERINGANAN" type="text">
													</label>
												</div>
											</section>
										</div>
										<div class="row" style="display: none;">
											<section class="col col-md-2">
												<div class="input-group state-success">
													<label class="input">
														<input class="form-control" id="TBLDAFTTANAH_NOMORSKPD" name="TBLDAFTTANAH_NOMORSKPD" type="text">
													</label>
												</div>
											</section>
										</div>
										<div class="row">
											...
											<section class="col col-md-3">
												<label class="input">
													<input style="background-color: #d8ddcf;" readonly="readonly" type="text" class="format-rupiah" name="TBLDAFTTANAH_PAJAK" id="TBLDAFTTANAH_PAJAK">
												</label>
											</section>
										</div>
										<div class="row">
								...
								<fieldset id="form-dokumentasi-tanggal" style="display: none;">
									...
									<div class="row">
										...
										<section class="col col-md-3">
											<label class="input">
												<i class="icon-append fa fa-calendar"></i>
												<input disabled="disabled" type="text" id="TBLDAFTTANAH_TGLTERIMA" name="TBLDAFTTANAH_TGLTERIMA" class="datepicker" data-dateformat="dd-mm-yy">
											</label>
										</section>
									</div>
									...
									<div class="row">
										...
										<section class="col col-md-3">
											<label class="input">
												<i class="icon-append fa fa-calendar"></i>
												<input disabled="disabled" type="text" id="TBLDAFTTANAH_TGLENTRI" name="TBLDAFTTANAH_TGLENTRI" class="datepicker" data-dateformat="dd-mm-yy">
											</label>
										</section>
									</div>
...
function generateAutocompleteWPAirTanah() {
	...
	serviceUrl: 'penetapan/keringananpajak_airtanah2017/autocompletewpairtanah',
...
function WPAirTanah2(nopokok) {
	$.ajax({
		url: 'penetapan/keringananpajak_airtanah2017/autocompletewpairtanah2',
		type: 'POST',
		dataType: 'json',
		data: {
			nopokok : nopokok
...
function cekPernahDaftar() {
	...
	if (TBLDAFTAR_NOPOK=='') {
		...
		$("#btnsimpan").show()
		$.ajax({
			url: 'penetapan/keringananpajak_airtanah2017/CekPernahDaftar',
			type: 'POST',
			dataType: 'json',
			data: {
			...
			success : function (respon) {
				...
				if (respon.status=='sudah_disetor') {
					$.SmartMessageBox({
						title : "Informasi", // judul Smart Alert
						content : "Data dengan Nomor Pokok "+window.nopokok+", Masa Pajak "+BLNPAJAK+" "+THNPAJAK+" sudah disetor. Data sudah tidak bisa diubah.", // konten dari smart alert
					...
					return false;
				} else if (respon.status=='sudah_pernah_ringan') { 
					$.SmartMessageBox({
						title : "Informasi", // judul Smart Alert
						content : "Data dengan Nomor Pokok "+window.nopokok+", Masa Pajak "+BLNPAJAK+" "+THNPAJAK+" sudah pernah dilakukan keringanan. <br> Apakah akan ada perubahan data?", // konten dari smart alert
				...
				else if (respon.status=='sudah_ditetapkan') {
					$.SmartMessageBox({
						title : "Informasi", // judul Smart Alert
						content : "Data dengan Nomor Pokok "+window.nopokok+", Masa Pajak "+BLNPAJAK+" "+THNPAJAK+" sudah terbit SKPD/Penetapan. <br> Apakah akan ada perubahan data?", // konten dari smart alert
						buttons : '[Tidak][Ya]' // pengaturan tombol
						}, function(ButtonPressed) {
							if (ButtonPressed === "Ya") {
							cari();
				...
				else if (respon.status=='belum_ditetapkan') { // sudah SPT belum ditetapkan
					notifikasi('Informasi','SKPD belum ditetapkan','failed',1,0);
					// $.SmartMessageBox({
					// 	title : "Informasi", // judul Smart Alert
					// 	content : "Data dengan Nomor Pokok "+window.nopokok+", Masa Pajak "+BLNPAJAK+" "+THNPAJAK+" sudah pernah mendaftar SPT. <br> Apakah akan ada perubahan data?", // konten dari smart alert
					// 	buttons : '[Tidak][Ya]' // pengaturan tombol
					// 	}, function(ButtonPressed) {
					// 		if (ButtonPressed === "Ya") {
					// 		cari();
					...
					notifikasi('Informasi','SPT belum terdaftar','failed',1,0);
				}
			}
		});
	}
...
function cari() {
	...
	if (TBLDAFTAR_NOPOK=='') {
		...
		$.ajax({
		url: 'penetapan/keringananpajak_airtanah2017/GetWPAirTanah',
		type: 'POST',
		dataType: 'json',
		data: {
			 nopokok: $('#TBLDAFTAR_NOPOK').val()
		...
		success: function(respon) {
			...
			$("#TBLDAFTTANAH_NPATARIF").val( formatRibuan(parseInt(respon['TBLDAFTTANAH_NILAIAIR1'])) );
			$("#TBLDAFTTANAH_PAJAK").val( formatRibuan(respon['TBLDAFTTANAH_PAJAK']) );
			$("#TBLDAFTTANAH_BUNGASPTPD").val( formatRibuan(respon['TBLDAFTTANAH_BUNGASPTPD']) );
			$("#TBLDAFTTANAH_RUPIAHSETOR").val( formatRibuan(respon['TBLDAFTTANAH_PAJAKSKPD']) );
			$("#TBLDAFTTANAH_NOMORSKPD").val(respon['NOKOHIR']);
			...
			$("#TBLDAFTTANAH_TGLAKHIRJUAL").val( isikiri(respon['TBLDAFTTANAH_TGLAKHIRJUAL'], '00') + '-' +isikiri(respon['TBLDAFTTANAH_BLNAKHIRJUAL'], '00') + '-' +isikiri(respon['TBLDAFTTANAH_THNAKHIRJUAL'], '2000')  );
...
function getTarifRekening(kodesubrek) {
	$.ajax({
		url: 'penetapan/keringananpajak_airtanah2017/GetKodeRek',
		type: 'POST',
		dataType: 'json',
		data: {
...
function simpanairtanah () {
	$.ajax({
		url: 'penetapan/keringananpajak_airtanah2017/SimpanAirTanah',
		type: 'post',
		dataType: "json",
...
function getTglBatas(THNPAJAK,BLNPAJAK,KODEREK) {
	$.ajax({
		url: 'penetapan/keringananpajak_airtanah2017/GetTGLBatas',
		type: 'POST',
		dataType: 'json',
		data: {
			 THNPAJAK : THNPAJAK
...
function hitungpajak() {
	...
	var TOTALSETOR = toAngka($('#TBLDAFTTANAH_RUPIAHSETOR').val());
	var PERSENRINGAN = toAngka($('#TBLDAFTTANAH_PERSENKERINGANAN').val());

	// if (NPA=='') {
	// 	notifikasi('Informasi','Mohon isikan Nilai Perolehan Air','failed',1,0);
	// }else{
		RP_RINGAN = (PERSENRINGAN/100)*TOTALSETOR;
		// BUNGARP = '';
		...
		var RES_PAJAK_RINGAN = TOTALSETOR - RP_RINGAN;
		var RUPIAH_RINGAN = RP_RINGAN;
		
		$('#TBLDAFTTANAH_RPKERINGANAN').val(Math.round(RUPIAH_RINGAN));
		$('#TBLDAFTTANAH_RUPIAHSETOR').val(Math.round(RES_PAJAK_RINGAN));

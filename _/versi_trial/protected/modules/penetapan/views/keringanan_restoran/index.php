...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Keringanan Pajak Restoran</h4>
		</div>
	</div>
</div>
						...
						<form id="form_sumber_pajak" class="smart-form" novalidate="">
							...
							<fieldset id="form_perhitungan" style="display: none;">
								...
								<div class="row">
									...
									<section class="col col-md-4">
										<label class="input">
											<input readonly="" class="input-sm format-rupiah text-align-right" type="text" id="hit_penjualanhari" name="hit_penjualanhari">
										</label>
									</section>
									<section class="col col-md-2">
										<p>Jumlah Hari</p>
									...
									<section class="col col-md-2">
										<label class="input">
											<input readonly="" class="input-sm text-align-right" type="text" value="30" id="hit_jumlahhari" name="hit_jumlahhari">
								...
								<div class="row">
									...
									<section class="col col-md-4">
										<label class="input">
											<input readonly="" class="input-sm form-control format-rupiah text-align-right" type="text" id="hit_penjualanbulan" name="hit_penjualanbulan">
										</label>
									</section>
									<section class="col col-md-2">
										<p>Keringanan</p>
									...
									<section class="col col-md-1">
										<label class="input">
											<input name="hit_keringanan" id="hit_keringanan" type="text" class="input-sm form-control">
										</label>
									</section>
									<section class="col col-md-1">
								...
								<div class="row">
									...
									<section class="col col-md-2">
										<label class="checkbox pull-left">
											<input disabled="" type="checkbox" id="including" name="including">
											<i></i>
										</label>
									</section>
								</div>
								<div class="row">
									...
									<section class="col col-md-2">
										<label class="input"> <i class="icon-append fa fa-calendar"></i>
											<input disabled="" type="text" name="hit_tanggalawal" class="datepicker" data-dateformat="dd-mm-yy" id="hit_tanggalawal">
										</label>
									</section>
									...
									<section class="col col-md-2">
										<label class="input"> <i class="icon-append fa fa-calendar"></i>
											<input disabled="" type="text" name="hit_tanggalakhir" class="datepicker" data-dateformat="dd-mm-yy" id="hit_tanggalakhir">
										</label>
									</section>
								</div>
								...
								<div class="row">
									...
									<section class="col col-md-2">
										<label class="checkbox pull-left">
											<input disabled="" type="checkbox" value="T" id="is_lhp" name="is_lhp">
											<i></i>
										</label>
										<?php /*
										<label class="select">
									...
									<section class="col col-md-2">
										<label class="checkbox pull-left">
											<input disabled="" type="checkbox" value="T" id="is_notabil" name="is_notabil">
											<i></i>
										</label>
										<?php /*
										<label class="select">
									...
									<section class="col col-md-2">
										<label class="checkbox pull-left">
											<input disabled="" type="checkbox" id="tanpa_bunga" name="tanpa_bunga">
											<i></i>
										</label>
										<?php /*
										<label class="select">
								...
								<div class="row">
									...
									<section class="col col-md-2">
										<label class="input-group"> 
											...
											<input readonly="" class="form-control text-align-right format-rupiah" type="text" name="hit_pajak" id="hit_pajak">
										</label>
									</section>
									<section class="col col-md-1">
										Bunga SPT 
									...
									<section class="col col-md-2">
										<label class="input-group"> 
											<span class="input-group-addon">Rp</span>
											<input readonly="" class="form-control text-align-right format-rupiah" type="text" name="hit_bungaspt" id="hit_bungaspt">
										</label>
									</section>
									<section class="col col-md-1">
										Total Setor 
									...
									<section class="col col-md-2">
										<label class="input-group"> 
											<span class="input-group-addon">Rp</span>
											<input readonly="" class="form-control text-align-right format-rupiah" type="text" name="hit_totalsetor" id="hit_totalsetor" disabled="disabled" style="background: #e4e4e4;">
										</label>
									</section>
								</div>
							</fieldset>
							<fieldset id="form_dokumentasi_tanggal" style="display: none;">
								...
								<div class="row">
									...
									<section class="col col-md-4">
										<label class="input"> <i class="icon-append fa fa-calendar"></i>
											<input  readonly=""  disabled="" class="form-control datepicker" value="<?php echo date('d-m-Y'); ?>" type="text" name="hit_tglterimaspt" data-dateformat="dd-mm-yy" id="hit_tglterimaspt">
										</label>
									</section>
								</div>
								<div class="row">
									...
									<section class="col col-md-4">
										<label class="input"> <i class="icon-append fa fa-calendar"></i>
											<input readonly="" class="form-control datepicker" disabled="disabled" style="background: #e4e4e4;" type="text" name="hit_tglbatasspt" data-dateformat="dd-mm-yy" id="hit_tglbatasspt">
										</label>
									</section>
								</div>
								<div class="row">
									...
									<section class="col col-md-4">
										<label class="input"> <i class="icon-append fa fa-calendar"></i>
											<input readonly="" disabled="" class="form-control datepicker value="<?php echo date('d-m-Y'); ?>" type="text" name="hit_tglentryspt" data-dateformat="dd-mm-yy" id="hit_tglentryspt">
										</label>
									</section>
								</div>
								<div class="row">
									...
									<section class="col col-md-3">
										<label class="select">
											<select disabled="" id="hit_carapenghitungan" name="hit_carapenghitungan" class="select2">
							...
							<footer id="footer-hotel" style="display: none;">
								...
								<section class="col col-md-2">
									<a id="tombol_simpan" onclick="simpan()" class="btn btn-sm btn-primary pull-left">
...
<script type="text/javascript">
	...
	function setMasaPajak() {
		$("#hit_tanggalawal").val('');
		$("#hit_tanggalakhir").val('');
		thn = $("#masapajak_tahun").val();
		bln = $("#masapajak_bulan").val();
		...
		if (thn!='' && bln!='') {
			...
			$("#hit_tanggalawal").val(masapajak.format('L'));
			$("#hit_tanggalakhir").val(masapajak.endOf('month').format('L'));
			$("#hit_jumlahhari").val(masapajak.endOf('month').format('L').split('-')[0]);
			// if (c!='') {
	...
	function generateAutocompleteWPResto() {
		$('#nomor_pajak').autocomplete({
			serviceUrl: 'penetapan/keringanan_restoran/autocompletewphotel',
	...
	function cari() {
		...
		if (CARI_NOPOK=='') {
			...
			$.ajax({
				url: 'penetapan/keringanan_restoran/getdata',
				type: 'POST',
				dataType: 'json',
				data: {
					...
					tanggal : ($('#is_tanggal').prop('checked') ? $('#masapajak_tanggal').val() : '')
				},
								...
								buttons : '[Tidak][Ya]' // pengaturan tombol
									...
									if (ButtonPressed === "Ya") {
										...
										if (respon.data=='proses selanjutnya') {
											...
											$('#hit_penjualanbulan').val(respon.TBLDAFTRMAKAN_OMSETPAJAK);
											$('#hit_pajak').val(respon.TBLDAFTRMAKAN_PAJAK);
											$('#hit_bungaspt').val(respon.TBLDAFTRMAKAN_BUNGASPTPD);

											$('#hit_totalsetor').val(eval(respon.TBLDAFTRMAKAN_PAJAK)+eval(respon.TBLDAFTRMAKAN_BUNGASPTPD));

											$('#wp_input_tgl_spt').val((respon.TBLDAFTRMAKAN_TGLSPTPD)+'-'+(respon.TBLDAFTRMAKAN_BLNSPTPD)+'-'+'20'+(respon.TBLDAFTRMAKAN_THNSPTPD));
											
											$('#hit_tglterimaspt').val((respon.TBLDAFTRMAKAN_TGLTERIMA)+'-'+(respon.TBLDAFTRMAKAN_BLNTERIMA)+'-'+'20'+(respon.TBLDAFTRMAKAN_THNTERIMA));

											$('#hit_tglbatasspt').val((respon.TBLDAFTRMAKAN_TGLBATASSPTPD)+'-'+(respon.TBLDAFTRMAKAN_BLNBATASSPTPD)+'-'+'20'+(respon.TBLDAFTRMAKAN_THNBATASSPTPD));

											//$('#hit_tglentryspt').val((respon.TBLDAFTRMAKAN_TGLENTRI)+'-'+(respon.TBLDAFTRMAKAN_BLNENTRI)+'-'+'20'+(respon.TBLDAFTRMAKAN_THNENTRI));
											$('#hit_tglentryspt').val('<?php echo date('d-m-Y');?>');

											if (respon.TBLDAFTRMAKAN_TGLENTRI==0) {
											...
											window.BUNGASPTPD = respon.TBLDAFTRMAKAN_BUNGASPTPD
	...
	function simpan() {
		...
		$.ajax({
			url: 'penetapan/keringanan_restoran/simpandata',
			type: 'POST',
			dataType: 'json',
			data: {
	...
	$('#hit_penjualanhari').keyup(function() {
		...
		var jumlahhari = toAngka($('#hit_jumlahhari').val());
		window.penjualanhari = penjualanhari*jumlahhari;
		var tarif = toAngka($('#persen_pajak').val());
		if (penjualanhari!=0) {
	...
	$("#hit_keringanan").keyup(function(event) {
		// var PENJUALANHARI = window.penjualanhari
		// var OMZET = window.penjualanbulan
		// if (PENJUALANHARI>0) {
			$('#hit_penjualanhari').trigger('keyup')
		// } else if(OMZET>0){
			$('#hit_penjualanbulan').trigger('keyup')
		// }
	});
	...
	function hitungPajak() {
		...
		window.bunga_spt = parseInt(window.BUNGASPTPD) //paten karena keringanan
		...
		if ($('#including').is(':checked')) {
			if(window.penjualanbulan>0){
				window.pajak = Math.round(window.penjualanbulan/11);
			} else {
				window.pajak = Math.round(window.penjualanhari/11);
			}
		} else {
			if(window.penjualanbulan>0){
				window.pajak = Math.round(window.penjualanbulan/10);
			} else {
				window.pajak = Math.round(window.penjualanhari/10);
			}
		}

		keringanan = 0
		pcringan = toAngka($("#hit_keringanan").val())
		if (pcringan > 0) {
			console.log('db', window.pajak)
			window.pajak = (100-pcringan)/100 * window.pajak
			window.pajak = ceiling(window.pajak, 1);
			console.log(window.pajak)
		}
		// window.bunga_spt = window.pajak* (window.PERSEN_DENDA/100);
		// window.bunga_spt = ceiling(window.bunga_spt, 1);

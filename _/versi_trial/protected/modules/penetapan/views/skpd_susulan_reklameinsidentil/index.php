...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> SKPD Susulan Pajak Reklame Insidentil</h4>
		</div>
	</div>
</div>
	...
	<script type="text/javascript">
		...
		function generateAutocompleteWP() {
			$('#TBLDAFTAR_NOPOK').autocomplete({
				serviceUrl: 'penetapan/skpd_susulan_reklameinsidentil/autocompletewp',
		...
		function cari() {
			...
			if (TBLDAFTAR_NOPOK=='') {
				...
				$.ajax({
					url: 'penetapan/skpd_susulan_reklameinsidentil/getdata',
					type: 'POST',
					dataType: 'json',
					data: {
...
function simpanPendataan() {
	...
	$.ajax({
		url: 'penetapan/skpd_susulan_reklameinsidentil/simpanPendataan',
		type: 'POST',
		dataType: 'json',

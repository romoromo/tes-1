...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Entry Pendataan Pajak Reklame Tetap</h4>
		</div>
	</div>
</div>
						...
						<form id="form-pendataan-reklame2016_tetap" class="smart-form">
							<fieldset>
								...
								<div class="row">
									...
									<section class="col col-md-2">
										<label class="input">
											<input type="text" id="TBLPENDATAAN_PAJAKKE" name="param[TBLPENDATAAN_PAJAKKE]" placeholder="Lokasi" maxlength="10">
										</label>
									</section>
								</div>
									...
									<div id="myTabReklameContent" class="tab-content padding-10">
										<div class="tab-pane fade in active" id="tabrek1">
											...
											<div class="row">
												...
												<section class="col col-md-4">
													<label class="input">
														<input class="input-sm" type="number" id="TBLDAFTREKLAME_NOSPT" name="param[TBLDAFTREKLAME_NOSPT]">
													</label>
												</section>
												<section class="col col-md-2">
													<p>TGL SPT</p>
											...
											<div class="row">
												...
												<section class="col col-md-1">
													<label class="input">
														<input class="input-sm text-align-right" type="text" id="TBLDAFTREKLAME_NOSPTD" name="param[TBLDAFTREKLAME_NOSPTD]">
													</label>
												</section>
											</div>
	...
	<script type="text/javascript">
		...
		function generateAutocompleteWP() {
			$('#TBLDAFTAR_NOPOK').autocomplete({
				serviceUrl: 'penetapan/keringanan_reklame_tetap/autocompletewp',
		...
		/*$('#TBLDAFTREKLAME_PENEMPATAN').keydown(function (e) {
			if (e.keyCode == 13) {
				e.preventDefault();
				return false;
			}
		...
		function cekPernahDaftar() {
			...
			if (TBLDAFTAR_NOPOK=='') {
				...
				$.ajax({
					url: 'penetapan/keringanan_reklame_tetap/CekPernahDaftar',
					type: 'POST',
					dataType: 'json',
					data: {
		...
		function cari() {
			...
			if (TBLDAFTAR_NOPOK=='') {
				...
				$.ajax({
					url: 'penetapan/keringanan_reklame_tetap/getdata',
					type: 'POST',
					dataType: 'json',
					data: {
...
function cetakPengambilan() {
	window.open('<?= Yii::app()->getBaseUrl(1); ?>/penetapan/keringanan_reklame_tetap/cetakPengambilan?');
}

function cetakJabong() {
	window.open('<?= Yii::app()->getBaseUrl(1); ?>/penetapan/keringanan_reklame_tetap/cetakJabong?');
}

function cetakIzinReklame() {
	window.open('<?= Yii::app()->getBaseUrl(1); ?>/penetapan/keringanan_reklame_tetap/cetakIzinReklame?');
}
...
function simpanPendataan() {
	...
	$.ajax({
		url: 'penetapan/keringanan_reklame_tetap/simpanPendataan',
		type: 'POST',
		dataType: 'json',

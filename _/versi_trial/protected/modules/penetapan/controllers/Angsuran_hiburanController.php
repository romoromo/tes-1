...
class Angsuran_hiburanController extends Controller
{
	var $KODE_GOL = 4;
	var $PAJAK_AYAT = 3;
	var $PAJAK_REK = '4.1.1.3.0';
	var $namatabel = 'TBLDAFTHIBURAN';
	var $modul_url = 'penetapan/angsuran_hiburan';
	var $jenispajak = 'HIBURAN';
	...
	{
		$model = Yii::app()->db->createCommand("SELECT {$this->namatabel}_REGKURANGBAYAR FROM {$this->namatabel} WHERE TBLDAFTAR_NOPOK = ".$TBLDAFTAR_NOPOK." AND TBLPENDATAAN_THNPAJAK = ".$tahun." AND TBLPENDATAAN_BLNPAJAK = ".$bulan." AND NVL(TBLPENDATAAN_TGLPAJAK,0) = 0")->queryScalar();
		return $model;
	}
	...
	public function actiongetdata()
	{
		...
		NVL({$this->namatabel}.{$this->namatabel}_NAKB,0) AS {$this->namatabel}_NAKB,
		...
		$data[''.$this->namatabel.'_NAKB'] = $model[''.$this->namatabel.'_NAKB'];

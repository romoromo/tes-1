...
class Skpdlb_bphtbController extends Controller
{
    var $KODE_GOL    = 1;
    var $PAJAK_AYAT  = 11;
    var $PAJAK_REK   = '4.1.1.11.0';
    var $MODUL_URL   = 'penetapan/skpdlb_bphtb';

    public $namatabel  = 'TBLDAFTBPHTB';
    public $PAJAK_NAMA = 'BPHTB';
    ...
    public function actiongetdata()
    {
        ...
        if ($proses == '') {
            ...
            $otherquery = array(
                'limit' => 30, 'join' => array('REFBADANUSAHA', 'REFBADANUSAHA.REFBADANUSAHA_ID= TBLDAFTAR.REFBADANUSAHA_IDPEMILIK'), 'join_2' => array('TBLLBHBAYAR', "TBLDAFTAR.TBLDAFTAR_NOPOK = TBLLBHBAYAR.TBLDAFTAR_NOPOK"), 'order' => 'TBLDAFTAR.TBLDAFTAR_NOPOK ASC'
            );
            ...
            $otherquery = array(
                'limit' => 30, 'join' => array('REFBADANUSAHA', 'REFBADANUSAHA.REFBADANUSAHA_ID= TBLDAFTAR.REFBADANUSAHA_IDPEMILIK'), 'join_2' => array("{$this->namatabel}", "TBLDAFTAR.TBLDAFTAR_NOPOK = {$this->namatabel}.TBLDAFTAR_NOPOK"), 'order' => 'TBLDAFTAR.TBLDAFTAR_NOPOK ASC'
            );
            $model = DBFetch::query(array('select' => $select, 'from' => $from, 'filter' => $filter, 'filter_AND' => $filter_AND, 'filterOR' => true, 'otherquery' => $otherquery, 'mode' => 'DETAIL'));

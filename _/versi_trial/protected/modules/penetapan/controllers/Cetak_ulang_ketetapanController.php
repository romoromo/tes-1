...
class Cetak_ulang_ketetapanController extends Controller
{
    ...
    public function actionCari()
    {
        ...
        if ($JENIS_PAJAK=='AIRTANAH') {
            ...
            $filter = array(
                ...
                ,$FIND.'__TBLDAFTREKLAME.TBLDAFTREKLAME_JNSREKLAME' => 'T'
    ...
    public function actionCetakSKPDWordAirtanah()
    {
        ...
        foreach ($data['list_skpd'] as $kolom) :
            ...
            $skpd['tglcetak'] = $kolom['TBLDAFTTANAH_TGLSKPD'] .' '. LokalIndonesia::getBulan($kolom['TBLDAFTTANAH_BLNSKPD']);
            $skpd['thncetak'] =  '20'. $kolom['TBLPENDATAAN_THNPAJAK'];
    ...
    public function actionCetakDaftarWord()
    {
        ...
        // echo $pecahtglskpd .' '. LokalIndonesia::getbulan($pecahbulanskpd) .' '. $pecahthnskpd;die();
        ...
        $totalpajak = array('totalpajak'=>0); $skpd = array('blnpajak'=>0); $totaljumrek = array('totaljumrek'=>0); $no=1;foreach ($data['list_skpd'] as $kolom) :
            ...
            if ($TBLDAFTREKLAME_JNSREKLAME == 'T') {
                $GLOBALS['jenis3'] = '/REKLAME TETAP';
            } else if ($TBLDAFTREKLAME_JNSREKLAME == 'I') {
                $GLOBALS['jenis3'] = '/REKLAME INSIDENTIL';
            } else {
                $GLOBALS['jenis3'] = '/REKLAME TETAP DAN INSIDENTIL';
            }
        ...
        $GLOBALS['tglskp'] = $pecahtglskpd .' '. LokalIndonesia::getbulan($pecahbulanskpd) .' '. $pecahthnskpd;
        ...
        // $GLOBALS['tglskpd'] = date('d') .' '. LokalIndonesia::getbulan(date('m')) .' '. date('Y');

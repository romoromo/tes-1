...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i>  Entri Setoran Transfer Pajak BPHTB</h4>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	...
	function cari() {
		...
		$.ajax({
			url: 'Setoranpajak_Trasfer/pajak_bphtb/getdata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun : $('#tahun').val(),
...
function simpan() {
	...
	if (NOMOR_SSPD=='') {
		...
		$.ajax({
			url: 'Setoranpajak_Trasfer/pajak_bphtb/simpandata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun : $('#tahun').val(),
...
function getrekening(kode) {
	$.ajax({
		url: 'Setoranpajak_Trasfer/pajak_bphtb/getrekening',
		type: 'POST',
		dataType: 'json',
		data: {
			kode : kode,
...
function cetakSSPD() {
	...
	window.open('Setoranpajak_Trasfer/pajak_bphtb/cetakSSPD/?'+jQuery.param(param));
}

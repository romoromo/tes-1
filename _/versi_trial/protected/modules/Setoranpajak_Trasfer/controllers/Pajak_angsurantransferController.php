...
class Pajak_angsurantransferController extends Controller
{
	...
	public function actionCetakSSPD()
	{
		...
		$otherquery = array(
			...
			,'join_seto'=>array("TBLSETOR", "TBLANGSURAN.TBLDAFTAR_NOPOK=TBLSETOR.TBLDAFTAR_NOPOK AND TBLANGSURAN.TBLPENDATAAN_THNPAJAK=TBLSETOR.TBLPENDATAAN_THNPAJAK AND TBLANGSURAN.TBLPENDATAAN_BLNPAJAK=TBLSETOR.TBLPENDATAAN_BLNPAJAK AND TBLSETOR.TBLSETOR_JNSKETETAPAN='A' AND TBLSETOR_JNSBAYAR LIKE '%SKPD-A%' AND TBLANGSURAN.TBLANGSURAN_PAJAKKE=TBLSETOR.TBLPENDATAAN_PAJAKKE")
			);
	...
	public function CetakWordSSPD($data=array())
	{
		...
		$nominal2 = $IS_DENDA ? $rowWP['TBLSETOR_DENDAKETETAPAN'] : 0;
	...
	public function actionsimpan()
	{
		...
		if ($exist=='ada') {
			...
			if (LokalIndonesia::toAngka($bunga)>1) {
				...
				$arrayOfData['TBLSETOR_REKJENIS'] = $_REQUEST['TBLREKENING_REKAYAT'];
				$arrayOfData['TBLSETOR_REKSUBJENIS'] = '0';
				$arrayOfData['TBLSETOR_STATUSBAYAR'] = '10';
				$arrayOfData['TBLSETOR_LOKET'] = substr( "BKP " . Yii::app()->user->nama_pengguna . '    ' . date('H:i:s'), 0, 24);
				$arrayOfData['KDMED'] = '0'; 
				$arrayOfData['KDREF'] = '0'; 
				$arrayOfData['KDSET'] = '1'; 
				$arrayOfData['LUNAS'] = 'L'; 
			...
			if (LokalIndonesia::toAngka($denda)>1) {

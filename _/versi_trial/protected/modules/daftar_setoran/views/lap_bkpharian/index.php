...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Cetak Laporan BKP (s/d Hari ini)
			</h4>
		</div>
	</div>
</div>
	...
	<div class="row">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<header>
				...
				<h2>Cetak Laporan BKP (s/d Hari ini)</h2>
			...
			<div>
				...
				<div class="widget-body no-padding">
					...
					<form action="" id="form_sumber_pajak" class="smart-form" novalidate>
						...
						<footer>
							<button type="button" class="btn btn-sm btn-primary" onclick="cetak()"> Cetak HTML</button>    
...
<script type="text/javascript">
	...
	function cetak () {
		...
		if ($('#tgl_setor').val()=='') {
			...
			window.open('<?php echo Yii::app()->getBaseUrl(1) ?>/daftar_setoran/lap_bkpharian/Cetak?tgl_setor='+tgl_setor);
		}
	}
	...
	function CetakWord() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/daftar_setoran/lap_bkpharian/CetakWord?'+ param);
	}

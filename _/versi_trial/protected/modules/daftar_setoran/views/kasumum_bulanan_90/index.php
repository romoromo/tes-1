 					...
 					<div class="widget-body no-padding">
 						...
 						<form action="" id="form_sumber_pajak" class="smart-form" novalidate>
 							...
 							<footer>
 								...
 								<button type="button" class="btn btn-sm btn-primary" onclick="CetakWord2()">
 									<i class="fa fa-table"></i> Cetak Rekap 2021
 								</button> 
 							</footer>					
 						</form>
 ...
 <script type="text/javascript">
 	...
 	function CetakWord2() {
 		...
 		window.open('<?= Yii::app()->getBaseUrl(1); ?>/<?= $this->MODULE_URL ?>/CetakWord2?'+ param);
 	}

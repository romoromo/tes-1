...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Cetak Rekap Penerimaan Per-Ayat Pajak
			</div>
		</div>
	</div>
	...
	<section id="widget-grid" class="">
		...
		<div class="row">
			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<div class="jarviswidget jarviswidget-color-teal" id="wid-id-cetak_perayat" 
			...
			<header>
				...
				<h2>Form Cetak Rekapitulasi Penerimaan Harian</h2>
...
<script type="text/javascript">
	...
	function cetak () {
		...
		window.open(URL_APLIKASI+"/<?= $this->MODULE_URL ?>/cetak?tahun="+window.tahun+"&bulan="+window.bulan);
	}
	...
	function CetakWord_lama() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/daftar_setoran/penerimaan_perayat/CetakWord?'+ param);
	}
</script>
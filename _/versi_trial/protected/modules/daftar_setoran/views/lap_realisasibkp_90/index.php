...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Cetak Laporan Realisasi Penerimaan BKP
			</h4>
		</div>
	</div>
</div>
					...
					<form action="" id="form_sumber_pajak" class="smart-form" novalidate>
						<fieldset>
								...
								<section class="col col-md-2">
									<div class="row">
										<div class="col col-15">
											<label class="input"> 
												<input type="number" value="<?php echo date('Y'); ?>"  id="tahun" name="tahun">
											</label>
										</div>
									</div>
								</section>
							...
							<div class="row">
								...
								<section class="col col-md-2">		
									<label class="input"> 
										<input value="<?php echo date('d') ?>" type="number" name="tanggal" id="tanggal">
									</label>
								</section>
							</div>
						</fieldset>	
...
<script type="text/javascript">
	...
	function CetakWord_lama() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/daftar_setoran/lap_realisasibkp/CetakWord?'+ param);
	}
</script>
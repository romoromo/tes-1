...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Validasi Jabong Insidentil</h4>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	...
	function generateAutocompleteWP() {
		$('#nopok').autocomplete({
			serviceUrl: 'validasi/jabong_insident/autocompletewp',
	...
	function cari() {
		$.ajax({
			url: 'validasi/jabong_insident/getdata',
			type: 'POST',
			dataType: 'json',
			data: {
	...
	function simpan() {
		...
		$.ajax({
			url: 'validasi/jabong_insident/simpandata',
			type: 'POST',
			dataType: 'json',
	...
	function cetak() {
		...
		window.open('validasi/jabong_insident/cetak/?'+jQuery.param(param));
	}

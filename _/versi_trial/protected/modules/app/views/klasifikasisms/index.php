...
<div class="well well-sm well-light">
	<h1 class="text-center font-lg"><i class="fa fa-archive"></i> Klasifikasi SMS</h1>
</div>
<!-- widget grid -->
<section id="widget-grid" class="">
	...
	<div class="row">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget jarviswidget-color-red" id="wid-id-cari" data-widget-fullscreenbutton="false" data-widget-deletebutton="false" data-widget-sortable="false" data-widget-fullscreenbutton="false" data-widget-deletebutton="false" data-widget-sortable="false" data-widget-editbutton="false">
				<!-- widget options:
	...
	<div class="row">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<!-- Widget ID (each widget will need unique ID)-->
			<div class="jarviswidget jarviswidget-color-yellow" id="wid-id-0" data-widget-fullscreenbutton="false" data-widget-deletebutton="false" data-widget-sortable="false" data-widget-editbutton="false">
				<!-- widget options:
				usage: <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class="fa fa-fw fa-2x fa-file-text-o"></i>&nbsp;Form Klasifikasi SMS</h4>
			</div>
				...
				<fieldset>
					<section>
						<div class="row">
							...
							<div class="col col-5">
								<label class="input">
									<input type="text" id="klasifikasisms">
								</label>
							</div>
						</div>
					</section>

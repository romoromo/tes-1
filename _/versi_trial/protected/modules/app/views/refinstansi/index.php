			...
			<div>
				...
				<div class="widget-body no-padding">
					<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
						<thead>
							<tr>
								<th width="21%"><div align="center">No</div></th>
								<th width="45%" data-class="expand"><i class=" text-muted hidden-md hidden-sm hidden-xs"></i>Nama Instansi</div></th>
								<th>&nbsp;</th>
							</tr>
						</thead>
						<tbody>

						<?php $no=1; foreach ($datainstansi as $instansi): ?>
							<tr>
								<td><?php echo $no++; ?></td>
								<td><?php echo $instansi['refinstansi_nama']; ?></td>
								<td>
								<button onclick="edit(<?php echo $instansi['refinstansi_id']; ?>)" type="button" class="btn btn-labeled btn-success btn-sm" style="width:65px; height:30px;">
								    		
								    			<i class="fa fa-edit"></i>
								    		Edit
								</button>

								<button  onclick="hapus(<?php echo $instansi['refinstansi_id']; ?>)" type='button' class='btn btn-labeled btn-danger btn-sm' style="width:65px; height:30px;">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title" id="myModalLabel"><i class="fa fa-check"></i>&nbsp;Form Tambah Instansi</h4>
								</div>
								<form action="" id="form-instansi" class="smart-form" novalidate>
									<fieldset>
										...
										<div class="row">
											...
											<section class="col col-8">
													<label class="input">
														<input class="input-sm" type="text" id="nama_instansi" name="data_instansi">
													</label>
											</section>
										</div>
										<hr>
...
<script type="text/javascript">
	...
	function runFormValidation() {
		var $orderForm = $("#form-instansi").validate({
				...
				messages : {
					data_instansi : {
						required : 'Mohon isikan Nama Instansi'
					}
				},
...
function edit(id) {
	...
	window.cmd = "edit";
	$.ajax({
		url: 'app/refinstansi/GetDataInstansi',
		type: 'POST',
		data: {id: id},
		success : function (respon) {
...
function hapus(id) {
	...
	$.SmartMessageBox({
		title : "Konfirmasi",
		content : "Apakah anda yakin akan menghapus Instansi ini?",
		buttons : '[Tidak][Ya]'
	}, function(ButtonPressed) {
		if (ButtonPressed === "Ya") {
			$.ajax({
				url: 'app/refinstansi/HapusDataInstansi',
				type: 'POST',
				data: {id: id},
				success: function  (respon) {
					if (respon=='success') 

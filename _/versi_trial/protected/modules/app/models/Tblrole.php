 ...
 */
class Tblrole extends CActiveRecord
{
	/**
	 ...
	 * @return Tblrole the static model class
	 */
	...
	public function getNama($id)
	{
		...
		if (strtoupper( $model->TBLROLE_CODE ) =="ADMINISTRATOR" OR strtoupper( $model->TBLROLE_CODE ) =="ADMINSISTEM") {
			//jika yg login ADMINISTRATOR maka asumsikan dia sebagai SUPERADMIN juga
			return "SUPERADMIN";
		}
		return strtoupper($model->TBLROLE_CODE);
	}

	public function isRole($role_code)
	{
		if(Tblrole::model()->getNama(Yii::app()->user->role_id)==$role_code)
			return true;
		else 
			return false;
	}

...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="well well-sm well-light bg-color-red txt-color-white">
            <h4><i class="fa fa-file fa-fw"></i> Enrty Data SPTPD Pajak Sarang Burung Walet</h4>
        </div>
    </div>
</div>

<section class="widget-grid">
    <div class="jarviswidget jarviswidget-color-teal" id="wid-erer-7re" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
                <!-- widget options:
            ...
            <header>
                <ul class="nav nav-tabs pull-left in">
                    ...
                    <li class="active">
                        ...
                        <a data-toggle="tab" href="#hr1">  Entry Pajak Sarang Burung Walet  </a>
                                                ...
                                                <table class="table table-bordered">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-center" rowspan="2">
                                                                <h3>SURAT PEMBERITAHUAN <br>PAJAK DAERAH <br>(SPTPD)<br><br><br>PAJAK SARANG BURUNG WALET</h3>
                                                            </td>
                                                            <td>
                                                                <div class="row">
                                                        ...
                                                        <tr>
                                                            <td colspan="3">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <section class="col col-md-8">
                                                                        <label class="select"> 
                                                                            <select class="select2" id="kecamatanS">
                                                                                <option selected="" disabled="">== Silahkan Pilih ==</option>
                                                                                <option>Kecamatan Danurejan</option>
                                                                                <option>Kecamatan Gedong Tengen</option>
                                                                                <option>Kecamatan Gondokusuman</option>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <section class="col col-md-8">
                                                                        <label class="select"> 
                                                                            <select class="select2" id="kelurahanS">
                                                                                <option selected="" disabled="">== Silahkan Pilih ==</option>
                                                                                <option>Bausasran</option>
                                                                                <option>Tegal Panggung</option>
                                                                                <option>Suryatmajan</option>
                                                    ...
                                                    <tbody>
                                                         <tr>
                                                            ...
                                                            <td style="width: 500px;">
                                                                <p align="center">Omset Penjualan </p>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>2. Sarang Burung Sejenisnya</td>
                                                            <td>
                                                                <label for="address" class="input">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <tr>
                                                                <td colspan="3">
                                                                    Dengan menyadarkan sepenuhnya 
                                                                    akan akibatnya termasuk sanksi 
                                                                    sesuai peraturan daerah yang berlaku, 
                                                                    maka saya menyatakan data yang diisikan beserta lampiranya adalah yang sebenar - benarnya
                                                                </td>
                                                            </tr>
                                                        </tr>
                                                        <td colspan="3">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="3" style="width: 200px;"><b>2. Akta dan Perizinan</b></td>
                                        </tr>
                                        <tr>
                                            <td><b>- Izin Usha / HO</b></td>
                                            <td><div class="row">
                                                <section class="col col-md-4"> Nomor </section>
                                            ...
                                            <td><div class="row">
                                                <section class="col col-md-4"> Tanggal </section>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"><div class="row">
                                                <section class="col col-md-4"> Berlaku sampai dengan :  </section>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td colspan="2"><div class="row">
                                                <section class="col col-md-4"> Dikeluarkan oleh :  </section>
                                                <section class="col col-md-7"> 
                                                    <label class="input">
                                                        <input type="text" name="card">
                                                    </label>
                                        ...
                                        <tr>
                                            <th colspan="3"><p align="left">3. Kapasitas</p></th>
                                        </tr>
                                    </tbody>
                                </table>
                        </div></section>
                    ...
                    <article class="col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <i class="fa fa-lg fa-angle-down pull-right"></i> <i class="fa fa-lg fa-angle-up pull-right"></i> Data Kapasitas</a></h4>
                                </div>
                                        ...
                                        <table id="dt_basic" class="table table-bordered table-striped table-condensed table-hover" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th align="center">Luas Usaha</th>
                                                    <th align="center">Jumlah Sarang</th>
                                                    <th align="center" width="30">Omset</th>
                                ...
                                <section class="col col-md-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            <tbody>
                                               <tr>
                                                <td style="width: 200px;"><b>4. Harga Penjualan</b></td>
                                                <td colspan="2">
                                                    <div class="row">
                                                        <section class="col col-md-4"> Jumlah (Rp) </section>
                                                        <section class="col col-md-4"> 
                                                            <label class="input">
                                                                <input type="text" name="card">
                                                            </label>
                                                    ...
                                                    <tr>
                                                        <td style="width: 200px;"><b>5. Masa Panen</b></td>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td></td>
                                                            <td colspan="2">Berlaku Sampai Dengan : </td>

...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Daftar Wajib Pajak Daerah per Numeklatur</h4>
		</div>
	</div>
</div>
				...
				<div class="jarviswidget jarviswidget-color-orange" id="wid-id-daftar-induk"
					...
					<div>
						...
						<p class="alert alert-info"> 
							<button type="button" class="btn btn-default" onclick="cetak_grid('html')">
								<i class="fa fa-print"></i> Cetak 
							</button>
							<!-- <button type="button" class="btn btn-default" onclick="cetak()">
								<i class="fa fa-print"></i> Cetak Daftar WP Excel
							</button>
...
<script type="text/javascript">
	...
	function generateAutocompleteWP() {
		$('#TBLDAFTAR_NOPOK').autocomplete({
			serviceUrl: 'pengembangan/wp_pernumeklatur/autocompletewp',
	...
	function cari() {
			...
			$.ajax({
				url: 'pengembangan/wp_pernumeklatur/GetData',
				type: 'POST',
				data:  {
	...
	function cetak() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pengembangan/wp_pernumeklatur/cetak?' + param);
	}
	...
	function cetak_daftarWord() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pengembangan/wp_pernumeklatur/cetakWord?' + param);
	}
	...
	function cetak_status() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pengembangan/wp_pernumeklatur/cetak_status?' + param);
	}
	...
	function loadDataTable() {
		...
		$.ajax({
			url: 'pengembangan/wp_pernumeklatur/cari',
			type: 'POST',
	...
	function cetak_grid(tipe) {
        window.open('<?php echo Yii::app()->baseUrl; ?>/pengembangan/wp_pernumeklatur/Cetak_daftar?tipe='+tipe);
  }
	...
	function setRekening(val) {
		$.ajax({
			url: 'pengembangan/wp_pernumeklatur/setRekening',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function getKelurahan(val) {
		$.ajax({
			url: 'pengembangan/wp_pernumeklatur/getKelurahan',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function getKelurahanedit(val) {
		$.ajax({
			url: 'pengembangan/wp_pernumeklatur/getKelurahanedit',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function getKelurahanedit2(val) {
		$.ajax({
			url: 'pengembangan/wp_pernumeklatur/getKelurahanedit2',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function simpan () {
		$.ajax({
			url: 'pengembangan/wp_pernumeklatur/Simpan',
			type: 'post',
			dataType: "json",

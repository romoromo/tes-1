...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <div class="well well-sm well-light bg-color-greenLight txt-color-white">
      <h4><i class="fa fa-file-text-o"></i> Data Realisasi Pajak per WP </h4>
    </div>
  </div>
</div>
    ...
    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      >
              ...
              <header role="heading">
                ...
                <h2> Data Realisasi Pajak per WP </h2>
              ...
              <div>
                  ...
                  <form action="" id="form_sumber_pajak" class="smart-form" novalidate>
                    <fieldset>
                      ...
                      <div class="row">
                        ...
                        <section class="col col-sm-2" style="display:none; ">
                          <label class="select">
                ...
                <div class="row" >
                  <section class="col col-md-2">
                    Per Tanggal Bayar Sampai Dengan
                  </section>
                ...
                <footer id="footer_cetakdata">
                  <section class="col col-md-5">
                    <button type="button" class="btn btn-sm btn-primary" onclick="cetak()" >
                      <i class="fa fa-save"></i> Cetak Excel Daftar Kendali
                    </button> 
...
<script type="text/javascript">
  ...
  function cetak () {
        ...
        window.open(window.APP_URL+'/pengembangan/Cek_data_perwptahunv3/cetak?masapajak='+window.masapajak+'&TBLREKENING_KODE='+window.TBLREKENING_KODE+'&cara_penetapan='+window.cara_penetapan+'&TBLKECAMATAN_ID='+window.TBLKECAMATAN_ID+'&JALAN='+window.JALAN+'&bulan='+window.bulan+'&cutoff='+window.cutoff);
      }
  }    
      ...
      window.open('<?= Yii::app()->getBaseUrl(1); ?>/pengembangan/Cek_data_perwptahunv3/cetakword?'+ param);

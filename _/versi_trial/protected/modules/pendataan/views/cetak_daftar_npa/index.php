...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Cetak Daftar NPA Pajak Air Tanah</h4>
		</div>
	</div>
</div>
				...
				<div role="content">
					...
					<div class="widget-body">
						...
						<form id="form-pendataan-restoran" class="smart-form">
							...
							<footer>
								<div id="tbl_simpan" style="display: none;">
									<button type="button" onclick="cetakvol()" class="btn btn-sm btn-success">
										<i class="fa fa-print"></i>&nbsp;Cetak Volume
									</button>
									<button type="button" onclick="cetakNPA()" class="btn btn-sm btn-success">
										<i class="fa fa-print"></i>&nbsp;Cetak NPA
									</button>
									<button type="button" onclick="cetakpajak()" class="btn btn-sm btn-success">
										<i class="fa fa-print"></i>&nbsp;Cetak Pajak
									</button>
								</div>
								<div id="tbl_cari">
...
<script type="text/javascript">
	...
	function cari() {
		...
		$.ajax({
			url: 'pendataan/cetak_daftar_npa/cari',
			type: 'POST',
			data: {
		...
		.done(function(respon) {
			...
			$("#tbl_simpan").show('fast');
		})
		.fail(function() {
			console.log("error");
			$("#tbl_simpan").hide('fast');
		})
		.always(function() {
	...
	function cetakvol() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/cetak_daftar_npa/cetakvol?' + param);
	}
	...
	function cetakNPA() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/cetak_daftar_npa/cetakNPA?' + param);
	}
	...
	function cetakpajak() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/cetak_daftar_npa/cetakpajak?' + param);
	}

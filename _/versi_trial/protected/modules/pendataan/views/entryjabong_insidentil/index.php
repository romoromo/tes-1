            ...
            <form id="form-data-jabonginsidentil" class="smart-form">
              <fieldset>
                ...
                <div class="row">
                  ...
                  <section class="col col-md-2">
                    <label class="input">
                      <input class="input-sm" type="number" id="TBLPENDATAAN_THNPAJAK" name="TBLPENDATAAN_THNPAJAK" value="<?= date('Y') ?>" placeholder="Tahun" maxlength="4">
                    </label>
                  </section>
                    ...
                    <div id="myTabReklameContent" class="tab-content padding-10">
                      ...
                      <div class="tab-pane fade in active" id="tabrek2">
                        ...
                        <div class="row bold">
                          ...
                          <section class="col-md-2">
                            <button class="btn btn-sm btn-primary" type="button" id="tombolhitung" onclick="hitungJabong()">
...
<script type="text/javascript">
  ...
  function hitungJabong() {
    ...
    if (idrek == '81' || '83' || '85' || '87' || '89') {
      tot_jmljabong = Math.round(jumlahjabong * jumlahrek);
    } else {
      tot_jmljabong = Math.round(jumlahjabong * luasreklame * jumlahrek);
    }
        ...
        success: function(respon) {
          if (respon.data == 'sudah entri') {
            ...
            $.SmartMessageBox({
              ...
              buttons: '[Edit][Cetak Ulang]' // pengaturan tombol
              ...
              $('#TBLDAFTREKLAME_HRGDASARJABONG').val(respon.TBLDAFTREKLAME_HRGDASARJABONG);

						...
						<fieldset>
							...
							<div class="row">
								...
								<section class="col col-md-2">
									<label class="select">
										<label class="input">
											<input type="number" value="<?php echo date('Y'); ?>" class="form-control" type="text" id="masapajak_tahun" name="masapajak_tahun" param="TBLPENDATAAN_THNPAJAK">
										</label>
									</label>
								</section>
							</div>
							...
							<div class="row">
								...
								<section class="col col-md-5">
									<label class="input">
										<input class="form-control" type="text" name="nopok" id="nopok">
									</label>
								</section>
							</div>
...
<script type="text/javascript">
	...
	function cari() {
		...
		$.ajax({
			url: 'pendataan/cek_data_perwptahun/cari',
			type: 'POST',
			data: {
	...
	function cetak() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/cek_data_perwptahun/cetak?' + param);
	}
	...
	function cetak (jenis) {
		...
		window.open(URL_APLIKASI+"/pendataan/cek_data_perwptahun/cetak?jenis="+jenis+"&TBLPENDATAAN_THNPAJAK="+window.TBLPENDATAAN_THNPAJAK+"&TBLDAFTAR_NOPOK="+window.TBLDAFTAR_NOPOK+"&rekening="+window.rekening);

...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Daftar Pendataan Pajak Official</h4>
		</div>
	</div>
</div>
					...
					<form action="" id="form_sumber_pajak" class="smart-form" novalidate>
						<fieldset>
							<div class="row">
									...
									<section class="col col-md-2">
										<label class="input">
											<input maxlength="2" type="number" id="TBLPENDATAAN_THNPAJAK" name="param[TBLPENDATAAN_THNPAJAK]" value="<?php echo date('Y'); ?>" placeholder="Tahun" maxlength="4">
										</label>
									</section>
									<section class="col col-md-2">
										<label class="select">
...
<script type="text/javascript">
	...
	function cari() {
		...
		reloadDT('dt_basic');
		$.ajax({
			url: 'pendataan/daftar_verifikasi_pendataan/cari',
			type: 'POST',
			data: {
	...
	function cetak() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/daftar_verifikasi_pendataan/cetak?' + param);
	}
	...
	function cetakWord(jenis) {
		...
		window.open('<?php echo Yii::app()->getBaseUrl(1); ?>/pendataan/daftar_verifikasi_pendataan/cetakWord?' + param);
	}
	...
	function cetak (jenis) {
		...
		window.open(URL_APLIKASI+"/pendataan/daftar_verifikasi_pendataan/cetak?jenis="+jenis+"&"+jQuery.param(data) );

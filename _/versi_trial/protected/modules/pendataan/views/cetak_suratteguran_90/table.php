<table width="100%" class="table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="dt_basic">
	<thead>
		<tr>
			...
			<th data-hide="phone, tablet"><div class="center"> Aksi</div></th>
			<?php endif ?>
			...
			<th data-hide="phone, tablet"><div class="center"> EMail</div></th>
			...
			<th data-hide="phone, tablet"><div class="center"> Status Akun SPTPD</div></th>
			<th> Pajak</th>
			<th> No SSP</th>
			<th> RP SSPD</th>
		</tr>
	...
	<tbody>
		...
		<tr>
			...
			<?php if (Tblrole::model()->isRole('SUPERADMIN') OR in_array(Yii::app()->user->role_id, array(96,97)) ): ?>
			<td>
				<a href="javascript:void(0)" onclick="cetak_record('<?= $row['TBLDAFTAR_NOPOK']; ?>')" class="btn btn-sm btn-default"><i class="fa fa-download"></i> Lihat Draft</a>
			</td>
			<?php endif ?>

...
<div class="row">
    ...
    <div class="well well-sm well-light bg-color-greenLight txt-color-white">
        <h4><i class="fa fa-pencil"></i> Entry Jabong Semi Permanen </h4>
    </div>
    </div>
    </div>
...
<section id="" class="">
    ...
    <form id="form-pendataan-reklame2016_tetap" class="smart-form">
      <fieldset>
        ...
        <button type="button" class="btn btn-sm btn-primary" onclick="cetak()"><i class="fa fa-print"> Cetak Jabong </i></button></footer>
      </form>
      <!-- end widget -->

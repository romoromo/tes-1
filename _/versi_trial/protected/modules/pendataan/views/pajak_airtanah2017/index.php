		...
		$.ajax({
			...
			success : function (respon) {
				...
				if (respon.status=='sudah_disetor') {
					...
					$.SmartMessageBox({
						title : "Informasi", // judul Smart Alert
						content : "Data dengan Nomor Pokok "+window.nopokok+", Masa Pajak "+BLNPAJAK+" "+THNPAJAK+" sudah terbit SKPD/Penetapan. Data sudah tidak bisa diubah.", // konten dari smart alert
						buttons : '[Ya]' // pengaturan tombol
						}, function(ButtonPressed) {
							if (ButtonPressed === "Ya") {
							cari();

...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Entry Pendataan Pajak Reklame Semi Permanen 2016</h4>
		</div>
	</div>
</div>
						...
						<form id="form-pendataan-reklame2016_tetap" class="smart-form">
							<fieldset>
								...
								<div class="row">
									...
									<section class="col col-md-2">
										<label class="input">
											<input value="<?php echo date('d') ?>" type="number" id="TBLDAFTREKLAME_TGLPAJAK" name="param[TBLDAFTREKLAME_TGLPAJAK]" placeholder="Tanggal" maxlength="2">
										</label>
									</section>
	...
	$(document).ready(function() {
		...
		function generateAutocompleteWP() {
			$('#TBLDAFTAR_NOPOK').autocomplete({
				serviceUrl: 'pendataan/reklame2016_semipermanen/autocompletewp',
		...
		function cari() {
			...
			if (TBLDAFTAR_NOPOK=='') {
				...
				$.ajax({
					url: 'pendataan/reklame2016_semipermanen/getdata',
					type: 'POST',
					dataType: 'json',
					data: {
						...
						,tanggal: btoa(TBLPENDATAAN_TGLPAJAK)
					},
...
function cetakPengambilan() {
	window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/reklame2016_semipermanen/cetakPengambilan?');
}

function cetakJabong() {
	window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/reklame2016_semipermanen/cetakJabong?');
}

function cetakIzinReklame() {
	window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/reklame2016_semipermanen/cetakIzinReklame?');
}
...
function simpanPendataan() {
	...
	$.ajax({
		url: 'pendataan/reklame2016_semipermanen/simpanPendataan',
		type: 'POST',
		dataType: 'json',

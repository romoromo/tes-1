...
class Pajak_airtanah2017_90Controller extends Controller
{
	var $KODE_GOL = 1;
	var $PAJAK_AYAT = 12;
	var $PAJAK_REK = '4.1.1.12.0';
	var $PAJAK_SUBJEN = 1;
	var $MODULE_URL = 'pendataan/pajak_airtanah2017_90';
	...
	public function actionIndex()
	{
		...
		WHERE TBLREKENING_KODE LIKE '4.1.1.12.%'
	...
	public function actionautocompletewpairtanah()
	{
		...
		$otherquery = array(
			'limit'=> 30
			,'leftjoin'=> array('REFBADANUSAHA_90 REFBADANUSAHA', 'REFBADANUSAHA.REFBADANUSAHA_ID = TBLDAFTAR.REFBADANUSAHA_IDPEMILIK')
	...
	public function actionGetKodeRek()
	{
		...
		$data = Yii::app()->db->createCommand()->select('*')->from('TBLREKENING_90 TBLREKENING')->where('TBLREKENING_KODE=:kode', array(':kode'=>$kodesubrek))->queryRow();
	...
	public function actionSimpanAirTanah()
	{
		...
		$TBLDAFTTANAH_NILAIAIR1 = isset($_REQUEST['TBLDAFTTANAH_NILAIAIR1']) && !empty($_REQUEST['TBLDAFTTANAH_NILAIAIR1']) ? $_REQUEST['TBLDAFTTANAH_NILAIAIR1'] : 0;
		...
		if($ada_data=='belum'){
			...
			$arrayInsert = array(
				...
				'TBLDAFTTANAH_NILAIAIR1' => LokalIndonesia::toAngka($TBLDAFTTANAH_NILAIAIR1),
				...
				'TBLDAFTTANAH_BUNGASPTPD' => LokalIndonesia::toAngka($TBLDAFTTANAH_BUNGASPTPD),
				...
				'TBLDAFTTANAH_REKAYAT' => $this->PAJAK_AYAT,
				'TBLDAFTTANAH_REKJENIS' => '0',
				'TBLDAFTTANAH_REKSUBJENIS' => $this->PAJAK_SUBJEN,
				'TBLDAFTTANAH_STATUSDATA' => '1',
				'TBLDAFTAR_JNSPENDAPATAN' => 'P',
			);
			$filter = array(

...
class Cek_data_perwptahunv2Controller extends Controller
{
	...
	public function getData(){
		...
		$sql="
		SELECT
			{$namaTBL}.{$namaTBL}_THN{$fieldtglspt} AS {$namaTBL}_THNSKPD,
			{$namaTBL}.{$namaTBL}_BLN{$fieldtglspt} AS {$namaTBL}_BLNSKPD,
			{$namaTBL}.{$namaTBL}_TGL{$fieldtglspt} AS {$namaTBL}_TGLSKPD,
			...
			NVL(NULL,0) AS BUNGA,
			NVL({$namaTBL}.{$namaTBL}_{$fieldpajak}, 0) AS PAJAK,

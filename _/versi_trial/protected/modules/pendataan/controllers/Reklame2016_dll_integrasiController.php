...
class Reklame2016_dll_integrasiController extends Controller
{
	var $KODE_GOL = 2;
	var $PAJAK_AYAT = 4;
...
public function actionCekPernahDaftar()
	...
	public function actionsimpanPendataan()
	{
		...
		// $simpan = $insert->insert('TBLDAFTREKLAME', 
		...
		if ($this->cekPernahDaftar($TBLPENDATAAN_THNPAJAK, $TBLPENDATAAN_BLNPAJAK, $TBLPENDATAAN_TGLPAJAK, $TBLPENDATAAN_PAJAKKE, $TBLDAFTAR_NOPOK)>0) {
			# update
			# 2020-11-19 15:15 jgn update no daftar izin agar tidak hilang - copas reklame insidentil integrasi

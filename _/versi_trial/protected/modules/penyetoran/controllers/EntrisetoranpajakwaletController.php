...
class EntrisetoranpajakwaletController extends Controller
{
	...
	public function CetakWordSSPD($data=array())
	{
		...
		$namafileDL = "SSPD-Sarang-Walet.docx"; 
		...
		$utama['rincireknama2'] = 'BUNGA PAJAK'; //$IS_BUNGA ? 'BUNGA PAJAK' : '';
		...
		$utama['rincirek3'] = '';
		$utama['rincireknama3'] = '';
		$utama['rincinominal3'] = $IS_DENDA ? LokalIndonesia::ribuan($nominal3) : '';

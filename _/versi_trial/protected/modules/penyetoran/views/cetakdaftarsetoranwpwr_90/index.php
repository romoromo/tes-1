				...
				<div class="widget-body no-padding">
					...
					<form action="" id="form_sumber_pajak" class="smart-form" novalidate>
						...
						<footer>
							...
							<button type="button" class="btn btn-sm btn-primary" onclick="cetaksub('wordsub')"><i class="fa fa-print"></i> Cetak Word 2022</button>
							<?php endif ?>
...
<script type="text/javascript">
	...
	function cetak(jenis){
		...
		var carabyr = $('#carabyr').val();
		 ...
		 window.open('<?php echo Yii::app()->getBaseUrl(1) ?>/<?= $this->MODULE_URL ?>/cetak?tahun='+tahun+'&bulan='+bulan+'&tgl='+tgl+'&jenis='+jenis+'&carabyr='+carabyr);
		}

	function cetaksub(jenis){
		var tgl = $('#tgl').val();
		var tahun = $('#tahun').val();
		var bulan = $('#bulan').val();
		var carabyr = $('#carabyr').val();

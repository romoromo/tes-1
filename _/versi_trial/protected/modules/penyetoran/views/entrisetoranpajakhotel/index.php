...
<script type="text/javascript">
	...
	function cari() {
		...
		$.ajax({
			url: 'penyetoran/entrisetoranpajakhotel/getdata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun: $('#tahun').val(),
			...
			success: function(respon) {
				if (respon.data.validate == 'kurang') {
					...
					if (respon.data.exist == 'adasetbpd' || respon.data.exist == 'adaseto') {
	...
	function simpan() {
		...
		if (NOMOR_SSPD == '') {
			...
			$.ajax({
					url: 'penyetoran/entrisetoranpajakhotel/simpandata',
					type: 'POST',
					dataType: 'json',
					data: {
						tahun: $('#tahun').val(),
	...
	function hitungDenda() {
		...
		if (jns_setoran == 'SKPDKB') {
			...
			rpdenda = Number(toAngka($("#<?= $this->namatabel ?>_KENAIKANKRGBAYAR").val()));
	...
	function cetakSSPD() {
		...
		window.open('penyetoran/entrisetoranpajakhotel/cetakSSPD/?' + jQuery.param(param));
	}
</script>
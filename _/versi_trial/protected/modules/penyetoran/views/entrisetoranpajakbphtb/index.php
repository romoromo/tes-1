...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i>  Entri Setoran Pajak BPHTB</h4>
		</div>
	</div>
</div>
					...
					<div class="widget-body no-padding">
						...
						<form action="" id="form_sumber_pajak" class="smart-form" novalidate>
							<fieldset>
								...
								<div id="id_respencarian">
									<div class="row">
										...
										<section class="col col-md-2">
											<span id="TBLDAFTAR_PEMILIKNAMA"></span>
										</section>
										<section class="col col-md-1">
											<p>No Rekening</p>
										</section>
									...
									<div class="row">
										...
										<section class="col col-md-2">
											<span id="TBLDAFTAR_PEMILIKALAMAT"></span>
										</section>
										<section class="col col-md-1">
											<p>Jenis Pajak</p>
										</section>
							...
							<footer id="footer_simpandata">
								<a onclick="simpan()" id="btn-Simpan" href="javascript:void(0)" class="btn btn-sm btn-primary" style="float: left;">
...
<script type="text/javascript">
	...
	function generateAutocompleteWPHotel() {
		$('#nopok').autocomplete({
			serviceUrl: 'penyetoran/entrisetoranpajakbphtb/autocomplete',
	...
	function cari() {
		...
		$.ajax({
			url: 'penyetoran/entrisetoranpajakbphtb/getdata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun : $('#tahun').val(),
			...
			success:function (respon) {
				if (respon.data.validate=='kurang') {
					...
					$('#TBLDAFTAR_PEMILIKNAMA').html(respon.model.TBLDAFTAR_PEMILIKNAMA);
					...
					$('#TBLDAFTAR_PEMILIKALAMAT').html(respon.model.TBLDAFTAR_PEMILIKALAMAT);
	...
	function simpan() {
		...
		if (NOMOR_SSPD=='') {
			...
			$.ajax({
				url: 'penyetoran/entrisetoranpajakbphtb/simpandata',
				type: 'POST',
				dataType: 'json',
				data: {
					tahun : $('#tahun').val(),
	...
	function getrekening(kode) {
		$.ajax({
			url: 'penyetoran/entrisetoranpajakbphtb/getrekening',
			type: 'POST',
			dataType: 'json',
			data: {
				kode : kode,
	...
	function cetakSSPD() {
		...
		window.open('penyetoran/entrisetoranpajakbphtb/cetakSSPD/?'+jQuery.param(param));
	}

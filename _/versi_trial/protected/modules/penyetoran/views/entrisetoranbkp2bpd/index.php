						...
						<fieldset>
							...
							<div class="row">
								...
								<section class="col col-md-2 hidden">
									<label class="input">
										<input value="0" class="input-sm" type="text" id="enopok" name="enopok">
									</label>
								</section>
								<section class="col col-md-1">
									<p>Setoran Ke</p>
					...
					<form action="" id="form_setorlain" class="smart-form" >
						<fieldset>
							...
							<div class="row">
								...
								<section class="col col-md-2">
									<label for="address" class="input">
										<input class="disabled" readonly="" value="20" type="text" name="TBLSETOR_STATUSBAYAR" id="TBLSETOR_STATUSBAYAR">
									</label>
								</section>
							</div>
							<div class="row">
...
<script type="text/javascript">
	...
	jQuery(document).ready(function($) {
		...
		function simpan() {
			...
			$.ajax({
				url: 'penyetoran/entrisetoranbkp2bpd/simpandata',
				type: 'POST',
				dataType: 'json',
	...
	function cari() {
		...
		$.ajax({
			url: 'penyetoran/entrisetoranbkp2bpd/getdata',
			type: 'POST',
			dataType: 'json',
			data: {
		...
		.done(function(respon) {
			if (respon.data.validate=='kurang') {
				...
				if (respon.data.exist=='ada') {
					...
					// 		if (ButtonPressed === "Ya") {
					// 			$.ajax({
					// 				url: 'penyetoran/entrisetoranbkp2bpd/hapus',
					// 				type: 'POST',
					// 				dataType: 'json',

...
<script type="text/javascript">
	...
	function generateAutocompleteWPhiburan() {
		$('#nopok').autocomplete({
			serviceUrl: 'penyetoran/entrisetoranpajakhiburan/autocomplete',
	...
	function cari() {
		...
		$.ajax({
			url: 'penyetoran/entrisetoranpajakhiburan/getdata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun: $('#tahun').val(),
	...
	function simpan() {
		...
		if (NOMOR_SSPD == '') {
			...
			$.ajax({
					url: 'penyetoran/entrisetoranpajakhiburan/simpandata',
					type: 'POST',
					dataType: 'json',
					data: {
						tahun: $('#tahun').val(),
	...
	function getrekening(kode) {
		$.ajax({
			url: 'penyetoran/entrisetoranpajakhiburan/getrekening',
			type: 'POST',
			dataType: 'json',
			data: {
				kode: kode,
	...
	function cetakSSPD() {
		...
		window.open('penyetoran/entrisetoranpajakhiburan/cetakSSPD/?' + jQuery.param(param));
	}
</script>
...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i>  Entri Setoran Pajak Hiburan</h4>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	...
	function generateAutocompleteWPHotel() {
		$('#nopok').autocomplete({
			serviceUrl: 'penyetoran/entrisetoranpajakhiburan2/autocomplete',
	...
	function cari() {
		...
		$.ajax({
			url: 'penyetoran/entrisetoranpajakhiburan2/getdata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun : $('#tahun').val(),
	...
	function simpan() {
		...
		if (NOMOR_SSPD=='') {
			...
			$.ajax({
				url: 'penyetoran/entrisetoranpajakhiburan2/simpandata',
				type: 'POST',
				dataType: 'json',
				data: {
					tahun : $('#tahun').val(),
	...
	function getrekening(kode) {
		$.ajax({
			url: 'penyetoran/entrisetoranpajakhiburan2/getrekening',
			type: 'POST',
			dataType: 'json',
			data: {
				kode : kode,
	...
	function cetakSSPD() {
		...
		window.open('penyetoran/entrisetoranpajakhiburan2/cetakSSPD/?'+jQuery.param(param));
	}

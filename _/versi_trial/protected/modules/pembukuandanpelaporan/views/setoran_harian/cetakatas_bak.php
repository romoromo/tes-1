...
<thead>  
  <tr>
    ...
    <td align="center" width="33%">TANGGAL CETAK : <?php echo LokalIndonesia::TanggalUmum(date('Y-m-d')); ?> </td>
  </tr>
</thead>
<tbody>
  <tr>
    <td align="left">DAN ASET DAERAH</td>
    <td align="center">BULAN SETOR : <?php echo strtoupper(LokalIndonesia::getBulan($bulan = $_REQUEST['bulan'])) ?> <?php echo $tahun = $_REQUEST['tahun'] ?></td>
    <td align="center"></td>
  </tr>
</tbody>
</table>
...
<tbody>   
    <tr>
      ...
      <td align="center"><?php echo $list['TBLSETOR_TGLSETOR'] ?>-<?php echo $list['TBLSETOR_BLNSETOR'] ?>-20<?php echo $list['TBLSETOR_THNSETOR'] ?></td> <!-- TG. SETOR -->

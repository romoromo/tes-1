...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <div class="well well-sm well-light bg-color-greenLight txt-color-white">
      <h4><i class="fa fa-file-text-o"></i> Cetak Buku Kendali SKPDKB </h4>
    </div>
  </div>
</div>
      ...
      >
                    ...
                    <fieldset>
                      <div class="row">
                        ...
                        <section class="col col-sm-3">
                          <label class="input">
                           <input  class="input-sm" value="<?php echo date('Y'); ?>" type="number" maxlength="4" id="tahunpjk" name="param[tahunpjk]">
                         </label>
                       </section>
                     </div>
                    <div class="row">
                          <section class="col col-2">
                            <p>Tahun Penetapan SK-Kurang Bayar</p>
                        </section>
            ...
            <div class="row">
              <footer id="footer_cetakdata">
                ...
                <section class="col col-md-2">
                  <button type="button" class="btn btn-sm btn-primary" onclick="cetakv2()" style="float: left;">
...
<script type="text/javascript">
  ...
  function cetak () {
    ...
    window.open(window.APP_URL+'/pembukuandanpelaporan/Daftra_bukukendali_skpdb/cetak?tahunpjk='+window.tahunpjk+'&TBLREKENING_KODE='+window.TBLREKENING_KODE);
  }
  ...
  function cetakv2 () {
    var TBLREKENING_KODE = $('#TBLREKENING_KODE').val();
        ...
        notifikasi('Informasi','Mohon isikan Rekening Pajak','failed',1,0);
          ...
          window.TBLREKENING_KODE = $('#TBLREKENING_KODE').val();
          window.APP_URL = "<?php echo $data['URL_APP']; ?>";
          window.open(window.APP_URL+'/pembukuandanpelaporan/Daftra_bukukendali_skpdb/cetakv2?tahunpjk='+window.tahunpjk+'&TBLREKENING_KODE='+window.TBLREKENING_KODE+'&tahun_penetapan='+window.tahun_penetapan);
        }
   }     

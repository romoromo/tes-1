...
<script type="text/javascript">
	...
	function generateAutocompleteWP() {
		...
		$('#nopok').autocomplete({
			serviceUrl: 'pembukuandanpelaporan/cek_data_perwptahunv3/autocompletewpv2',
	...
	function cetak(jenis) {
		...
		window.open(URL_APLIKASI+"/pembukuandanpelaporan/cek_data_perwptahunv3/cetak?jenis="+jenis+"&TBLPENDATAAN_THNPAJAK="+window.TBLPENDATAAN_THNPAJAK+"&TBLDAFTAR_NOPOK="+window.TBLDAFTAR_NOPOK+"&rekening="+window.rekening);

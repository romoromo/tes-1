...
<div class="row">
	...
	<script type="text/javascript">
		...
		function cetak(jenis){
			...
			var tahun = $('#tahun').val();
			window.open('<?php echo Yii::app()->getBaseUrl(1) ?>/pembukuandanpelaporan/laporan_tunggakan/Cetak?nopok='+nopok+'&TBLREKENING_KODE='+TBLREKENING_KODE+'&tahun='+tahun+'&jenis='+jenis);
		}

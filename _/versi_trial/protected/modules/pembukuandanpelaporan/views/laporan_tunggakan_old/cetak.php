...
<style type="text/css">
  ...
  -->
	...
	<tr>
		<td align="center">DAFTAR TUNGGAKAN <?php echo $data['judul'] ?> BERDASARKAN SKPD TAHUN <?php echo $tahun = $_REQUEST['tahun'] ?></td>
	</tr>
</thead>
<tbody>
	<tr>
...
<table width="100%" border="1" style="border-collapse:collapse;" cellpadding="0" cellspacing="0" class="table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" >
	...
	<?php $no=1; foreach ($data['cetak'] as $list) :?>
		<tr>
			<td align="center"><?php echo $list['TBLDAFTHOTEL_THNKURANGBAYAR'] ?>/<?php echo $list['TBLDAFTHOTEL_BLNKURANGBAYAR'] ?>/<?php echo $list['TBLDAFTHOTEL_TGLKURANGBAYAR'] ?></td>

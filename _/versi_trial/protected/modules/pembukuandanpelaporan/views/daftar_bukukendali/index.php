...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <div class="well well-sm well-light bg-color-greenLight txt-color-white">
      <h4><i class="fa fa-file-text-o"></i> Cetak Buku Kendali </h4>
    </div>
  </div>
</div>
...
<script type="text/javascript">
  ...
  function cetak () {
        ...
        window.open(window.APP_URL+'/pembukuandanpelaporan/Daftar_bukukendali/cetak?masapajak='+window.masapajak+'&TBLREKENING_KODE='+window.TBLREKENING_KODE+'&cara_penetapan='+window.cara_penetapan+'&TBLKECAMATAN_ID='+window.TBLKECAMATAN_ID+'&JALAN='+window.JALAN+'&bulan='+window.bulan+'&cutoff='+window.cutoff);
      }
  }    
      ...
      window.open('<?= Yii::app()->getBaseUrl(1); ?>/pembukuandanpelaporan/Daftar_bukukendali/cetakword?'+ param);

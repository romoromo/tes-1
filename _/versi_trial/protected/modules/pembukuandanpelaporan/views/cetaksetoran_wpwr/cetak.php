  ...
  -->
      ...
      <thead>  
        <tr>
          ...
          <td align="center">Tanggal: <?php echo $tanggal = $_REQUEST['tanggal'] ?>/<?php echo LokalIndonesia::getBulan($bulan = $_REQUEST['bulan']) ?>/<?php echo $tahun = $_REQUEST['tahun'] ?> <?php //echo LokalIndonesia::TanggalUmum($tgl_setor = $_REQUEST['tgl_setor']) ?> </td>
        </tr>
      </thead>
      <tbody>
        <tr>

	...
	public function actionCetak()
	{
		...
		switch ( $rek ) {
			case '1':
				...
				$data['namapajak'] = 'PAJAK_HOTEL';
				break;
			
			case '2':
				$namaTBL = 'TBLDAFTRMAKAN';
				$data['namapajak'] = 'PAJAK_RUMAHMAKAN';
				break;
			
			case '3':
				$namaTBL = 'TBLDAFTHIBURAN';
				$data['namapajak'] = 'PAJAK_HIBURAN';
				break;
			
			case '4':
				$namaTBL = 'TBLDAFTREKLAME';
				$data['namapajak'] = 'PAJAK_DAFTARREKLAME';
				break;
			
			case '5':
				$namaTBL = 'TBLDAFTPARKIR';
				$data['namapajak'] = 'PAJAK_DAFTPARKIR';
				break;
			
			case '6':
				$namaTBL = 'TBLDAFTTANAH';
				$data['namapajak'] = 'PAJAK_DAFTTANAH';
				break;
			
			case '7':
				$namaTBL = 'TBLDAFTBURUNG';
				$data['namapajak'] = 'PAJAK_DAFTBURUNG';
				break;

...
function cari () {
			...
			$.ajax({
				url: 'penagihan/daftartunggakan_skpdkb/Cari',
				type: 'POST',
				data: {
      ...
      window.open('<?php echo Yii::app()->getBaseUrl(1) ?>/penagihan/daftartunggakan_skpdkb/Cetak?TBLDAFTAR_NOPOK='+TBLDAFTAR_NOPOK+'&TBLREKENING_KODE='+TBLREKENING_KODE+'&tahunkb='+tahunkb+'&jenis='+jenis+'&tahunpjk='+tahunpjk+'&tgl_cutoff='+tgl_cutoff+'&tahunpjk_akhir='+tahunpjk_akhir+'&tahunkb_akhir='+tahunkb_akhir);
    }
    ...
    function CetakExcel(){
      ...
      window.open('<?= Yii::app()->getBaseUrl(1); ?>/penagihan/daftartunggakan_skpdkb/Cetak?'+ param);
    }
    ...
    function CetakWord(){
      ...
      window.open('<?= Yii::app()->getBaseUrl(1); ?>/penagihan/daftartunggakan_skpdkb/CetakWord?'+ param);
    }

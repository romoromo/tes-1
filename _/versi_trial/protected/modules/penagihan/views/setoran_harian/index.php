...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="well well-sm well-light bg-color-greenLight txt-color-white">
            <h4><i class="fa fa-file-text-o"></i> Cetak Setoran Harian </h4>
        </div>
    </div>
</div>
                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-3">
                                        <label class="input"> <i></i>
                                            <input type="number" name="tanggal" id="tanggal" value="<?php echo date('d'); ?>" onkeypress="returnisNumberKey(event)"> 
                                        </label>
                                    </section>
                                </div>                       
                                <div class="row">
...
<script type="text/javascript">
    ...
    function cetakkecilatas(){
        ...
        window.open('<?php Yii::app()->getBaseUrl(1); ?>/penagihan/setoran_harian/cetakkecilatas?tahun='+tahun+'&bulan='+bulan+'&tanggal='+tanggal+'&rekening='+rekening);
    }
    ...
    function cetakatas(){
        ...
        var tanggal = $('#tanggal').val();
        var rekening = $('#rekening').select2('val');
        window.open('<?php Yii::app()->getBaseUrl(1); ?>/penagihan/setoran_harian/cetakatas?tahun='+tahun+'&bulan='+bulan+'&tanggal='+tanggal+'&rekening='+rekening);
    }
    ...
    function cetakatashtml(){
        if ($('#rekening').select2('val')=='') {
            ...
            var tanggal = $('#tanggal').val();
            var rekening = $('#rekening').select2('val');
            window.open('<?php Yii::app()->getBaseUrl(1); ?>/penagihan/setoran_harian/cetakatashtml?tahun='+tahun+'&bulan='+bulan+'&tanggal='+tanggal+'&rekening='+rekening);
    ...
    function cetakkecilbawah(){
        ...
        window.open('<?php Yii::app()->getBaseUrl(1); ?>/penagihan/setoran_harian/cetakkecilbawah?rekening='+rekeningbwh+'&tglawl='+tglawl+'&tglakhir='+tglakhir+'&tahun='+tahun+'&bulan='+bulan+'&tanggal='+tanggal);
    ...
    function cetakbawah(){
     ...
     var tglawl= $('#tglawl').val();
     var tglakhir= $('#tglakhir').val();
     window.open('<?php Yii::app()->getBaseUrl(1); ?>/penagihan/setoran_harian/cetakbawah?rekening='+rekeningbwh+'&tglawl='+tglawl+'&tglakhir='+tglakhir+'&tahun='+tahun+'&bulan='+bulan+'&tanggal='+tanggal);
 }
 ...
 function cetakbawahhtml(){
   if ($('#rekeningbwh').select2('val')=='') {
    notifikasi('Informasi','Mohon Isikan Rekening Pajak','failed',1,0);
        ...
        var tglawl= $('#tglawl').val();
        var tglakhir= $('#tglakhir').val();
        window.open('<?php Yii::app()->getBaseUrl(1); ?>/penagihan/setoran_harian/cetakbawahhtml?rekening='+rekeningbwh+'&tglawl='+tglawl+'&tglakhir='+tglakhir+'&tahun='+tahun+'&bulan='+bulan+'&tanggal='+tanggal);

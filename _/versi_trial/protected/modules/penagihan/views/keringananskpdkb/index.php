...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Telaah Keringanan SKPDKB</h4>
		</div>
	</div>
</div>
...
<script type="text/javascript">
  ...
  $('#pemohon').autocomplete({
    serviceUrl: '<?php echo Yii::app()->getBaseUrl(1); ?>/penagihan/keringananskpdkb/AutocompletePegawai',

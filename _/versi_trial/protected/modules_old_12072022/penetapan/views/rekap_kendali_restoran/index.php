...
<div class="well well-sm well-light bg-color-greenLight txt-color-white">
            <h4><i class="fa fa-file-text-o"></i> Cetak Laporan Kendali Restoran </h4>
</div>
</div>
</div>
...
<div class="jarviswidget jarviswidget-color-teal" id="wid-id-validasi_penyetoran" 
      ...
      <header role="heading">
        <span class="widget-icon"><i class="fa fa-list-ul"></i></span>
          <h2>Daftar Kartu Data Pajak Restoran </h2>
                  ...
                  <section class="col col-3">
                      <label class="select">
                              <select class="input-md" enabled="enabled">
                                ...
                                <option value="1" >SEKATEN (RUMAH MAKAN)</option>
                                <option value="2" >TUNGGAKAN PAJAK RESTORAN</option>
                                <option value="3" >RESTORAN</option>
                                <option value="4" >RUMAH MAKAN</option>
                                <option value="5" >RESTORAN/RUMAH MAKAN KECIL</option>
                                <option value="6" >KANTIN</option>
                                <option value="7" >TUNGGAKAN RESTORAN MENENNGAH</option>
                                <option value="8" >WARUNG</option>
                                <option value="9" >PAJAK RESTORAN</option>
                                <option value="10" >PEDAGANG KAKI LIMA</option>
                              </select><i></i>
                      </label>
                  </section>
</div>
...
<script type="text/javascript">
    ...
    function cetak () {
    window.open(window.APP_URL+'/penetapan/rekap_kendali_restoran/cetak');
}
</script>
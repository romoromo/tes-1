...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file fa-fw"></i> Keringanan Pajak Hiburan</h4>
		</div>
	</div>
</div>
							...
							<div class="row">
								...
								<section class="col col-md">
									<label class="checkbox pull-right">
										<input type="checkbox" name="is_tanggal" id="is_tanggal" value="T">
										<input type="hidden" name="is_tanggal" value="F">
										<i></i>
									</label>
								</section>
								<section class="col col-md-2">
						...
						<fieldset id="form-data-perhitungan" style="display: none;">
							...
							<div class="row">
								...
								<section class="col col-md-3">
									<label class="input">
										<input readonly="" type="text" onkeyup="hitungPajakHari()" class="format-rupiah" id="TBLDAFTHIBURAN_PENJUALANHARI" name="TBLDAFTHIBURAN_PENJUALANHARI">
									</label>
								</section>
								<section class="col col-md-2">
									<p>Jumlah Hari</p>
								...
								<section class="col col-md-3">
									<label class="input">
										<input readonly="" type="text" onkeyup="hitungPajakHari()" class="format-ribuan" id="TBLDAFTHIBURAN_JUMLAHHARIJUAL" name="TBLDAFTHIBURAN_JUMLAHHARIJUAL">
									</label>
								</section>
							</div>
							...
							<div class="row">
								...
								<section class="col col-md-3">
									<label class="input">
										<input readonly="" type="text" onkeyup="hitungPajakBulan()" class="format-rupiah" id="TBLDAFTHIBURAN_OMSETPAJAK" name="TBLDAFTHIBURAN_OMSETPAJAK">
									</label>
								</section>
								<section class="col col-md-2">
									<p>Keringanan (%)</p>
								...
								<section class="col col-md-1">
									<label class="input">
										<input type="number" style="" class="text-align-right" id="TBLDAFTHIBURAN_PERSENRINGAN" name="TBLDAFTHIBURAN_PERSENRINGAN">
									</label>
								</section>
							</div>
							...
							<div class="row">
								...
								<section class="col col-md-3">
									<label class="input">
										<i class="icon-append fa fa-calendar"></i>
										<input readonly="" type="text" id="TBLDAFTHIBURAN_TGLMULAIJUAL" name="TBLDAFTHIBURAN_TGLMULAIJUAL" class="datepicker" data-dateformat="dd-mm-yy">
									</label>
								</section>
								<section class="col col-md-2">
								...
								<section class="col col-md-3">
									<label class="input">
										<i class="icon-append fa fa-calendar"></i>
										<input readonly="" type="text" id="TBLDAFTHIBURAN_TGLAKHIRJUAL" name="TBLDAFTHIBURAN_TGLAKHIRJUAL" class="datepicker" data-dateformat="dd-mm-yy">
									</label>
								</section>
							</div>
							...
							<div class="row">
								...
								<section class="col col-md-3">
									<label class="checkbox pull-left">
										<input disabled="" type="checkbox" value="T" id="isBungaDenda" name="isBungaDenda">
										<i></i>
										<p>Tanpa Denda</p>
									</label>
								</section>
							...
							<div class="row">
								...
								<section class="col col-md-2">
									<div class="input-group">
										...
										<input readonly="" class="form-control format-ribuan format-rupiah" id="TBLDAFTHIBURAN_PAJAK" name="TBLDAFTHIBURAN_PAJAK" type="text">
									</div>
								</section>
								...
								<section class="col col-md-2">
									<div class="input-group">
										<span class="input-group-addon">Rp</span>
										<input readonly="" class="form-control format-ribuan format-rupiah" id="TBLDAFTHIBURAN_BUNGASPTPD" name="TBLDAFTHIBURAN_BUNGASPTPD" type="text">
									</div>
								</section>
						...
						<fieldset id="form-dokumentasi-tanggal" style="display: none;">
							...
							<div class="row">
								...
								<section class="col col-md-3">
									<label class="input">
										<i class="icon-append fa fa-calendar"></i>
										<input readonly="" type="text" id="TBLDAFTHIBURAN_TGLTERIMA" name="TBLDAFTHIBURAN_TGLTERIMA" class="datepicker" data-dateformat="dd-mm-yy">
									</label>
								</section>
							</div>
...
<script type="text/javascript">
	...
	function generateAutocompleteWPHiburan() {
		$('#TBLDAFTAR_NOPOK').autocomplete({
			serviceUrl: 'penetapan/keringanan_hiburan/autocompletewphiburan',
	...
	function cekPernahDaftar() {
		...
		var TGLPAJAK = ($('#is_tanggal').prop('checked') ? $('#TBLPENDATAAN_TGLPAJAK').val() : '0')
		...
		if (TGLPAJAK=='') {
			notifikasi('Informasi','Mohon isikan Tanggal Pajak','failed',1,0);
		}
		else{
			window.nopokok = window.nopokok || $("#TBLDAFTAR_NOPOK").val()
			$.ajax({
				url: 'penetapan/keringanan_hiburan/CekPernahDaftar',
				type: 'POST',
				dataType: 'json',
				data: {
				...
				success : function (respon) {
					...
					if (respon.status=='sudah') {
						$.SmartMessageBox({
							...
							content : "Data dengan Nomor Pokok "+window.nopokok+", Masa Pajak "+TGLPAJAK+"-"+BLNPAJAK+"-"+THNPAJAK+" sudah pernah didata. <br> Apakah anda ingin menampilkan data ini?", // konten dari smart alert
						...
						notifikasi('Maaf', `Tidak ditemukan pendataan dengan Nomor Pokok ${window.nopokok}. Masa Pajak ${TGLPAJAK}-${BLNPAJAK}-${THNPAJAK}`, 'x', 1,0)
					}
				}
			});
		}
	...
	function getTglBatas(THNPAJAK,BLNPAJAK,KODEREK) {
		$.ajax({
			url: 'penetapan/keringanan_hiburan/GetTGLBatas',
			type: 'POST',
			dataType: 'json',
			data: {
				 THNPAJAK : THNPAJAK
	...
	function cari() {
		...
		if (TBLDAFTAR_NOPOK=='') {
			...
			$.ajax({
				url: 'penetapan/keringanan_hiburan/GetWPHiburan',
				type: 'POST',
				dataType: 'json',
				data: {
					 nopokok: window.nopokok
					,THNPAJAK: $('#TBLPENDATAAN_THNPAJAK').val()
					,BLNPAJAK: $('#TBLPENDATAAN_BLNPAJAK').val()
					,TGLPAJAK: ($('#is_tanggal').prop('checked') ? $('#TBLPENDATAAN_TGLPAJAK').val() : '0')
				},
				success: function(respon) {
					if (respon.TBLDAFTHIBURAN_REGSETOR != 'XXX') {
						return notifikasi('Sudah Disetor', 'Transaksi sudah disetor tidak bisa diberi keringanan', 'x', 1,0)
					}
					...
					window.BUNGASPTPD = respon.TBLDAFTHIBURAN_BUNGASPTPD
					...
					$("#TBLREKENING_PERSEN").val(respon.TBLDAFTHIBURAN_PERSENTARIF)
					$('#form-data-perhitungan').show('fast');
					$('#form-dokumentasi-tanggal').show('fast');
					$('#footer-hiburan').show('fast');
					if ( !$('#is_tanggal').prop('checked') ) {
						$("#TBLDAFTHIBURAN_JNSHIBURAN").val('T')
					} else {
						$("#TBLDAFTHIBURAN_JNSHIBURAN").val('I')
					}
					setMasaPajak();
					setPriceFormat();
				}
	...
	function getTarifRekening(kodesubrek) {
		$.ajax({
			url: 'penetapan/keringanan_hiburan/GetKodeRek',
			type: 'POST',
			dataType: 'json',
			data: {
			...
			success: function(respon) {
				...
				$('#TBLREKENING_REKJENIS').val(respon.TBLREKENING_REKJENIS);
			}
		});
		
	}

	$("#isBungaDenda").click(function(event) {
	...
	$("#TBLDAFTHIBURAN_PERSENRINGAN").keyup(function(event) {
		var PENJUALANHARI = toAngka($('#TBLDAFTHIBURAN_PENJUALANHARI').val());
		var OMZET = toAngka($('#TBLDAFTHIBURAN_OMSETPAJAK').val());
		if (PENJUALANHARI>0) {
			hitungPajakHari()
	...
	function hitungPajakHari() {
		...
		if ( bungabln > 0) {
			...
			bungarp = ceiling(bungarp, 1);

			if ($('#isBungaDenda').prop('checked')) {
				bungarp = 0
			}

			bungarp = parseFloat(window.BUNGASPTPD)

			$('#TBLDAFTHIBURAN_BUNGASPTPD').val(bungarp);
		}

		keringanan = 0
		pcringan = toAngka($("#TBLDAFTHIBURAN_PERSENRINGAN").val())
		if (pcringan > 0) {
			console.log('db', pajak)
			pajak = (100-pcringan)/100 * pajak
			pajak = ceiling(pajak, 1);
			console.log(pajak)
		}
	...
	function simpanhiburan () {
		$.ajax({
			url: 'penetapan/keringanan_hiburan/SimpanHiburan',
			type: 'post',
			dataType: "json",

...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file fa-fw"></i> Keringanan Pajak Air Tanah</h4>
		</div>
	</div>
</div>
...
function generateAutocompleteWPAirTanah() {
	...
	serviceUrl: 'penetapan/keringananpajak_airtanah/autocompletewpairtanah',
...
function cekPernahDaftar() {
	...
	if (TBLDAFTAR_NOPOK=='') {
		...
		$.ajax({
			url: 'penetapan/keringananpajak_airtanah/CekPernahDaftar',
			type: 'POST',
			dataType: 'json',
			data: {
...
function cari() {
	...
	if (TBLDAFTAR_NOPOK=='') {
		...
		$.ajax({
		url: 'penetapan/keringananpajak_airtanah/GetWPAirTanah',
		type: 'POST',
		dataType: 'json',
		data: {
			 nopokok: window.nopokok
...
function getTarifRekening(kodesubrek) {
	$.ajax({
		url: 'penetapan/keringananpajak_airtanah/GetKodeRek',
		type: 'POST',
		dataType: 'json',
		data: {
...
function simpanairtanah () {
	$.ajax({
		url: 'penetapan/keringananpajak_airtanah/SimpanAirTanah',
		type: 'post',
		dataType: "json",
...
function getTglBatas(THNPAJAK,BLNPAJAK,KODEREK) {
	$.ajax({
		url: 'penetapan/keringananpajak_airtanah/GetTGLBatas',
		type: 'POST',
		dataType: 'json',
		data: {
			 THNPAJAK : THNPAJAK

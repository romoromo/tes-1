...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Daftar Induk WP</h4>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	...
	function generateAutocompleteWP() {
		$('#TBLDAFTAR_NOPOK').autocomplete({
			serviceUrl: 'pendaftaran/daftar_induk/autocompletewp',
	...
	function cari() {
			...
			$.ajax({
				url: 'pendaftaran/daftar_induk/GetData',
				type: 'POST',
				data:  {
	...
	function cetak() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendaftaran/daftar_induk/cetak?' + param);
	}
	...
	function cetak_daftarWord() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendaftaran/daftar_induk/cetakWord?' + param);
	}
	...
	function cetak_status() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendaftaran/daftar_induk/cetak_status?' + param);
	}
	...
	function setRekening(val) {
		$.ajax({
			url: 'pendaftaran/daftar_induk/setRekening',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function getKelurahan(val) {
		$.ajax({
			url: 'pendaftaran/daftar_induk/getKelurahan',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function getKelurahanedit(val) {
		$.ajax({
			url: 'pendaftaran/daftar_induk/getKelurahanedit',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function getKelurahanedit2(val) {
		$.ajax({
			url: 'pendaftaran/daftar_induk/getKelurahanedit2',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function simpan () {
		$.ajax({
			url: 'pendaftaran/daftar_induk/Simpan',
			type: 'post',
			dataType: "json",

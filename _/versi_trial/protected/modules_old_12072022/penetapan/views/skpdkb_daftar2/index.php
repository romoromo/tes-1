	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="well well-sm well-light bg-color-greenLight txt-color-white">
				<h4><i class="fa fa-file-text-o"></i> Rekap Daftar SKPDKB </h4>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function cetak() {
			...
			window.open('<?= Yii::app()->getBaseUrl(1); ?>/penetapan/skpdkb_daftar2/cetak?' + param);
		}
		...
		function cetakWord() {
			...
			window.open('<?= Yii::app()->getBaseUrl(1); ?>/penetapan/skpdkb_daftar2/cetakword?' + param);
		}

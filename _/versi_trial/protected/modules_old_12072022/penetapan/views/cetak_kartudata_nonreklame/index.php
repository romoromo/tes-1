...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Cetak Kartu Data Air Tanah</h4>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	...
	function cari() {
		...
		reloadDT('dt_basic');
		$.ajax({
			url: 'penetapan/cetak_kartudata_nonreklame/cari',
			type: 'POST',
			data: {
	...
	function cetak() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/penetapan/cetak_kartudata_nonreklame/cetak?' + param);
	}
	...
	function cetakWord(jenis) {
		...
		window.open('<?php echo Yii::app()->getBaseUrl(1); ?>/penetapan/cetak_kartudata_nonreklame/cetakWord?' + param);
	}
	...
	function cetak (jenis) {
		...
		window.open(URL_APLIKASI+"/penetapan/cetak_kartudata_nonreklame/cetak?jenis="+jenis+"&"+jQuery.param(data) );

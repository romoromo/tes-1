...
<div class="well well-sm well-light bg-color-greenLight txt-color-white">
            <h4><i class="fa fa-file-text-o"></i> Cetak Laporan Kendali Hiburan </h4>
</div>
</div>
</div>
...
<div class="jarviswidget jarviswidget-color-teal" id="wid-id-validasi_penyetoran" 
      ...
      <header role="heading">
        <span class="widget-icon"><i class="fa fa-list-ul"></i></span>
          <h2>Daftar Kartu Data Pajak Hiburan </h2>
                  ...
                  <section class="col col-3">
                      <label class="select">
                              <select class="input-md" enabled="enabled">
                                ...
                                <option value="1" >PAJAK HIBURAN</option>
                              </select><i></i>
                      </label>
                  </section>
</div>
                  ...
                  <section class="col col-3">
                      <label class="select">
                              <select class="input-md" enabled="enabled">
                                ...
                                <option value="1" >INSIDENTAL</option>
                                <option value="2" >PUSAT KEBUGARAN/ FITNESS CENT</option>
                                <option value="3" >LAIN-LAIN</option>
                                <option value="4" >SEKATEN (HIBURAN)</option>
                                <option value="5" >TUNGGAKAN PAJAK HIBURAN</option>
                                <option value="6" >PAJAK HIBURAN</option>
                                <option value="7" >TONTONAN FILM</option>
                                <option value="8" >KONTES KECANTIKAN BINARAGA DLL</option>
                                <option value="9" >PERTUNJUKAN KES. TRADISIONAL</option>
                                <option value="10" >PAMERAN</option>
                                <option value="11" >INSIDENTIL OLAHRAGA, FITNES</option>
                                <option value="11" >DISKOTIK DAN KLAB MALAM</option>
                                <option value="11" >KARAOKE</option>
                                <option value="11" >VIDEO GAME, TOYS, PLAY STATION</option>
                                <option value="11" >GEL. PERMAINAN KETANGKASAN</option>
                                <option value="11" >PERMAINAN BILYARD, GOLF, BOWLING</option>
                                <option value="11" >KOLAM PANCING</option>
                                <option value="11" >TUNGGAKAN PAJAK HIBURAN</option>
                                <option value="11" >DENDA PAJAK HIBURAN</option>
                                <option value="11" >PERMAINAN KETANGKASAN</option>
                                <option value="11" >WAYANG KULIT</option>
                                <option value="11" >INSIDENTAL FILM</option>
                                <option value="11" >VIDIO KASET/VCD/KARAOKE</option>
                                <option value="11" >KRKB GEMBIRA LOKA</option>
                                <option value="11" >KOLAM RENANG</option>
                                <option value="11" >REFLEKSI DAN MANDI AUP/SPA</option>
                                <option value="11" >PAGELARAN TARI, MUSIK, BUSANA</option>
                                <option value="11" >SIRKUS, AKROBAT, DAN SULAP</option>
                                <option value="11" >PACUAN KUDA, KENDARAAN BERMOTOR</option>
                                <option value="11" >PERTANDINGAN OLAHRAGA</option>
                              </select><i></i>
                      </label>
                  </section>
</div>
...
<div class="row">
                  ...
                  <section class="col col-md-2">
                      <button class="btn btn-sm btn-primary" onclick="cetak()" style="float: left;" disabled="disabled">
                          <i class="fa fa-save"></i> Cetak Vol
                      </button>
...
<script type="text/javascript">
    ...
    function cetak () {
    window.open(window.APP_URL+'/penetapan/rekap_kendali_hiburan/cetak');
}
</script>
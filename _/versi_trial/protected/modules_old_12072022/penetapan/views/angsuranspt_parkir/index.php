	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="well well-sm well-light bg-color-greenLight txt-color-white">
				<h4><i class="fa fa-file-text-o"></i> Angsuran SPTPD - Pajak parkir </h4>
			</div>
		</div>
	</div>
	...
	<section id="widget-grid" class="" >
		...
		<div class="row">
			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<div class="jarviswidget jarviswidget-color-teal" id="wid-id-kiorssparkir" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
					<header>
					...
					<div>
						...
						<div class="widget-body no-padding">
							<form id="form_angsuran_pajakparkir" class="smart-form" novalidate="">
								<br><fieldset>
									<div class="row">
										...
										<section class="col col-md-4">
											<h4 align="left">Entry Penetapan Angsuran Pajak parkir</h4>
										</section>
									</div>
	...
	function generateAutocompleteWPparkir() {
		$('#TBLDAFTAR_NOPOK').autocomplete({
			serviceUrl: '<?php echo $this->modul_url ?>/autocompletewpparkir',
									...
									$.SmartMessageBox({
										...
										if (ButtonPressed=='Ya') {
											$.ajax({
												...
												type: 'POST',
												dataType: 'json',
												data: $("#form_angsuran_pajakparkir").serialize()+'&id='+window.idSurat+'&idObyek='+window.idObyek+'&cmd='+window.cmd+"&tblketetapanangsuran="+tblketetapanangsuran+"&totalkb="+window.totalkb,
											})
	...
	function cetakketetapan() {
		tblketetapanangsuran = localStorage["tblketetapanangsuran"];
		var data = $("#form_angsuran_pajakparkir").serialize()+'&id='+window.idSurat+'&idObyek='+window.idObyek+'&cmd='+window.cmd+"&tblketetapanangsuran="+tblketetapanangsuran+"&totalkb="+window.totalkb;
	...
	function cetakperjanjian() {
		tblketetapanangsuran = localStorage["tblketetapanangsuran"];
		var data2 = $("#form_angsuran_pajakparkir").serialize()+'&id='+window.idSurat+'&idObyek='+window.idObyek+'&cmd='+window.cmd+"&tblketetapanangsuran="+tblketetapanangsuran+"&totalkb="+window.totalkb;
	...
	function getNoANG(tahun) {
			$.ajax({
				url: 'penetapan/angsuranspt_parkir/GetNoANG',
				type: 'POST',
				dataType: 'json',
				data: {
					tahun: tahun

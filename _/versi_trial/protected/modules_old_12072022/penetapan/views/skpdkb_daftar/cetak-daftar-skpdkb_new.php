		...
		<thead>
			...
			<thead>  
				<tr>
					...
					<th></th>
					<th></th>
					<th colspan="1">PLT. KA. SUB BIDANG PENETAPAN PENDAPATAN DAERAH</th>
					<th></th>
					<th></th>
					<th></th>
					<th></th>
					<th></th>
					<th></th> 
					<th>STAF SUB BIDANG PENETAPAN PENDAPATAN DAERAH</th> 
					<th></th>
				</tr>
			</thead>
			<tbody style="text-align: center;">
				<tr>
					...
					<td></td>
					<td></td>
					<td>RUDI MUHAIRANI<br>
						NIP. NIP. 196710051987031006
					</td>
					<td></td>
					<td></td>
					<td></td>
					<td></td>
					<td></td>
					<td></td><td>FAJAR SUTANTO<br>
					NIP. 198908052011011001</td>
					<td></td>
				</tr>
			</tbody>
		</table>

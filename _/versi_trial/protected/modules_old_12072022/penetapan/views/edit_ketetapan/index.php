						...
						<fieldset>
							...
							<div class="row">
								...
								<div class="row">
									...
									<section class="col col-md-2">
										<label class="input">
											<input maxlength="2" placeholder="99" type="number" id="TBLPENDATAAN_THNPAJAK" name="param[TBLPENDATAAN_THNPAJAK]" value="<?= date('y') ?>" placeholder="Tahun" maxlength="2">
										</label>
									</section>
									<section class="col col-md-2">
										<label class="select">
		...
		$.SmartMessageBox({
			...
			if (ButtonPressed === "Ya") {
				...
				.done(function(respon) {
					...
					$("#batal_ke").val(ke);
					$("#batal_thp").val(thp);
					$("#batal_blp").val(respon[respon.NAMATABEL+'_BLNPAJAK']);
					$("#batal_hrp").val(respon[respon.NAMATABEL+'_TGLPAJAK']);

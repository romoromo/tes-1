...
class Skpdkb_daftar2Controller extends Controller
{
	...
	public function actionCetak()
	{
		...
		$range = "AND TO_DATE ( NVL(".$NAMATABEL."_THNKURANGBAYAR,99) || '/' || NVL(".$NAMATABEL."_BLNKURANGBAYAR,01)  || '/' || NVL(".$NAMATABEL."_TGLKURANGBAYAR,01),  'YY/MM/DD') 
		...
		AND NVL (".$NAMATABEL."_THNKURANGBAYAR, 0) > 0
		".$tahunpjk."
		".$range."

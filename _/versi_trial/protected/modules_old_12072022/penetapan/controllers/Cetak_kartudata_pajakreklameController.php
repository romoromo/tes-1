...
class Cetak_kartudata_pajakreklameController extends Controller
{
	...
	public function getData()
	{
		...
		$wheretahunpjk = !empty($tahunpjk) ? (' AND TBLPENDATAAN_THNPAJAK='.$tahunpjk) : '';
		$wherebulanpjk = !empty($bulanpjk) ? (' AND TBLPENDATAAN_BLNPAJAK='.$bulanpjk) : '';
		$wheretanggalpjk = !empty($tanggalpjk) ? (' AND TBLPENDATAAN_TGLPAJAK='.$tahunpjk) : '';
		$wherekecamatan = !empty($kecamatan) ? (' AND TBLKECAMATAN_ID='.$kecamatan) : '';
		$wheretahunsptpd = !empty($tahunsptpd) ? (' AND TBLDAFTREKLAME_THNSKPD='.$tahunsptpd) : '';
		$wherebulansptpd = !empty($bulansptpd) ? (' AND TBLDAFTREKLAME_BLNSKPD='.$bulansptpd) : '';
		$wheretanggalsptpd = !empty($tanggalsptpd) ? ('AND TBLDAFTREKLAME_TGLSKPD='.$tanggalsptpd) : '';

...
class Spt_hotelController extends Controller
{
	...
	public function actiongetdata()
	{
		...
		TBLDAFTHOTEL.TBLDAFTHOTEL_BUNGASPTPD,
	...
	public function actionsimpandata()
	{
		...
		if ($cek>0) {
			...
			$simpan = $insert->insert('TBLDAFTHOTEL', array(
					    ...
					    ,'TBLDAFTHOTEL_PAJAK'=>$hit_totalsetor
					    ...
					    ,'TBLDAFTHOTEL_THNBATASSPTPD'=>substr($arr_tglterimasptpd[2],-2)
					    ,'TBLDAFTHOTEL_BLNBATASSPTPD'=>$arr_tglterimasptpd[1]
					    ,'TBLDAFTHOTEL_TGLBATASSPTPD'=>$arr_tglterimasptpd[0]
					    ,'TBLDAFTHOTEL_THNTERIMA'=>substr($arr_tglbatassptpd[2],-2)
					    ,'TBLDAFTHOTEL_BLNTERIMA'=>$arr_tglbatassptpd[1]
					    ,'TBLDAFTHOTEL_TGLTERIMA'=>$arr_tglbatassptpd[0]
	...
	{
		$model = Yii::app()->db->createCommand('SELECT COUNT(TBLPENDATAAN_THNPAJAK) AS JML FROM TBLDAFTHOTEL WHERE TBLPENDATAAN_THNPAJAK ='.$thn.' AND TBLPENDATAAN_BLNPAJAK='.$bulan.' AND TBLDAFTAR_NOPOK='.$nopok)->queryScalar();
		return $model;
	}

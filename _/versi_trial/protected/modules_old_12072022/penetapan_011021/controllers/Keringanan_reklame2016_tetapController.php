...
class Keringanan_reklame2016_tetapController extends Controller
{
	...
	var $MODULE_URL = 'penetapan/keringanan_reklame2016_tetap';
	...
	public function actionsimpanPendataan()
	{
		...
		$RPRINGAN = DMOrcl::getRequest('param', 'TBLDAFTREKLAME_PCRINGANRP');
		...
		$arrayData = array(
			...
			'RPRINGAN' => !empty($RPRINGAN) ? $RPRINGAN : 0,
		...
		if ($this->cekPernahDaftar($TBLPENDATAAN_THNPAJAK, $TBLPENDATAAN_PAJAKKE, $TBLDAFTAR_NOPOK)>0) {
			# update
			$where = 'TBLPENDATAAN_THNPAJAK ='.$TBLPENDATAAN_THNPAJAK.' 
			AND NVL(TBLPENDATAAN_BLNPAJAK, 0)=0 
			AND NVL(TBLPENDATAAN_TGLPAJAK, 0)=0 
			AND TBLPENDATAAN_PAJAKKE='.$TBLPENDATAAN_PAJAKKE.' 
			AND TBLDAFTAR_NOPOK='.$TBLDAFTAR_NOPOK;

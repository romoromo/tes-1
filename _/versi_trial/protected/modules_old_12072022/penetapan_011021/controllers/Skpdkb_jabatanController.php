...
class Skpdkb_jabatanController extends Controller
{
	...
	public function actiongetdata()
	{
		...
		$filter = array(
			...
			,'EQ__TBLMONITORING_DETAIL.THP' => $tahun
	...
	public function actionSimpan()
	{
		...
		$column = array(
			...
			,'PAJAKJAB'      => LokalIndonesia::toAngka($PARAM['jml_omzet'])
	...
	public function actionCetakWord()
	{
		...
		$dt['thnkb'] = '20'.$data['cetak']['THKBJAB'];
		$dt['blnkbawal'] = LokalIndonesia::getbulan($data['cetak']['BLKBJAB']);
		$dt['blnkbakhir'] = LokalIndonesia::getbulan($data['cetak']['BLKBJAB']);
		...
		$dt['denda'] = '';
		$dt['setoran'] = LokalIndonesia::rupiah($data['cetak']['NAKBJAB']);

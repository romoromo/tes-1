...
class Angsuran_hiburanController extends Controller
{
	...
	{
		$model = Yii::app()->db->createCommand("SELECT {$this->namatabel}_REGKURANGBAYAR FROM {$this->namatabel} WHERE TBLDAFTAR_NOPOK = ".$TBLDAFTAR_NOPOK." AND TBLPENDATAAN_THNPAJAK = ".$tahun." AND TBLPENDATAAN_BLNPAJAK = ".$bulan."")->queryScalar();
		return $model;
	}

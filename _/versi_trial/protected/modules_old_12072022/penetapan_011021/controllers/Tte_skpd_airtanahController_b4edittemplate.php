...
class Tte_skpd_airtanahController extends Controller
{
	...
	public function actionSkpd_draft()
	{
		...
		$data_replace['{$PAJAK_BUNGA}']      = ''; //$PAJAK_BUNGA = number_format($data_trans['T_JMLHKENAIKAN'], 0, ",", ".");
		$data_replace['{$PAJAK_KENAIKAN}']   = ''; //$PAJAK_KENAIKAN = number_format($data_trans['T_JMLHKENAIKAN'], 0, ",", ".");
		...
		$data_replace['{$LABEL_STIMULUS}'] = ''; //$LABEL_STIMULUS = $data_trans['T_DASARPENGENAAN'] - $data_trans['T_JMLHPAJAK'] != 0 ? "Stimulus Pengurangan Pajak 50%" : '';
		$data_replace['{$STIMULUS}']       = ''; //$STIMULUS = ($data_trans['T_DASARPENGENAAN'] - $data_trans['T_JMLHPAJAK']);
		// $data_replace['{$PAJAK_STIMULUS}'] = $PAJAK_STIMULUS = $data_trans['T_DASARPENGENAAN'] - $data_trans['T_JMLHPAJAK'] != 0 ? number_format($STIMULUS, 0, ",", ".") : '';

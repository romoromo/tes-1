...
class Stpd_hiburanController extends Controller
{
	...
	{
		$model = Yii::app()->db->createCommand("SELECT COUNT(TBLPENDATAAN_THNPAJAK) AS JML FROM TBLSETOR WHERE TBLPENDATAAN_THNPAJAK =".$THNPAJAK." AND TBLPENDATAAN_BLNPAJAK=".$BLNPAJAK." AND TBLDAFTAR_NOPOK=".$NOPOKOK." AND NVL(TBLPENDATAAN_TGLPAJAK, 0) = ".$tanggal." AND TBLSETOR_JNSBAYAR = 'STPD'")->queryScalar();
		return $model;
	}
	...
	public function actionSimpanSTPDHiburan()
	{

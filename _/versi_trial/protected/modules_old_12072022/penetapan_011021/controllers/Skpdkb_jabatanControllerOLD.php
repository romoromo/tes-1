...
class Skpdkb_jabatanController extends Controller
{
	...
	public function actiongetdata()
	{
		...
		$cekadaspt = $this->cekAdaspt($tahun_substr, $bulan, $TBLDAFTAR_NOPOK, $NamaTBL);

		if ($cekadaspt > 0) {
			$data['data'] = 'sudah ada spt lapor';	
		} else {
			$data['data'] = 'ada spt 0';
	...
	public function actionSimpanSKPDKBHotel1()
	{
		...
		$column = array(
			...
			'TBLDAFTHOTEL_KENAIKANKRGBAYAR' => LokalIndonesia::toAngka($PARAM['TBLDAFTHOTEL_DENDAKRGBAYAR']),
			'TBLDAFTHOTEL_DENDAKRGBAYAR' => LokalIndonesia::toAngka($PARAM['TBLDAFTHOTEL_KENAIKANKRGBAYAR']),
		...
		$column = array('TBLPENDATAAN_THNPAJAK'=>$THNPJK
			...
			,'TBLKRGBAYAR_DENDAKRGBAYAR'=> LokalIndonesia::toAngka($PARAM['TBLDAFTHOTEL_KENAIKANKRGBAYAR'])
			,'TBLKRGBAYAR_KENAIKANKRGBAYAR'=> LokalIndonesia::toAngka($PARAM['TBLDAFTHOTEL_DENDAKRGBAYAR'])
	...
	public function actionGetNoSKPDKB()
	{
		...
		$data = Yii::app()->db->createCommand("SELECT
			MAX(TO_NUMBER (TO_CHAR(NVL(".$NamaTBL."_REGKBJABATAN, 0))))+1 AS nokb
		FROM
			".$NamaTBL."
		WHERE
			TBLPENDATAAN_THNPAJAK = ".$splthn."
		AND NVL (".$NamaTBL."_REGKBJABATAN, 0) <> 0
		ORDER BY

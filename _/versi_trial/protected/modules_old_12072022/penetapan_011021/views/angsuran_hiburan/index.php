	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="well well-sm well-light bg-color-greenLight txt-color-white">
				<h4><i class="fa fa-file-text-o"></i> Angsuran - Pajak Hiburan </h4>
			</div>
		</div>
	</div>
	...
	<section id="widget-grid" class="" >
		...
		<div class="row">
			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<div class="jarviswidget jarviswidget-color-teal" id="wid-id-hiburan" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
					<header>
		...
		$.ajax({
			...
			success: function(respon) {
				if (respon.data=="sudah kb") {
					...
					$('#<?= $this->namatabel ?>_NAKB').val(respon.<?= $this->namatabel ?>_NAKB);
	...
	function getNoANG(tahun) {
			$.ajax({
				url: 'penetapan/angsuran_hiburan/GetNoANG',
				type: 'POST',
				dataType: 'json',
				data: {
					tahun: tahun

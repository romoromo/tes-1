<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<h4><i class="fa fa-file-text-o"></i> SKPDLB - Pajak Air Tanah </h4>
		</div>
	</div>
</div>
...
<section id="widget-grid" class="" >
	...
	<div class="row">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget jarviswidget-color-teal" id="wid-id-arigdgsdsfd" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
				<header>
				...
				<div>
					...
					<div class="widget-body no-padding">
						<form id="form_sumber_pajak" class="smart-form" novalidate="">
							...
							<fieldset>
								<div class="row">
								<section class="col col-md-12"><h4 align="center"><b>Entry SKPDLB Pajak Air Tanah</b></h4></section>
								</div>

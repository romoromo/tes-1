	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="well well-sm well-light bg-color-greenLight txt-color-white">
				<h4><i class="fa fa-file-text-o"></i> SKPD Nihil - Pajak Hotel </h4>
			</div>
		</div>
	</div>
	...
	<section id="widget-grid" class="" >
		...
		<div class="row">
			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<div class="jarviswidget jarviswidget-color-teal" id="wid-id-Pajak_Hotel" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
					<header>
					...
					<div>
						...
						<div class="widget-body no-padding">
							<form id="form-skpdn-hotel" class="smart-form" novalidate="">
								<fieldset>
									...
									<hr><br>
									<div class="row">
										<section class="col col-md-12"><h4 align="center">Entry SKPDN Pajak Hotel</h4></section>
									</div>
									...
									<div class="row">
										...
										<section class="col col-md-2">
											<label class="input"> <i class="icon-append fa fa-calendar"></i>
												<input type="text" name="TBLDAFTHOTEL_TGLPERIKSA" class="datepicker" data-dateformat="dd-mm-yy" id="TBLDAFTHOTEL_TGLPERIKSA">
											</label>
										</section>
									</div>
									<div class="row">
										...
										<section class="col col-md-4">
											<label class="input">
												<input class="form-control format-rupiah" type="text" id="TBLDAFTHOTEL_RUPIAHPERIKSA" name="TBLDAFTHOTEL_RUPIAHPERIKSA">
											</label>
										</section>
									</div>
									<div class="row">
									...
									<div class="row">
										...
										<section class="col col-md-2">
											<label class="input">
												<input class="form-control" type="text" id="TBLDAFTHOTEL_REGNIHIL" name="TBLDAFTHOTEL_REGNIHIL">
											</label>
										</section>
										<section class="col col-md-2">Tanggal SKPDKN</section>
										<section class="col col-md-2">
											<label class="input"> <i class="icon-append fa fa-calendar"></i>
												<input type="text" name="TBLDAFTHOTEL_TANGGLNIHIL" class="datepicker" value="<?= date('d-m-Y') ?>"  data-dateformat="dd-mm-yy" id="TBLDAFTHOTEL_TANGGLNIHIL">
											</label>
										</section>
									</div>
								</fieldset>
	...
	<script type="text/javascript">
		...
		function generateAutocomplete() {
			$('#TBLDAFTAR_NOPOK').autocomplete({
				serviceUrl: 'penetapan/skpdnihil_hotel/autocomplete',
		...
		function runFormValidation() {
			var $FormData = $("#form-skpdn-hotel").validate({
			...
			rules : {
				...
				"TBLDAFTHOTEL_RUPIAHPERIKSA" : {
					required : true
				},
				"TBLDAFTHOTEL_REGNIHIL" : {
					required : true
				},
				"TBLDAFTHOTEL_TGLPERIKSA" : {
					required : true
				},
				"TBLDAFTHOTEL_TANGGLNIHIL" : {
					required : true
				},
			},
			...
			var param = jQuery.param(
				{
					...
					, TBLPENDATAAN_BLNPAJAK: $("#TBLDAFTHOTEL_BLNKBAKHIR").select2('val')
					, TBLPENDATAAN_THNPAJAK: $("#TBLPENDATAAN_THNPAJAK").val()
				}
			);
			window.open('<?php echo Yii::app()->getBaseUrl(1); ?>/penetapan/skpdnihil_hotel/cetakword?'+param);
		}

		function cari () {
			var CARI_NOPOK = $('#TBLDAFTAR_NOPOK').val();
			var BULAN_AKHIR = $('#TBLDAFTHOTEL_BLNKBAKHIR').select2('val');
			...
			if (CARI_NOPOK=='') {
				...
				$.ajax({
					url: 'penetapan/skpdnihil_hotel/getdata',
					type: 'POST',
					dataType: 'json',
					data: {
						TBLDAFTAR_NOPOK : CARI_NOPOK,
						bulan_akhir : $('#TBLDAFTHOTEL_BLNKBAKHIR').select2('val'),
						...
						if (respon.data=='sudah entri') {
							$.SmartMessageBox({
								...
								buttons : '[Tidak][Ya]' // pengaturan tombol
									...
									$('#TBLDAFTHOTEL_RUPIAHPERIKSA').val(respon.TBLDAFTHOTEL_RUPIAHPERIKSA);
									$('#TBLDAFTHOTEL_NOMORPERIKSA').val(respon.TBLDAFTHOTEL_NOMORPERIKSA);
									$('#TBLDAFTHOTEL_REGNIHIL').val(respon.TBLDAFTHOTEL_REGNIHIL);

									$('#TBLDAFTHOTEL_PAJAKPERIKSA').attr('disabled', 'disabled');
									$('#TBLDAFTHOTEL_PAJAKPERIKSA').attr('style', 'background:#eee');

									if (respon.TBLDAFTHOTEL_TGLPERIKSA==undefined) {
										$('#TBLDAFTHOTEL_TGLPERIKSA').val('<?= date('d-m-Y') ?>');
									} else {
									...
									$('#TBLDAFTHOTEL_TANGGLNIHIL').val(respon.TBLDAFTHOTEL_TANGGLNIHIL +'-'+ respon.TBLDAFTHOTEL_BULANNIHIL +'-20'+ respon.TBLDAFTHOTEL_TAHUNNIHIL);
							...
							if (respon.TBLDAFTHOTEL_TGLPERIKSA==undefined || respon.TBLDAFTHOTEL_TGLPERIKSA==0) {
								$('#TBLDAFTHOTEL_TGLPERIKSA').val('<?= date('d-m-Y') ?>');
							} else {
								$('#TBLDAFTHOTEL_TGLPERIKSA').val(respon.TBLDAFTHOTEL_TGLPERIKSA +'-'+ respon.TBLDAFTHOTEL_BLNPERIKSA +'-20'+respon.TBLDAFTHOTEL_THNPERIKSA);
							}
		...
		function getNoSKPDNihil(tahun) {
			$.ajax({
				url: 'penetapan/skpdnihil_hotel/getNoSKPDNihil',
				type: 'POST',
				dataType: 'json',
				data: {
					tahun: tahun
				...
				success: function(respon) {
					if (respon=='') {
						$('#TBLDAFTHOTEL_REGNIHIL').val(1);
						
					}
					else{
						$('#TBLDAFTHOTEL_REGNIHIL').val(respon.NOLB);
		...
		function simpanskpdnihil () {
			$.ajax({
				url: 'penetapan/skpdnihil_hotel/SimpanSKPDNHotel',
				type: 'post',
				dataType: "json",
				data:  $("#form-skpdn-hotel").serialize(),

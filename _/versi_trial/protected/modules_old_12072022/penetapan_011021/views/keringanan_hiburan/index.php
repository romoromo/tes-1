							...
							<div class="row">
								...
								<section class="col col-md-3">
									<label class="checkbox pull-left">
										<input type="checkbox" value="T" id="isBungaDenda" name="isBungaDenda">
										<i></i>
										<p>Tanpa Denda</p>
									</label>
								</section>
							...
							<div class="row">
								...
								<section class="col col-md-2">
									<div class="input-group">
										...
										<input class="form-control format-ribuan format-rupiah" id="TBLDAFTHIBURAN_PAJAK" name="TBLDAFTHIBURAN_PAJAK" type="text">
									</div>
								</section>
								...
								<section class="col col-md-2">
									<div class="input-group">
										<span class="input-group-addon">Rp</span>
										<input class="form-control format-ribuan format-rupiah" id="TBLDAFTHIBURAN_BUNGASPTPD" name="TBLDAFTHIBURAN_BUNGASPTPD" type="text">
									</div>
								</section>

								...
								<div class="row">
									...
									<section class="col col-md-3">
										<label class="input"> <i class="icon-append fa fa-calendar"></i>
											<input type="text" value="<?= date('d-m-Y') ?>" id="TBLDAFTTANAH_TGLENTRI" name="TBLDAFTTANAH_TGLENTRI" class="datepicker" data-dateformat="dd-mm-yy">
										</label>
									</section>
								</div>
								<div class="row">
...
<form target="_blank" id="form-skpd-airtanah" style="display: none;" method="post" action="<?= Yii::app()->getBaseUrl(1); ?>/penetapan/pajak_airtanah/cetakskpdword/">

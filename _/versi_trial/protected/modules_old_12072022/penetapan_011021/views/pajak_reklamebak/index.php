						...
						<fieldset>
							...
							<div class="row" style="display: none;">
								...
								<div class="row">
									...
									<section class="col col-md-3">
										<label class="input"> <i class="icon-append fa fa-calendar"></i>
											<input type="text" name="param[TBLDAFTREKLAME_TGLBATASSKPD]" class="datepicker" data-dateformat="dd-mm-yy" id="TBLDAFTREKLAME_TGLBATASSKPD">
										</label>
									</section>
								</div>
...
<script type="text/javascript">
	...
	function cetakNotaWord() {
		var q = btoa(daftaridPajak);
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/penetapan/pajak_reklame/cetaknotaword/?data=' + q);
	}

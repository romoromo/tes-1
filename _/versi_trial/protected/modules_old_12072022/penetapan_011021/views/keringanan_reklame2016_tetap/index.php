									...
									<div id="myTabReklameContent" class="tab-content padding-10">
											...
											<div class="row">
												...
												<section class="col col-md-2">
													<div class="input-group">
														<label class="input">
															<input class="input-sm text-align-right" type="number" id="TBLDAFTREKLAME_PCRINGAN" name="param[TBLDAFTREKLAME_PCRINGAN]">
														</label>
										...
										<div class="tab-pane fade in" id="tabrek2">
											...
											<div class="row">
												...
												<section class="col col-md-2 font-md text-align-right">
													<label>
														<input type="text" readonly="" class="disabled" id="TBLDAFTREKLAME_PCRINGANRP" value="" name="param[TBLDAFTREKLAME_PCRINGANRP]">
													</label>
												</section>
											</div>
											...
											<div class="row bold">
												...
												<section class="col col-md-3 font-xl">
													= <span class="text-align-right TBLDAFTREKLAME_PAJAK_RINGAN"></span>
				...
				$.ajax({
					...
					success: function(respon) {
						if (respon.data=='proses selanjutnya') {
							...
							notifikasi('Maaf', 'Data belum ditetapkan', 'failed', 1,0);
							...
							notifikasi('Maaf', 'Data tidak ditemukan', 'failed', 1,0);
							$("#btnsimpan").attr('disabled', true);
...
function HitungPajak() {
	...
	/*keringanan*/
	pcringan = $("#TBLDAFTREKLAME_PCRINGAN").val();
	RPRINGAN = TBLDAFTREKLAME_PAJAK * (pcringan/100);

	TBLDAFTREKLAME_PAJAK_RINGAN = TBLDAFTREKLAME_PAJAK * ((100-pcringan)/100);

	$("#TBLDAFTREKLAME_PCRINGANRP").val(toRp(RPRINGAN));
	$("#TBLDAFTREKLAME_PAJAK").val(TBLDAFTREKLAME_PAJAK_RINGAN);
	$(".TBLDAFTREKLAME_PAJAK").text(toRp(TBLDAFTREKLAME_PAJAK));
	$(".TBLDAFTREKLAME_PAJAK_RINGAN").text(toRp(TBLDAFTREKLAME_PAJAK_RINGAN));
...
jQuery(document).ready(function($) {
	$("#tabrek1 input,#tabrek1 select").addClass('disabled').attr('disabled', 1);
	$("#form-dokumentasi-tanggal input,#form-dokumentasi-tanggal select").addClass('disabled').attr('disabled', 1);

	setTimeout(function() {
		$("#TBLDAFTREKLAME_PCRINGAN").removeAttr('disabled').removeClass('disabled');
	}, 1000);
});
</script>
<style type="text/css">

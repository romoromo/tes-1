			...
			<div class="jarviswidget jarviswidget-color-darken" id="wid-id-7" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-sortable="false">
				...
				<div>
					...
					<div class="table-responsive" style="max-width: 100%; height: 400px!important; overflow: auto;">
						...
						<div><p class=""> 
						<span><strong>SKPD :</strong></span><br>
						<span><strong>Pengguna Anggaran :</strong></span><br>
						<span><strong>Bendahara Penerima :</strong></span><br>
						<span><strong>Bulan :</strong></span><br>
						</p></div>
...
<script type="text/javascript">
	...
	function cetak (tipe) {
		...
		window.open('<?php echo Yii::app()->getBaseUrl(1) ?>/pembukuandanpelaporan/cetakrekap_jenis/Cetak?tipe='+tipe+'&jenis='+cari_jenis);
	}

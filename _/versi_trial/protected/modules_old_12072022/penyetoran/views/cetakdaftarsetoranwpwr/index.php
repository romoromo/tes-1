						...
						<fieldset>
							...
							<div class="row">
								...
								<section class="col col-md-3">
									<label class="select">
										<select class="select2" name="jenis_setoran">
...
<script type="text/javascript">
	...
	function cetak(jenis){
		...
		var bulan = $('#bulan').val();
		 ...
		 window.open('<?php echo Yii::app()->getBaseUrl(1) ?>/penyetoran/cetakdaftarsetoranwpwr/cetak?tahun='+tahun+'&bulan='+bulan+'&tgl='+tgl+'&jenis='+jenis);
		}

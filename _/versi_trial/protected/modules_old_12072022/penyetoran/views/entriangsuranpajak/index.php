...
<script type="text/javascript">
	...
	function cari () {
		$.ajax({
			url: 'penyetoran/entriangsuranpajak/getdata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun : $('#tahun').val(),
			...
			success:function (respon) {
				if (respon.data==false) {
					...
					$('#sptnama').html(respon.datadarisetbpd.TBLANGSURAN_NAMABADANUSAHA);
					$('#alamat').html(respon.datadarisetbpd.TBLANGSURAN_ALAMATBADANUSAHA);
					$('#rekening').html(respon.datadarisetbpd.TBLREKENING_KODEFULL);
					$('#jenispajak').html(respon.datadarisetbpd.TBLREKENING_NAMAREKENING);
					$('#tglskp').val( respon.datadarisetbpd.TBLANGSURAN_TGLKETETAPAN +'-'+ respon.datadarisetbpd.TBLANGSURAN_BLNKETETAPAN +'-'+'20'+respon.datadarisetbpd.TBLANGSURAN_THNKETETAPAN );
					$('#tglbatas').val( respon.datadarisetbpd.TBLANGSURAN_TGLBATASKETETAPAN +'-'+respon.datadarisetbpd.TBLANGSURAN_BLNBATASKETETAPAN+'-'+'20'+respon.datadarisetbpd.TBLANGSURAN_THNBATASKETETAPAN );
					$('#pajak').val(respon.datadarisetbpd.TBLANGSURAN_KETETAPANTOTAL);
					// $('#tglsetor').val(respon.datadarisetbpd.TBLANGSURAN_KETETAPANPAJAK);
					$('#angsuran').val(respon.datadarisetbpd.TBLANGSURAN_ANGSURAN);
					$('#bunga').val(respon.datadarisetbpd.TBLANGSURAN_BUNGAANGSURAN);
					$('#denda').val(toRp(respon.datadarisetbpd.TBLSETORANBPD_DENDAKETETAPAN));
					$('#nosetoran').val(respon.datadarisetbpd.NOMORSSPD);
					$('#TBLKECAMATAN_ID').val(respon.datadarisetbpd.TBLKECAMATAN_ID);
					$('#TBLKELURAHAN_ID').val(respon.datadarisetbpd.TBLKELURAHAN_ID);
					$('#TBLDAFTAR_JNSPENDAPATAN').val(respon.datadarisetbpd.TBLDAFTAR_JNSPENDAPATAN);
					$('#TBLREKENING_REKURUSAN').val(respon.datadarisetbpd.TBLREKENING_REKURUSAN);
					$('#TBLREKENING_REKPEMERINTAHAN').val(respon.datadarisetbpd.TBLREKENING_REKPEMERINTAHAN);
					$('#TBLREKENING_REKORGANISASI').val(respon.datadarisetbpd.TBLREKENING_REKORGANISASI);
					$('#TBLREKENING_REKPROGRAM').val(respon.datadarisetbpd.TBLREKENING_REKPROGRAM);
					$('#TBLREKENING_REKKEGIATAN').val(respon.datadarisetbpd.TBLREKENING_REKKEGIATAN);
					$('#TBLREKENING_REKDINAS').val(respon.datadarisetbpd.TBLREKENING_REKDINAS);
					$('#TBLREKENING_REKBIDANG').val(respon.datadarisetbpd.TBLREKENING_REKBIDANG);
					$('#TBLREKENING_REKPENDAPATAN').val(respon.datadarisetbpd.TBLREKENING_REKPENDAPATAN);
					$('#TBLREKENING_REKPAD').val(respon.datadarisetbpd.TBLREKENING_REKPAD);
					$('#TBLREKENING_REKPAJAK').val(respon.datadarisetbpd.TBLREKENING_REKPAJAK);
					$('#TBLREKENING_REKAYAT').val(respon.datadarisetbpd.TBLREKENING_REKAYAT);
					$('#TBLREKENING_REKJENIS').val(respon.datadarisetbpd.TBLREKENING_REKJENIS);
					$('#TBLREKENING_REKSUBJENIS').val(respon.datadarisetbpd.TBLREKENING_REKSUBJENIS);
					$('#TBLANGSURAN_GOLONGAN').val(respon.datadarisetbpd.TBLANGSURAN_GOLONGAN);
					$('#TBLANGSURAN_TGLAWALKETETAPAN').val(respon.datadarisetbpd.TBLANGSURAN_TGLAWALKETETAPAN);
					$('#TBLANGSURAN_THNBATASKETETAPAN').val(respon.datadarisetbpd.TBLANGSURAN_THNBATASKETETAPAN);
					$('#TBLANGSURAN_BLNBATASKETETAPAN').val(respon.datadarisetbpd.TBLANGSURAN_BLNBATASKETETAPAN);
					...
					$('#bunga').val(respon.data.TBLANGSURAN_BUNGAANGSURAN);
					$('#nosetoran').val('');
	...
	function hitungJumlahPokok() {
		angsuran = Number(toAngka($('#angsuran').val()));
		bunga = Number(toAngka($('#bunga').val()));
	...
	function cetakSSPD() {
		...
		window.open('penyetoran/entriangsuranpajak/CetakSSPD/?'+jQuery.param(param));
	}

	function simpan() {
		$.ajax({
			url: 'penyetoran/entriangsuranpajak/simpan',
			type: 'POST',
			dataType: 'json',

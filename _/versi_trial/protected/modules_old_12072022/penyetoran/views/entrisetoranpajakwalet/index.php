...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i>  Entri Setoran Pajak Walet</h4>
		</div>
	</div>
</div>
										...
										<div class="col-md-6">
											...
											<div  style="padding: 3%;">
												...
												<div class="row">
													...
													<section class="col col-md-10">
														<label class="input" >
															<input class="form-control format-rupiah-desimal" style="background: #eee;" disabled="disabled" id="dendasetor" type="text">
														</label>
													</section>
												</div>
												<div class="row">
												...
												<div class="row">
													...
													<section class="col col-md-10">
														<label class="input">
															<input style="background: #eee;" disabled="disabled" class="form-control  format-rupiah-desimal" id="totalsetor" type="text">
														</label>
													</section>
												</div>
											</div>
										...
										<div class="col-md-6">
											...
											<div  style="padding: 3%;">
												<div class="row">
													...
													<section class="col col-md-3">
														<label class="input"> <i class="icon-append fa fa-calendar"></i>
															<input style="background: #eee;" disabled="disabled" type="text" name="request" class="datepicker form-control" data-dateformat="dd-mm-yy" id="<?php echo $this->namatabel; ?>_TGLBTSKRGBAYAR">
														</label>
													</section>
												</div>
												<div class="row">
...
<script type="text/javascript">
	...
	function generateAutocompleteWPHotel() {
		$('#nopok').autocomplete({
			serviceUrl: 'penyetoran/entrisetoranpajakwalet/autocomplete',
	...
	function cari() {
		...
		$("#btnCetakSSPD").hide();
		$.ajax({
			url: 'penyetoran/entrisetoranpajakwalet/getdata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun : $('#tahun').val(),
	...
	function simpan() {
		$.ajax({
			url: 'penyetoran/entrisetoranpajakwalet/simpandata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun : $('#tahun').val(),
	...
	function getrekening(kode) {
		$.ajax({
			url: 'penyetoran/entrisetoranpajakwalet/getrekening',
			type: 'POST',
			dataType: 'json',
			data: {
				kode : kode,
	...
	function hitungDenda() {
		var tglbatas = $("#TANGGAL_HITUNGAN_DENDA").val();
		if (tglbatas=='') {
			tglbatas = $("#<?= $this->namatabel ?>_TGLBTSKRGBAYAR").val();
		}
		window.BULAN_DENDAX = getBulanDenda(convDate(tglbatas), '<?= date('Y-m-d') ?>');
		var totalpajak = Number(toAngka($('#TBLDAFTHOTEL_RUPIAHKRGBAYAR').val()));
		rpdenda = Number(toAngka($("#TBLDAFTHOTEL_DENDAKRGBAYAR").val()));
		totalbayar = Number(toAngka($("#TBLDAFTHOTEL_RUPIAHKRGBAYAR").val()));
	...
	function cetakSSPD() {
		...
		window.open('penyetoran/entrisetoranpajakwalet/cetakSSPD/?'+jQuery.param(param));
	}

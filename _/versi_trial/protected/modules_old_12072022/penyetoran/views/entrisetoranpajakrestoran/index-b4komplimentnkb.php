...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i>  Entri Setoran Pajak Restoran</h4>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	...
	function generateAutocompleteWPHotel() {
		$('#nopok').autocomplete({
			serviceUrl: 'penyetoran/entrisetoranpajakrestoran/autocomplete',
	...
	function cari() {
		...
		$.ajax({
			url: 'penyetoran/entrisetoranpajakrestoran/getdata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun : $('#tahun').val(),
			...
			success:function (respon) {
				if (respon.model.PAJAKSETOR<500000) {
					notifikasi('Maaf', 'Omzet Rumah Makan dibawah 5.000.000', 'fail', 1,0);
				} else {
	...
	function simpan() {
		if($('#is_tanggal').is(':checked')){
			tgl_data = $('#is_tanggal').select2('val');
		} else {
			tgl_data = '0';
		}
		$.ajax({
			url: 'penyetoran/entrisetoranpajakrestoran/simpandata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun : $('#tahun').val(),
	...
	function getrekening(kode) {
		$.ajax({
			url: 'penyetoran/entrisetoranpajakrestoran/getrekening',
			type: 'POST',
			dataType: 'json',
			data: {
				kode : kode,
	...
	function cetakSSPD() {
		...
		window.open('penyetoran/entrisetoranpajakrestoran/cetakSSPD/?'+jQuery.param(param));
	}

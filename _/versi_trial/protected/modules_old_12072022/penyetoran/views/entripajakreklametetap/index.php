...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i>  Entri Setoran Pajak Reklame Tetap</h4>
		</div>
	</div>
</div>
						...
						<form action="" id="form_sumber_pajak" class="smart-form" novalidate>
							<fieldset>
								...
								<div class="row">
									...
									<section class="col col-md-2">
										<label class="input">
											<input class="input-sm" type="number" id="lokasi" name="lokasi">
										</label>
									</section>
								</div>
								<div class="row">
...
<script type="text/javascript">
	...
	function generateAutocompleteWPHotel() {
		$('#nopok').autocomplete({
			serviceUrl: 'penyetoran/entripajakreklametetap/autocomplete',
	...
	function cari() {
		...
		$("#btnCetakSSPD").hide();
		$.ajax({
			url: 'penyetoran/entripajakreklametetap/getdata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun : $('#tahun').val(),
	...
	function simpan() {
		$.ajax({
			url: 'penyetoran/entripajakreklametetap/simpandata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun : $('#tahun').val(),
	...
	function getrekening(kode) {
		$.ajax({
			url: 'penyetoran/entripajakreklametetap/getrekening',
			type: 'POST',
			dataType: 'json',
			data: {
				kode : kode,
	...
	function cetakSSPD() {
		...
		window.open('penyetoran/entripajakreklametetap/cetakSSPD/?'+jQuery.param(param));
	}

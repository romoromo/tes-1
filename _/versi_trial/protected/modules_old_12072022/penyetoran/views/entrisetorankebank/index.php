...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i>  Cetak Setor Ke Bank s/d Hari Ini</h4>
		</div>
	</div>
</div>
	...
	<div class="row">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<header>
				...
				<h2>Form Laporan Setoran BKP ke BPD</h2>
							...
							<div class="row">
								...
								<section class="col col-md-3">
									<label class="input"> <i class="icon-append fa fa-calendar"></i>
										<input type="text" name="tgl_setor" class="datepicker" data-dateformat="dd-mm-yy" id="tgl_setor">
									</label>
								</section>
							</div>
							<div class="row">

...
class EntrisetoranpajakairtanahController extends Controller
{
	...
	public function actiongetdata()
	{
		...
		if ($tahun=="") {
			...
			$data['exist'] = $this->cekpernahsetor($tahun,$bln,$nopok,$jenis_setoran);
	...
	public function cekpernahsetor($tahun,$bln,$nopok,$jenis_setoran='')
	{
	...
	public function actionsimpandata()
	{
		...
		$exist = $this->cekpernahsetor($tahun,$bln,$nopok,$jenis_setoran);
		if ($exist=='ada') {

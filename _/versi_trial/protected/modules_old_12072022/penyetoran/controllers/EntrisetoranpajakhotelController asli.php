...
class EntrisetoranpajakhotelController extends Controller
{
	...
	public function actiongetdata()
	{
		...
		if($jenis_setoran=='SPTPD') {
			...
			$joinbpd    = "JOIN TBLSETORANBPD ON TBLSETORANBPD.TBLDAFTAR_NOPOK = ".$this->namatabel.".TBLDAFTAR_NOPOK AND  TBLSETORANBPD.TBLPENDATAAN_THNPAJAK = ".$this->namatabel.".TBLPENDATAAN_THNPAJAK AND TBLSETORANBPD.TBLPENDATAAN_BLNPAJAK = ".$this->namatabel.".TBLPENDATAAN_BLNPAJAK";
	...
	public function CetakWordSSPD($data=array())
	{
		...
		if ($jenis_setoran=='STPD') {
			$nominal2 = $rowWP['TBLSETORANBPD_BUNGAKETETAPAN'];
		} else {

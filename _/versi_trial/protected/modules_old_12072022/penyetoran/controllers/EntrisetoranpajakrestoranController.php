...
class EntrisetoranpajakrestoranController extends Controller
{
		...
		if ($exist=='ada') {
			...
			if ($update) {
				...
				$arrayOfData = array(
					...
					'TBLSETORANBPD_BUNGAKURANGBAYAR'=>$jenis_setoran=='SKPDKB' ? (isset($model[$this->namatabel.'_BUNGAKRGBAYAR']) ? $model[$this->namatabel.'_BUNGAKRGBAYAR'] : 0) : 0,
	...
	public function CetakWordSSPD($data=array())
	{
		...
		if ($jenis_setoran=='SKPDKB' || $jenis_setoran=='STPD') {

            ...
            <fieldset class="smart-form">
                <div class="row">
                    ...
                    <section class="col col-md-4">
                        <label class="input">
                            <input type="text" id="tnpwpddaftar_miliknama" name="tnpwpddaftar_miliknama" class="form-control" placeholder="Ketik nama Pemilik / Pengelola">
                        </label>
                        <label><em>Cari dengan nama pemilik</em></label>
                    </section>
                    <button id="btnTambahPemilik" type="button" class="btn btn-sm btn-primary">Tambahkan Pemilik/Pengelola</button>
                </div>

       	    <div id="form-pemilik" style="display: none;">

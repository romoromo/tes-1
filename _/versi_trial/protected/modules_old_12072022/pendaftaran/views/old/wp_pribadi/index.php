					...
					<div class="widget-body no-padding">
						...
						<form action="" id="form-pendaftaran-pribadi" class="smart-form" novalidate>
							...
							<footer>
									...
									<button type="button" onclick="reset_form();" class="btn btn-sm btn-default" data-dismiss="modal">

...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i>  Entri Setoran Transfer Pajak Air Tanah</h4>
		</div>
	</div>
</div>
...
<section id="widget-grid" class="">
	...
	<div class="row">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget jarviswidget-color-teal" id="wid-896da6s879d8id-pajak_airtanah" 
							...
							<div id="id_respencarian">
								...
								<div class="row">
									<div class="col-md-6">
										...
										<div  style="padding: 3%;">
											<div class="row">
												<section class="col col-md-2">Tanggal SKP</section>
												<section class="col col-md-4">
												...
												<section class="col col-md-1">Batas SKP</section>
												<section class="col col-md-4">
													<label class="input"> <i class="icon-append fa fa-calendar"></i>
									...
									<div class="col-md-6">
										...
										<div  style="padding: 3%;">
											...
											<div class="row">
												...
												<section class="col col-md-10">
													<label class="input" >
														<input class="form-control format-rupiah-desimal" style="background: #eee;" name="dendasetor" id="dendasetor" type="text">
													</label>
												</section>
											</div>
											<div class="row">
...
<script type="text/javascript">
	...
	function cari() {
		...
		$("#btnCetakSSPD").hide();
		$.ajax({
			url: 'Setoranpajak_Trasfer/pajak_airtanah/getdata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun : $('#tahun').val(),
			...
			success:function (respon) {
				if (respon.data.validate=='kurang') {
					...
					if(respon.model.<?php echo $this->namatabel; ?>_THNSKPD) {
						...
						$('#<?php echo $this->namatabel; ?>_TGLSKPD').val(respon.model.<?php echo $this->namatabel; ?>_TGLSKPD+'-'+bulanskpd+'-'+viewtahunthnskpd);
					} else {
					...
					if(respon.model.<?php echo $this->namatabel; ?>_THNBATASSKPD) {
						...
						$('#<?php echo $this->namatabel; ?>_TGLBATASSKPD').val(viewtglbatasskpd+'-'+viewbulanbatasskpd+'-'+viewtahunbatasskpd);
					} else {
...
function simpan() {
	...
	if (NOMOR_SSPD=='') {
		...
		$.ajax({
			url: 'Setoranpajak_Trasfer/pajak_airtanah/simpandata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun : $('#tahun').val(),
...
function hitungsetor(){
	var jns_setoran = $('#jenis_setoran').select2('val');
	if (jns_setoran == 'STPD') {
		totalsetoranpajak = Number(toAngka($('#<?php echo $this->namatabel; ?>_BUNGATAGIHAN').val()));
...
function cetakSSPD() {
	...
	window.open('Setoranpajak_Trasfer/pajak_airtanah/cetakSSPD/?'+jQuery.param(param));
}

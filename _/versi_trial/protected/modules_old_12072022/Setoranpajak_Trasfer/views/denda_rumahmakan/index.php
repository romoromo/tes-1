...
<section id="widget-grid" class="">
	...
	<div class="row">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget jarviswidget-color-teal" id="wid-id-pajak_restodsfsdfran" 
...
<script type="text/javascript">
	...
	function cari() {
		...
		$("#btnCetakSSPD").show();
		$.ajax({
			url: 'Setoranpajak_Trasfer/denda_rumahmakan/getdata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun : $('#tahun').val(),
			...
			success:function (respon) {
				if (respon.data.validate=='kurang') {
					...
					if(respon.model.<?php echo $this->namatabel; ?>_THNENTRISETOR) {
						$('#<?php echo $this->namatabel; ?>_TANGGALSETOR, #TANGGAL_ENTRY').val(respon.model.<?php echo $this->namatabel; ?>_THNENTRISETOR+'-'+viewbulansetor+'-'+viewtahunsetor);
					} else {
						// $('#TANGGAL_ENTRY').val('');
					}
	...
	function simpan() {
		$.ajax({
			url: 'Setoranpajak_Trasfer/denda_rumahmakan/simpandata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun : $('#tahun').val(),
	...
	function cetakSSPD() {
		...
		window.open('Setoranpajak_Trasfer/denda_rumahmakan/cetakSSPD/?'+jQuery.param(param));
	}

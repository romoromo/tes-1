...
class Denda_rumahmakanController extends Controller
{
	...
	public function actionsimpandata()
	{
		...
		if (!empty($bunga_setor)) {
			...
			$arrayOfDataInsert['TBLSETOR_REKJENIS'] = $arrayOfDataInsert['TBLSETOR_REKJENIS'];
		...
		if (!empty($denda_setor)) {
			...
			$arrayOfDataInsert['TBLSETOR_REKJENIS'] = $arrayOfDataInsert['TBLSETOR_REKAYAT'];
			if (empty($jmlsetor))
				$arrayOfDataInsert['JENSET'] = 'B';
			else
				$arrayOfDataInsert['JENSET'] = '';

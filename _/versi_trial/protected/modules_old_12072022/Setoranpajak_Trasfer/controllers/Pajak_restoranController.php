	...
	public function actiongetdata()
	{
		...
		// var_dump($setbpd->params);
			...
			$arrayOfDataInsert = array(
				...
				,'TBLSETOR_BUNGAKETETAPAN' => $jenis_setoran=='SPTPD' ? (isset($setbpd[$NAMATABEL.'_BUNGASPTPD']) ? $setbpd[$NAMATABEL.'_BUNGASPTPD'] : 0) : ($jenis_setoran=='SKPDKB' ? $setbpd[$NAMATABEL.'_BUNGAKRGBAYAR'] : 0)
				,'TBLSETOR_BUNGATAGIHAN' => "0"
				,'TBLSETOR_BUNGAKURANGBAYAR' => "0"
				,'BURET' => "0"
				,'TBLSETOR_DENDAKETETAPAN' => $jenis_setoran=='SKPDKB' ? (isset($setbpd[$NAMATABEL.'_NAKB']) ? $setbpd[$NAMATABEL.'_NAKB'] : 0) : 0
...
if ($dendasetor>0) {
	...
	$arrayOfDataInsert['TBLSETOR_RUPIAHSETOR'] = ((isset($setbpd[$NAMATABEL.'_NAKB']) ? $setbpd[$NAMATABEL.'_NAKB'] : 0)+$dendasetor);
	$arrayOfDataInsert['TBLSETOR_DENDAKETETAPAN'] = $jenis_setoran=='SKPDKB' ? (isset($setbpd[$NAMATABEL.'_NAKB']) ? $setbpd[$NAMATABEL.'_NAKB'] : 0) : 0;

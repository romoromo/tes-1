	...
	public function actiongetdata()
	{
		...
		// var_dump($setbpd->params);
			...
			$arrayOfDataInsert = array(
				...
				,'TBLSETOR_RUPIAHSETOR' => $jenis_setoran=='STPD' ? $setbpd[$NAMATABEL.'_BUNGATAGIHAN'] : $setbpd[$NAMATABEL.'_PAJAK']
				...
				,'TBLSETOR_PAJAKKURANGBAYAR' => $jenis_setoran=='SKPDKB' ? $setbpd[$NAMATABEL.'_RUPIAHKRGBAYAR'] : 0
				,'TBLSETOR_BUNGAKETETAPAN' => isset($setbpd[$NAMATABEL.'_BUNGASPTPD']) ? $setbpd[$NAMATABEL.'_BUNGASPTPD'] : ''
				,'TBLSETOR_BUNGATAGIHAN' => "0"
				,'TBLSETOR_BUNGAKURANGBAYAR' => $jenis_setoran=='SKPDKB' ? $setbpd[$NAMATABEL.'_BUNGAKRGBAYAR'] : 0
				,'BURET' => "0"
...
if ($dendasetor>0) {
	...
	$arrayOfDataInsert['TBLSETOR_RUPIAHSETOR'] = $dendasetor;
	$arrayOfDataInsert['TBLSETOR_DENDAKETETAPAN'] = $dendasetor;
			// $arrayOfDataInsert['RPSSKP'] = ;
	$arrayOfDataInsert['TBLSETOR_REKPAJAK'] = '4';
...
public function actionCetakSSPD()
{
	...
	if ($data['jenis_setoran']=='STPD' || $data['jenis_setoran']=='SKPDKB') {
		 	$selectseto = ',TBLSETOR.TBLSETOR_RUPIAHSETOR,TBLSETOR.TBLSETOR_DENDAKETETAPAN';
		 } else {
		 	$selectseto = '';
		 }
	...
	{$NAMATABEL}_REGSETOR AS NOMORSSPD,
	...
	$from = 'TBLDAFTAR';
		...
		if ($data['jenis_setoran']=='STPD') {
        	$filter = array(
	            ...
	            // ,'EQ__TBLSETOR.TBLSETOR_JNSBAYAR' => 'STPD'
	        );
	    	...
	    	$filter = array(
	            ...
	            ,'EQ__'.$NAMATABEL.'.TBLPENDATAAN_THNPAJAK' => $TBLPENDATAAN_THNPAJAK
	            ,'EQ__'.$NAMATABEL.'.TBLPENDATAAN_BLNPAJAK' => $TBLPENDATAAN_BLNPAJAK
	            // ,'EQ__TBLSETOR.TBLSETOR_JNSBAYAR' => 'SKPDKB'
	        );
        	...
        	$filter = array(
	            ...
	            ,'EQ__'.$NAMATABEL.'.TBLPENDATAAN_THNPAJAK' => $TBLPENDATAAN_THNPAJAK
	            ,'EQ__'.$NAMATABEL.'.TBLPENDATAAN_BLNPAJAK' => $TBLPENDATAAN_BLNPAJAK
	            // ,'EQ__TRIM(TBLSETOR.TBLSETOR_JNSBAYAR)' => 'SPTPD'
	        );

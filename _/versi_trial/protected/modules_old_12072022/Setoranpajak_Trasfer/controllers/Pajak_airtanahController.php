...
class Pajak_airtanahController extends Controller
{
	...
	public function actionsimpandata()
	{
		...
		if ($jenis_setoran=='SKPD' OR $jenis_setoran=='SKPDKB') {
		...
		$arrayOfDataInsert = array(
			...
			,'TBLSETOR_RUPIAHSETOR' => $jenis_setoran=='STPD' ? $setbpd[$NAMATABEL.'_BUNGATAGIHAN'] : (isset($setbpd[$NAMATABEL.'_PAJAKSKPD']) ? $setbpd[$NAMATABEL.'_PAJAKSKPD'] : 0)
	...
	public function CetakWordSSPD($data=array())
	{
		...
		$namafileDL = "SSPD-Transfer-Air-Tanah.docx"; 

...
// echo "string";
	...
	header("Content-Disposition:attachment;Filename=Pembukuan-SKPDKB.xls");
...
public function actiongetangsuran()
	{
		...
		$data['detail'] = Yii::app()->db->createCommand('
			...
			'.$tbl.'.'.$tbl.'_RUPIAHKRGBAYAR,
			TBLANGSURAN.TBLANGSURAN_KETETAPANTOTAL,
			(TBLANGSURAN.TBLANGSURAN_KETETAPANTOTAL-'.$tbl.'.'.$tbl.'_RUPIAHKRGBAYAR) AS DENDATAMBAHAN,
			TBLDAFTAR.TBLDAFTAR_BADANUSAHANAMA,
			TBLDAFTAR.TBLDAFTAR_NOPOK,
			TBLDAFTAR.TBLDAFTAR_PEMILIKNAMA,
			TBLDAFTAR.TBLDAFTAR_BADANUSAHAALAMAT,

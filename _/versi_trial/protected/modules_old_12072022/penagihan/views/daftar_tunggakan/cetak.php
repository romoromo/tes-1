...
<tr>
    <th colspan="18" style="text-align-last:left;">
        LAPORAN TUNGGAKAN <?php echo $data ['judul'] ?> TAHUN <?php echo $masapajak = $_REQUEST['masapajak'] ?><br>
         BADAN PENGELOLAAN KEUANGAN DAN ASET DAERAH KOTA YOGYAKARTA TAHUN <?php echo $masapajak = $_REQUEST['masapajak'] ?> <br>

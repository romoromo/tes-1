...
<script type="text/javascript">
	...
	function cari() {
		...
		$.ajax({
			url: 'penagihan/Teguranairtanah/cari',
			type: 'POST',
			data: {
	...
	function cetakWord () {
		...
		if ($('#no_surat').val()=='') {
			...
			var q = daftaridPajak;
			window.open('<?= Yii::app()->getBaseUrl(1); ?>/penagihan/Teguranairtanah/cetakword/?data=' + q +"&TBLPENDATAAN_THNPAJAKA="+$('#TBLPENDATAAN_THNPAJAKA').val()+"&TBLPENDATAAN_THNPAJAKK="+$('#TBLPENDATAAN_THNPAJAKK').val()+"&TBLDAFTAR_NOPOK="+$('#TBLDAFTAR_NOPOK').val()+"&no_surat="+$('#no_surat').val()+"&tglawal="+$('#tglawal').val()+"&tglakhir="+$('#tglakhir').val() );
		}   
    ...
    function cetakdaftar () {
		...
		if ($('#no_surat').val()=='') {
			...
			var q = daftaridPajak;
			window.open('<?= Yii::app()->getBaseUrl(1); ?>/penagihan/Teguranairtanah/cetakdaftar/?data=' + q +"&TBLPENDATAAN_THNPAJAKA="+$('#TBLPENDATAAN_THNPAJAKA').val()+"&TBLPENDATAAN_THNPAJAKK="+$('#TBLPENDATAAN_THNPAJAKK').val()+"&TBLDAFTAR_NOPOK="+$('#TBLDAFTAR_NOPOK').val()+"&no_surat="+$('#no_surat').val()+"&tglawal="+$('#tglawal').val()+"&tglakhir="+$('#tglakhir').val() );
		}   
    ...
    function generateAutocompleteWPHotel() {
			$('#TBLDAFTAR_NOPOK').autocomplete({
				serviceUrl: 'penagihan/Teguranairtanah/autocomplete',
  	...
  	function cetakdaftar2 (jenis) {
			...
			window.open('<?php echo Yii::app()->getBaseUrl(1) ?>/penagihan/Teguranairtanah/Cetak?jenis='+jenis+'&TBLDAFTAR_NOPOK='+TBLDAFTAR_NOPOK+'&TBLPENDATAAN_THNPAJAKA='+TBLPENDATAAN_THNPAJAKA+'&TBLPENDATAAN_THNPAJAKK='+TBLPENDATAAN_THNPAJAKK);
		}

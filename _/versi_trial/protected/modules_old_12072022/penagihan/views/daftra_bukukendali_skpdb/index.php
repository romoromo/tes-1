...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <div class="well well-sm well-light bg-color-greenLight txt-color-white">
      <h4><i class="fa fa-file-text-o"></i> Cetak Laporan Buku Kendali SKPDKB </h4>
    </div>
  </div>
</div>
                    ...
                    <fieldset>
                      <div class="row">
                        ...
                        <section class="col col-sm-1">
                          <label class="input">
                           <input type="text" maxlength="4" id="tahunpjk" name="param[tahunpjk]">
                         </label>
                       </section>
                     </div>
                     <div class="row">
              ...
              <footer id="footer_cetakdata">
                ...
                <section class="col col-md-2">
                  <button type="button" class="btn btn-sm btn-primary" onclick="cetakv2()" style="float: left;">
                    <i class="fa fa-print"></i> Cetak V2
                  </button>
                </section>
              </footer>
            </div>
...
<script type="text/javascript">
  ...
  function cetak () {
    ...
    window.open(window.APP_URL+'/penagihan/Daftra_bukukendali_skpdb/cetak?tahunpjk='+window.tahunpjk+'&TBLREKENING_KODE='+window.TBLREKENING_KODE);
  }
  ...
  function cetakv2 () {
    ...
    window.APP_URL = "<?php echo $data['URL_APP']; ?>";
    window.open(window.APP_URL+'/penagihan/Daftra_bukukendali_skpdb/cetakv2?tahunpjk='+window.tahunpjk+'&TBLREKENING_KODE='+window.TBLREKENING_KODE+'&cara_penetapan='+window.cara_penetapan+'&JALAN='+window.JALAN+'&TBLKECAMATAN_ID='+window.TBLKECAMATAN_ID);
  }

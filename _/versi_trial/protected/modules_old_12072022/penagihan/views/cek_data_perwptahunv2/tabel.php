	...
	<thead>
		...
		<tbody>
			...
			<tr>
				...
				<td><?= LokalIndonesia::ribuan($row[$data['namatbl'].'_PAJAKSKPD']); ?></td>
				<td>
				...
				<td><?= LokalIndonesia::ribuan($row[$data['namatbl'].'_RUPIAHSETOR']); ?></td>
				<td><?= $row['TBLPENDATAAN_BLNPAJAK']; ?></td>
				...
				<td><?= LokalIndonesia::ribuan($row[$data['namatbl'].'_RUPIAHKRGBAYAR']); ?></td>
			</tr>
		<?php endforeach ?>
	</tbody>
</table>

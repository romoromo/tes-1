...
function cari () {
		...
		function cetak(jenis){
			...
			window.open('<?php echo Yii::app()->getBaseUrl(1) ?>/penagihan/daftartunggakan_skpdkb/Cetak?TBLDAFTAR_NOPOK='+TBLDAFTAR_NOPOK+'&TBLREKENING_KODE='+TBLREKENING_KODE+'&tahunkb='+tahunkb+'&jenis='+jenis+'&tahunpjk='+tahunpjk);
		}

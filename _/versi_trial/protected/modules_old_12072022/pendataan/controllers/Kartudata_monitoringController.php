...
class Kartudata_monitoringController extends Controller
{
	...
	public function actionCari()
	{
		...
		$tglentriawal = $_REQUEST['tglentriawal'] ? $_REQUEST['tglentriawal'] : '';
		$tglentriakhir = $_REQUEST['tglentriakhir'] ? $_REQUEST['tglentriakhir'] : '';
		...
		AND TGL_MONITORING BETWEEN TO_DATE ('$tglentriawal', 'DD-MM-YYYY') AND TO_DATE('$tglentriakhir', 'DD-MM-YYYY')
		";
	...
	public function actionCetakword()
	{
		...
		$namatpl = $path_tpl . 'cetak_sk_monitoring_hiburan3.docx';

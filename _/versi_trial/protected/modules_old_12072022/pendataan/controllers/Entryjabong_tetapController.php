...
class Entryjabong_tetapController extends Controller
{
	...
	{
		$model = Yii::app()->db->createCommand('SELECT TBLDAFTREKLAME_RUPIAHJABONG FROM TBLDAFTREKLAME WHERE TBLDAFTAR_NOPOK ='.$TBLDAFTAR_NOPOK.' AND TBLPENDATAAN_PAJAKKE = '.$pajakke.' AND TBLPENDATAAN_THNPAJAK = '.$tahun)->queryScalar();
		return $model;
	}

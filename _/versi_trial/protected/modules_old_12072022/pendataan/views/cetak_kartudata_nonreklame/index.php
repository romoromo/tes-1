...
<script type="text/javascript">
	...
	function cetak() {
		...
		window.open('<?php echo Yii::app()->getBaseUrl(1); ?>/pendataan/cetak_kartudata_nonreklame/cetak?' + param);
	}
	...
	function cetakWord(jenis) {
		...
		window.open('<?php echo Yii::app()->getBaseUrl(1); ?>/pendataan/cetak_kartudata_nonreklame/cetakWord?' + param);
	}

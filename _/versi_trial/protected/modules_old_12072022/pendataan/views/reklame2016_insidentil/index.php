	...
	<script type="text/javascript">
		...
		function generateAutocompleteWP() {
			$('#TBLDAFTAR_NOPOK').autocomplete({
				serviceUrl: 'pendataan/reklame2016_insidentil/autocompletewp',
		...
		function cekPernahDaftar() {
			...
			if (TBLDAFTAR_NOPOK=='') {
				...
				$.ajax({
					url: 'pendataan/reklame2016_insidentil/CekPernahDaftar',
					type: 'POST',
					dataType: 'json',
					data: {
			...
			var TBLPENDATAAN_TGLPAJAK = $('#TBLPENDATAAN_TGLPAJAK').val();
				$.ajax({
					url: 'pendataan/reklame2016_insidentil/cekNospt',
					type: 'POST',
					dataType: 'json',
					data: {
						 NOPOKOK: TBLDAFTAR_NOPOK
		...
		function cari() {
			...
			if (TBLDAFTAR_NOPOK=='') {
				...
				$("#btnsimpan").removeAttr('disabled');
				$.ajax({
					url: 'pendataan/reklame2016_insidentil/getdata',
					type: 'POST',
					dataType: 'json',
					data: {
...
function cetakPengambilan() {
	window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/reklame2016_insidentil/cetakPengambilan?');
}

function cetakJabong() {
	window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/reklame2016_insidentil/cetakJabong?');
}

function cetakIzinReklame() {
	window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/reklame2016_insidentil/cetakIzinReklame?');
}
...
function simpanPendataan() {
	...
	$.ajax({
		url: 'pendataan/reklame2016_insidentil/simpanPendataan',
		type: 'POST',
		dataType: 'json',
...
function getDataReklame() {
	var nodaftar = $('#TBLDAFTREKLAME_NODAFTARIZIN').val();
	$.ajax({
		url: 'pendataan/reklame2016_insidentil/GetDataReklame',
		type: 'POST',
		dataType: 'json',
		data: {
			 nodaftar: nodaftar

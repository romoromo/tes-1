	...
	$(document).ready(function() {
		...
		function generateAutocompleteWP() {
			$('#TBLDAFTAR_NOPOK').autocomplete({
				serviceUrl: 'pendataan/reklame2016_dll/autocompletewp',
		...
		function cekPernahDaftar() {
			...
			if (TBLDAFTAR_NOPOK=='') {
				...
				$.ajax({
					url: 'pendataan/reklame2016_dll/CekPernahDaftar',
					type: 'POST',
					dataType: 'json',
					data: {
		...
		function cekNospt() {
			...
			var TBLPENDATAAN_TGLPAJAK = $('#TBLPENDATAAN_TGLPAJAK').val();
				$.ajax({
					url: 'pendataan/reklame2016_dll/cekNospt',
					type: 'POST',
					dataType: 'json',
					data: {
						NOPOKOK: TBLDAFTAR_NOPOK
		...
		function cari() {
			...
			if (KODE==undefined) {
				...
				$.ajax({
					url: 'pendataan/reklame2016_dll/getdata',
					type: 'POST',
					dataType: 'json',
					data: {
...
function HitungPajak() {
	...
	NISEWA = (NSL * jmlrek * rekluas * JUMLAHHARI)/365;
...
function simpanPendataan() {
	...
	$.ajax({
		url: 'pendataan/reklame2016_dll/simpanPendataan',
		type: 'POST',
		dataType: 'json',

...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i>   Cetak Daftar Omset Tahunan</h4>
		</div>
	</div>
</div>
							...
							<fieldset>
								...
								<div class="row">
									<section class="col col-md-2">
										<p><strong>Tanggal Pajak</strong></p>
									</section>
							...
							<table width="100%" class="table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="dt_basic">
								<thead>
									<tr>
									    ...
									    <th data-hide="phone"><div class="center"> No Pokok</div></th>
									    <th data-class="expand"><div class="center"> Kecamatan</div></th>
									    <th data-hide="phone, tablet"><div class="center"> Kelurahan</div></th>
									    <th data-hide="phone, tablet"><div class="center"> Nama Badan Usaha</div></th>
									    <th data-hide="phone, tablet">Alamat Badan Usaha</th>
									</tr>
								</thead>
								<tbody>
									<tr>
									    ...
									    <td>Tegalrejo</td>
									    <td>Tegalrejo</td>
									    <td>Hotel Puri Gajah Mada</td>
									    <td>Jl Magelang No 25 YK</td>
									</tr>
								</tbody>
							</table>

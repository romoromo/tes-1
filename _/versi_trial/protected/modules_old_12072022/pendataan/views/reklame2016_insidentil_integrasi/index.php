...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Entry Pendataan Pajak Reklame Insidentil 2016</h4>
		</div>
	</div>
</div>
					...
					<form id="form-pendataan-reklame2016_tetap" class="smart-form">
						<fieldset>
							...
							<div class="row">
								...
								<section class="col col-md-4">
									<label class="input">
										<input type="text" id="TBLDAFTREKLAME_NODAFTARIZIN" name="param[TBLDAFTREKLAME_NODAFTARIZIN]" placeholder="Ketik Nomor Pendaftaran dari Perizinan">
									</label>
								</section>
							</div>
							<div class="row">
								...
								<section class="col col-md-2">
									<label class="input">
										<input value="<?= date('d-m-Y') ?>" class="datepicker" data-dateformat="dd-mm-yy" type="text" id="TBLPENDATAAN_TGLPAJAK" name="param[TBLPENDATAAN_TGLPAJAK]" placeholder="Tanggal Pajak" maxlength="10">
									</label>
								</section>
							...
							<div class="row">
								...
								<section class="col col-md-2">
									<label class="input">
										<input type="number" id="TBLPENDATAAN_PAJAKKE" name="param[TBLPENDATAAN_PAJAKKE]" placeholder="Lokasi" maxlength="10">
									</label>
								</section>
							</div>
							...
							<div class="row" id="kolomupdatenodaftizin" style="display: none;">
								<section class="col col-md-2">
									<p>Nomor Pendaftaran Izin Reklame</p>
								</section>
								<section class="col col-md-4">
									<label class="input">
										<input type="text" id="TBLDAFTREKLAME_NODAFTARIZIN_EDIT" 
										name="param[TBLDAFTREKLAME_NODAFTARIZIN_EDIT]">
									</label>
								</section>
								<button id="btnupdatenoizin" type="button" class="btn btn-sm btn-warning" onclick="updatenodaftizin()">
									<i class="fa fa-floppy-o"></i>&nbsp;Update Data No. Pendaftaran Izin
								</button>
							</div>
							<!-- //FORM WP -->
						</fieldset>
								...
								<div id="myTabReklameContent" class="tab-content padding-10">
									<div class="tab-pane fade in active" id="tabrek1">
										...
										<div class="row">
											...
											<section class="col col-md-3">
												<label class="select">
													<select class="select2" id="TBLDAFTREKLAME_SKORKAWASAN" name="param[TBLDAFTREKLAME_SKORKAWASAN]">
														<option selected="" disabled="" value=""></option>
														<?php foreach ($data['list_kelasjalanskorkawasan'] as $list): ?>
															<option idjnsrek="<?= $list['REFJENISREKLAMETARIF_ID'] ?>" value="<?= $list['RREKKAWASAN_SKOR'] ?>" skor="<?= $list['RREKKAWASAN_SKOR'] ?>"><?= $list['RREKKAWASAN_NAMA'] ?> [<?= $list['RREKKAWASAN_SKOR'] ?>]</option>
														<?php endforeach ?>
													</select>
												</label>
											</section>
											...
											<section class="col col-md-3">
												<label class="select">
													<select class="select2" id="RREKJNSREKTARIF_ID" name="param[RREKJNSREKTARIF_ID]">
														<option selected="" disabled="" value=""></option>
										...
										<div class="row">
											<section class="col col-md-2">
												<p>Sudut pandang menurut Simperizinan</p>
											</section>
											<section class="col col-md-3">
												<p id="muka_sisi"></p>
											</section>
											...
											<section class="col col-md-3">
												<label class="select">
													<select class="select2" id="RREKJNSPOSISI_ID" name="param[RREKJNSPOSISI_ID]">
														<option selected="" disabled="" value=""></option>
										...
										<div class="row">
											...
											<section class="col col-md-3">
												<label class="select">
													<select class="select2" id="REFSUDUTPANDANG_SKOR" name="param[REFSUDUTPANDANG_SKOR]">
														<option selected="" disabled="" value=""></option>
										...
										<div class="row">
											...
											<section class="col col-md-3">
												<label class="select">
													<select class="select2" id="REFKETINGGIAN_SKOR" name="param[REFKETINGGIAN_SKOR]">
														<option selected="" disabled="" value=""></option>
									...
									<div class="tab-pane fade in" id="tabrek2">
										...
										<div class="row">
											...
											<section class="col col-md-6 font-md">
												...
												<label class="col col-sm-1">X</label>
												<label class="col col-md-2 text-align-right TBLDAFTREKLAME_JUMLAHHARI"></label>
											</section>
										</div>
						...
						<fieldset id="form-dokumentasi-tanggal" style="display: none;">
							...
							<footer>
								<div id="tbl_simpan">
									...
									<button type="button" class="btn btn-sm btn-default" data-dismiss="modal" onclick="selesai()">
									...
									<a href="#pendataan/entryjabong_insidentil">
										<button id="btncetakjabong" type="button" class="btn btn-sm btn-success" disabled="">
...
<script type="text/javascript">
	...
	<?php
	$row = array();
	foreach($data['list_sdpandang1'] as $list)
	{	
		$row[] = array(
			"value"=> $list['RREKSUDUTPANDANG_SKOR']
			,'text'=> $list['RREKSUDUTPANDANG_NAMA'] . ' [' . $list['RREKSUDUTPANDANG_SKOR'] .'] '
			,'skor'=> $list['RREKSUDUTPANDANG_SKOR']
		);
	}
	$result = $row;
	echo ' SDPANDANG_JNS[1] = ' . CJSON::encode($result);
	?>;

	<?php
	$row = array();
	foreach($data['list_sdpandang2'] as $list)
	{	
		$row[] = array(
			"value"=> $list['RREKSUDUTPANDANG_SKOR']
			,'text'=> $list['RREKSUDUTPANDANG_NAMA'] . ' [' . $list['RREKSUDUTPANDANG_SKOR'] .'] '
	...
	$result = $row;
	echo ' SDPANDANG_JNS[2] = ' . CJSON::encode($result);
	?>;

	<?php
	$row = array();
	foreach($data['list_ketinggian1'] as $list)
	{	
		$row[] = array(
			"value"=> $list['RREKKETINGGIAN_SKOR']
			,'text'=> $list['RREKKETINGGIAN_NAMA'] . ' [' . $list['RREKKETINGGIAN_SKOR'] .'] '
			,'skor'=> $list['RREKKETINGGIAN_SKOR']
		);
	}
	$result = $row;
	echo ' TINGGI_JNS[1] = ' . CJSON::encode($result);
	?>;

	<?php
	$row = array();
	foreach($data['list_ketinggian2'] as $list)
	{	
		$row[] = array(
			"value"=> $list['RREKKETINGGIAN_SKOR']
			,'text'=> $list['RREKKETINGGIAN_NAMA'] . ' [' . $list['RREKKETINGGIAN_SKOR'] .'] '
	...
	$result = $row;
	echo ' TINGGI_JNS[2] = ' . CJSON::encode($result);
	?>;

	$("#TBLDAFTREKLAME_SKORKAWASAN").change(function(event) {
		var idx = $("#TBLDAFTREKLAME_SKORKAWASAN option:selected").attr('idjnsrek');
		setComboList('REFSUDUTPANDANG_SKOR', '', SDPANDANG_JNS[idx]);
		setComboList('REFKETINGGIAN_SKOR', '', TINGGI_JNS[idx]);
		$('#REFSUDUTPANDANG_SKOR').select2('val',"");
		$('#REFKETINGGIAN_SKOR').select2('val',"");
	});

		// $("#TBLDAFTREKLAME_SKORKAWASAN").trigger('change');
		...
		$("#TBLDAFTREKLAME_KETERANGAN1, #TBLDAFTREKLAME_KETERANGAN2, #TBLDAFTREKLAME_PENEMPATAN, #TBLDAFTREKLAME_NODAFTARIZIN, #TBLDAFTREKLAME_NODAFTARIZIN_EDIT").keyup(function(evt){
		...
		function generateAutocompleteWP() {
			$('#TBLDAFTAR_NOPOK').autocomplete({
				serviceUrl: 'pendataan/reklame2016_insidentil_integrasi/autocompletewp',
		...
		function cekPernahDaftar() {
			...
			if (TBLDAFTAR_NOPOK=='') {
				notifikasi('Informasi','Mohon isikan No Pokok WP','failed',1,0);
			} else if (TBLPENDATAAN_PAJAKKE=='') {
				notifikasi('Informasi','Mohon isikan Kode Lokasi','failed',1,0);
			} else {
				$.ajax({
					url: 'pendataan/reklame2016_insidentil_integrasi/CekPernahDaftar',
					type: 'POST',
					dataType: 'json',
					data: {
						NOPOKOK: TBLDAFTAR_NOPOK
						,TGLPAJAK: TBLPENDATAAN_TGLPAJAK
					...
					success : function (respon) {
						if (respon.status=='sudah') {
							$.SmartMessageBox({
								...
								content : "Data dengan Nomor Pokok "+TBLDAFTAR_NOPOK+", Masa Pajak "+TBLPENDATAAN_TGLPAJAK+" dengan pendataan ke "+TBLPENDATAAN_PAJAKKE+" sudah pernah didata. <br> Apakah anda ingin mengubah data ini?", // konten dari smart alert
		...
		function updatenodaftizin() {
			$("#btnupdatenoizin").attr('disabled', true);
			var TBLDAFTAR_NOPOK = $('#TBLDAFTAR_NOPOK').val();
			var TBLPENDATAAN_PAJAKKE = $('#TBLPENDATAAN_PAJAKKE').val();
			var TBLPENDATAAN_TGLPAJAK = $('#TBLPENDATAAN_TGLPAJAK').val();
			var nodaftarizin = $('#TBLDAFTREKLAME_NODAFTARIZIN_EDIT').val();

			$.ajax({
				url: 'pendataan/reklame2016_insidentil_integrasi/updatenomordaftizin',
				type: 'POST',
				dataType: 'json',
				data:  { nomordaftarizin: nodaftarizin
					,NOPOKOK: TBLDAFTAR_NOPOK
					,PAJAKKE: TBLPENDATAAN_PAJAKKE
					,TGLPAJAK: TBLPENDATAAN_TGLPAJAK
				},
				success: function(respon) {
					if (respon.status=='success') {
						notifikasi('No. Pendaftaran Izin berhasil disimpan', 'success', 1, 0);
						window.location.reload();
					} else {
						notifikasi('No. Pendaftaran Izin gagal disimpan', 'f', 1, 0);
						$("#btnupdatenoizin").attr('disabled', false);
					}
				}
			})
			.done(function() {
		...
		function cekNospt() {
			...
			var TBLPENDATAAN_TGLPAJAK = $('#TBLPENDATAAN_TGLPAJAK').val();
			$.ajax({
				url: 'pendataan/reklame2016_insidentil_integrasi/cekNospt',
				type: 'POST',
				dataType: 'json',
				data: {
					NOPOKOK: TBLDAFTAR_NOPOK
				...
				success : function (respon) {
					if (respon.status=='sudah') {
							...
							// });
							// return false;
							notifikasi('Maaf', 'Data Sudah Dalam Proses Selanjutnya.', 'f', 1, 0);
							setTimeout(function() {
								cari();
		...
		function cari() {
			...
			var TBLPENDATAAN_TGLPAJAK = $('#TBLPENDATAAN_TGLPAJAK').val();
			var NODAFTARIZIN = $('#TBLDAFTREKLAME_NODAFTARIZIN').val();
			if (TBLDAFTAR_NOPOK=='') {
				notifikasi('Informasi','Mohon isikan No Pokok WP','failed',1,0);
				...
				$("#btnsimpan").removeAttr('disabled');
				$.ajax({
					url: 'pendataan/reklame2016_insidentil_integrasi/getdata',
					type: 'POST',
					dataType: 'json',
					data: {
					...
					success: function(respon) {
						if (respon.data=='proses selanjutnya' || respon.data=='ada') {
							// getDataReklame();
							...
							if (respon.TAHUN_PERDA!=2016) {
								notifikasi('Maaf', 'Data dientri <b>bukan</b> melalui modul Pendataan Reklame PERDA 2016', 'failed', 1,0);
								$("#btnsimpan").attr('disabled', 1);
							}
							...
							$('#TBLDAFTREKLAME_NODAFTARIZIN_EDIT').val(respon.TBLDAFTREKLAME_NODAFTARIZIN);
							$("#kolomupdatenodaftizin").show('fast');
							...
							$('#TBLDAFTREKLAME_TGLENTRI').val('<?= date('d-m-Y')?>');
							$('#TBLDAFTREKLAME_TGLTERIMA').val('<?= date('d-m-Y')?>');
							$("#kolomupdatenodaftizin").hide('fast');
							if (NODAFTARIZIN!='') {
								getDataReklame();
							}
						}
...
function HitungPajak() {
	...
	NSL = ns * tarifharga;
	NSL = Number(NSL.toFixed(0)); // NSL tidak diceil, tapi outputnya tetap diceiling 
	...
	$(".TBLDAFTREKLAME_JUMLAHHARI").html(JUMLAHHARI);
...
$("#btnHitung").click(function(event) {
	rekening = $('#TREKENINGSUB_KODE').select2('val');
	keterangan1 = $('#TBLDAFTREKLAME_KETERANGAN1').val();
	keterangan2 = $('#TBLDAFTREKLAME_KETERANGAN2').val();
	jumlah_reklame = $('#TBLDAFTREKLAME_JMLHREKLAME').val();
	skorkawasan = $('#TBLDAFTREKLAME_SKORKAWASAN').select2('val');
	sudutpandang = $('#REFSUDUTPANDANG_SKOR').select2('val');
	ketinggian_skor = $('#REFKETINGGIAN_SKOR').select2('val');
	rek_panjang = $('#TBLDAFTREKLAME_PANJANG').val();
	rek_lebar = $('#TBLDAFTREKLAME_LEBAR').val();
	tgl_mulai = $('#TBLDAFTREKLAME_TGLMULAIREKLAME').val();

	if (rekening=="") {
		notifikasi('Data Kurang Lengkap', 'Mohon Isikan Rekening', 'f', 1, 0);
	} else if (keterangan1=="") {
		notifikasi('Data Kurang Lengkap', 'Mohon Isikan Keterangan', 'f', 1, 0);
	} else if (keterangan2=="") {
		notifikasi('Data Kurang Lengkap', 'Mohon Isikan Keterangan 2', 'f', 1, 0);
	} else if (jumlah_reklame=="") {
		notifikasi('Data Kurang Lengkap', 'Mohon Isikan Jumlah Reklame', 'f', 1, 0);
	} else if (skorkawasan==null) {
		notifikasi('Data Kurang Lengkap', 'Mohon Isikan Kelas Jalan', 'f', 1, 0);
	} else if (sudutpandang==null) {
		notifikasi('Data Kurang Lengkap', 'Mohon Isikan SD Pandang', 'f', 1, 0);
	} else if (ketinggian_skor==null) {
		notifikasi('Data Kurang Lengkap', 'Mohon Isikan Skor', 'f', 1, 0);
	} else if (rek_panjang=="") {
		notifikasi('Data Kurang Lengkap', 'Mohon Isikan Panjang', 'f', 1, 0);
	} else if (rek_lebar=="") {
		notifikasi('Data Kurang Lengkap', 'Mohon Isikan Lebar', 'f', 1, 0);
	} else if (tgl_mulai=="") {
		notifikasi('Data Kurang Lengkap', 'Mohon Isikan Tanggal Mulai', 'f', 1, 0);
	} else {
		$("#link_tabrek2").click();
	}
});
...
$("#TREKENINGSUB_KODE").change(function(event) {
	str = $('#TREKENINGSUB_KODE').select2('val');
	if (str.substr(-2)=='77') {
		$('#RREKJNSREKTARIF_ID').select2('val',1);
		$('#RREKJNSPOSISI_ID').select2('val',1);
	} else if (str.substr(-2)=='78') {
		$('#RREKJNSREKTARIF_ID').select2('val',1);
		$('#RREKJNSPOSISI_ID').select2('val',1);
	} else if (str.substr(-2)=='79') {
		$('#RREKJNSREKTARIF_ID').select2('val',1);
		$('#RREKJNSPOSISI_ID').select2('val',1);
	} else if (str.substr(-2)=='80') {
		$('#RREKJNSREKTARIF_ID').select2('val',3);
		$('#RREKJNSPOSISI_ID').select2('val',2);
	} else if (str.substr(-2)=='81') {
		$('#RREKJNSREKTARIF_ID').select2('val',3);
		$('#RREKJNSPOSISI_ID').select2('val',2);
	} else if (str.substr(-2)=='82') {
		$('#RREKJNSREKTARIF_ID').select2('val',3);
		$('#RREKJNSPOSISI_ID').select2('val',2);
	} else {
		$('#RREKJNSREKTARIF_ID').select2('val',"");
		$('#RREKJNSPOSISI_ID').select2('val',"");
	}
});
...
function cetakPengambilan() {
	window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/reklame2016_insidentil_integrasi/cetakPengambilan?');
}

function cetakJabong() {
	window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/reklame2016_insidentil_integrasi/cetakJabong?');
}

function cetakIzinReklame() {
	window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/reklame2016_insidentil_integrasi/cetakIzinReklame?');
}
...
function simpanPendataan() {
	...
	$.ajax({
		url: 'pendataan/reklame2016_insidentil_integrasi/simpanPendataan',
		type: 'POST',
		dataType: 'json',
...
$("#TBLDAFTREKLAME_NODAFTARIZIN").change(function(event) {
	...
	// if (n!=4) {
		if (!empty(str) && !str.includes('REK-I')) {
...
function getDataReklame(CALLBACK_FUNCTION) {
	...
	$.ajax({
		url: 'pendataan/reklame2016_insidentil_integrasi/GetDataReklame',
		type: 'POST',
		dataType: 'json',
		data: {
			nodaftar: nodaftar
		...
		success : function (respon) {
			if (respon.status=='found') {
				...
				notifikasi('Maaf', 'No Pendaftaran Izin Tidak Ditemukan', 'failed', 1,0);
				$("#btnsimpan").attr('disabled', true);
			}
...
$("#TBLPENDATAAN_TGLPAJAK").change(function(event) {
	var tgl = $("#TBLPENDATAAN_TGLPAJAK").val();
	$('#TBLPENDATAAN_THNPAJAK').val(tgl.split('-')[2]);
	$('#TBLPENDATAAN_BLNPAJAK').val(parseInt(tgl.split('-')[1]));
});
</script>
<style type="text/css">

...
class Cek_data_perwptahunv4Controller extends Controller
{
	...
	public function getData(){
		...
		SELECT
			...
			TBLANGSURAN_THNENTRISETOR AS TBLSETOR_THNSETOR,
			TBLANGSURAN_BLNENTRISETOR AS TBLSETOR_BLNSETOR,
			TBLANGSURAN_TGLENTRISETOR AS TBLSETOR_TGLSETOR,
		...
		";
			...
			SELECT
				...
				(TBLSETOR.TBLSETOR_RUPIAHSETOR + TBLSETOR.TBLSETOR_BUNGAKETETAPAN + TBLSETOR.TBLSETOR_DENDAKETETAPAN) AS TBLSETOR_RUPIAHSETOR,

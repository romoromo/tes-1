...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <div class="well well-sm well-light bg-color-greenLight txt-color-white">
      <h4><i class="fa fa-file-text-o"></i> Cetak Kartu Kendali </h4>
    </div>
  </div>
</div>
...
<script type="text/javascript">
  ...
  function cetak () {
   ...
   window.open('<?php echo Yii::app()->getBaseUrl(1) ?>/pembukuandanpelaporan/cetak_kartukendali/Cetak?tahun='+tahun+'&TBLREKENING_KODE='+TBLREKENING_KODE);
 }

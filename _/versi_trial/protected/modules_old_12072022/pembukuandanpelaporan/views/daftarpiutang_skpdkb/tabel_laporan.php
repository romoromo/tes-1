...
<table width="100%" border="0" style="border-collapse:collapse;" cellpadding="0" cellspacing="0" class="table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" >
	<thead>
		<tr>
			...
			<th data-hide="phone" align="center"> TH Pajak</th>
			<th data-hide="phone" align="center"> BL Pajak</th>
			<th data-hide="phone" align="center"> TGL SKPDKB</th>
			<th data-hide="phone" align="center"> Jenis</th>
			<th data-hide="phone" align="center"> Pajak Periksa</th>
			<th data-hide="phone" align="center"> Bunga KB</th>
			<th data-hide="phone" align="center"> Denda KB</th>
			<th data-hide="phone" align="center"> Ketetapan KB</th>
			...
			<th data-hide="phone" align="center"> Total Bayar</th>
	...
	<tbody>
		...
		<tr>
			...
			<td><?php echo $list[$data['NamaTBL'].'_REGKURANGBAYAR'] ?></td> <!-- NOKB -->
			...
			<td><?= $list[$data['NamaTBL'].'_REGSURATANGSUR'] == '' ? 'KB' : 'A' ;?></td>
			...
			<td><?php echo LokalIndonesia::ribuan($list['BAYAR']) ?></td>

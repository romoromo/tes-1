...
function cari () {
      ...
      success: function (respon) {
		...
		function cetak(jenis){
			...
			window.open('<?php echo Yii::app()->getBaseUrl(1) ?>/pembukuandanpelaporan/daftarpiutang_skpdkb/Cetak?TBLDAFTAR_NOPOK='+TBLDAFTAR_NOPOK+'&TBLREKENING_KODE='+TBLREKENING_KODE+'&tahunkb='+tahunkb+'&jenis='+jenis+'&tahunpjk='+tahunpjk+'&tahunpjk_akhir='+tahunpjk_akhir+'&tahunkb_akhir='+tahunkb_akhir);
		}

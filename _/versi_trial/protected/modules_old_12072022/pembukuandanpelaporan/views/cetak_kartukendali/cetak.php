...
<table width="100%" border="1" style="border-collapse:collapse;" cellpadding="0" cellspacing="0" class="table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" >
  ...
  -->
        ...
        <tr>
            ...
            <th colspan="18" style="text-align-last:left;">REALISASI WAJIB <?php echo $namarekening ?> TAHUN <?php echo $tahun = $_REQUEST['tahun'] ?><br>
    ...
    <tbody style="text-align: center;">
        ...
        <tr>
            ...
            <td><?php echo $list['TBLDAFTAR_JENISPENDAPATAN'] ?>.<?php echo $list['TBLDAFTAR_GOLONGAN'] ?>.<?php echo $list['TBLDAFTAR_NOPOK'] ?>.<?php echo $list['TBLKECAMATAN_IDBADANUSAHA'] ?>.<?php echo $list['TBLKELURAHAN_IDBADANUSAHA'] ?> </td>
...
<table width="100%" class="table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="dt_basic" cellpadding="5" border="0">
    <thead>
        ...
        <thead>  
          <tr>
            ...
            <th></th>
            <th></th>
            <th colspan="1">Ka. Sub Bid Pembukuan</th>
            <th></th>
            <th></th>
            <th></th>
            <th></th>
    ...
    <tbody style="text-align: center;">
      <tr>
        ...
        <td></td>
        <td></td>
        <td>RM. Santoso Tri Harianto. SIP<br>
            NIP. 19630415 199003 1 008
        </td>
        <td></td>
        <td></td>
        <td></td>

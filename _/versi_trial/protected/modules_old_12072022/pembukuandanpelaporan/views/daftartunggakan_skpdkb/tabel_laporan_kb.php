...
<table width="100%" border="0" style="border-collapse:collapse;" cellpadding="0" cellspacing="0" class="table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" >
	...
	<tbody>
		...
		<tr>
			...
			<td><?php echo $list[$data['NamaTBL'].'_REGKURANGBAYAR'] ?></td> <!-- Alamat WP -->
			<td><?php echo LokalIndonesia::getBulan($list[$data['NamaTBL'].'_BLNKBAWAL']) ?> - <?php echo LokalIndonesia::getBulan($list[$data['NamaTBL'].'_BLNKBAKHIR']) ?> 20<?php echo $list['TBLPENDATAAN_THNPAJAK'] ?></td> <!-- TH -->

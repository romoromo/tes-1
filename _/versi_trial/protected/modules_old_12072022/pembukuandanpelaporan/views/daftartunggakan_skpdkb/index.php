...
function cari () {
      ...
      window.open('<?php echo Yii::app()->getBaseUrl(1) ?>/pembukuandanpelaporan/daftartunggakan_skpdkb/Cetak?TBLDAFTAR_NOPOK='+TBLDAFTAR_NOPOK+'jenis_setoran='+jenis_setoran+'&TBLREKENING_KODE='+TBLREKENING_KODE+'&tahunkb='+tahunkb+'&jenis='+jenis+'&tahunpjk='+tahunpjk+'&tgl_cutoff='+tgl_cutoff+'&tahunpjk_akhir='+tahunpjk_akhir+'&tahunkb_akhir='+tahunkb_akhir);
    }

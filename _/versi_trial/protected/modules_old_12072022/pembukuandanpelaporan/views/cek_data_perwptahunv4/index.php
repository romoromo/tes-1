...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Check Data Per-WP Per-Tahun V3</h4>
		</div>
	</div>
</div>
					...
					<form action="" id="form_sumber_pajak" class="smart-form" novalidate>
						<fieldset>
							...
							<footer>
								...
								<button type="button" onclick="cetak('word')" class="btn btn-sm btn-primary">
...
<script type="text/javascript">
	...
	function cetak(jenis) {
		...
		window.open(URL_APLIKASI+"/pembukuandanpelaporan/cek_data_perwptahunv4/cetak?jenis="+jenis+"&TBLPENDATAAN_THNPAJAK="+window.TBLPENDATAAN_THNPAJAK+"&TBLDAFTAR_NOPOK="+window.TBLDAFTAR_NOPOK+"&rekening="+window.rekening);

...
<div class="well well-sm well-light text-center">
	<h4><i class="fa fa-tasks"></i> Cetak Daftar Ketetapan</h4>
</div>
						...
						<fieldset>
							...
							<div class="row">
								...
								<div class="row">
									...
									<section class="col col-md-2">
										<label class="input"> <i class="icon-append fa fa-calendar"></i>
											<input type="text" value="<?= date('d-m-Y') ?>" name="TGLENTRI2" class="datepicker" data-dateformat="dd-mm-yy" id="TGLENTRI2">
										</label>
									</section>
								</div>
								<div class="row">
						...
						<div class="widget-body no-padding">
							<div class="widget-body-toolbar">
								...
								<div class="group_button_proses_reklame pull-right" style="display: none;">
									...
									<button class="btn btn-sm txt-color-white bg-color-greenLight" onclick="cetakNotaWord()" type="button" style="display: none;">
									...
									<button class="btn btn-sm btn-default" id="btnskpdreklame" onclick="cetakSKPDWord()" type="button" style="display: none;">
								...
								<div class="group_button_proses_airtanah pull-right" style="display: none;">
									...
									<button class="btn btn-sm txt-color-white bg-color-greenLight" onclick="cetakNotaWordAirtanah()" type="button" style="display: none;">
										<i class="fa fa-print"></i> Cetak Nota
									</button>
									...
									<button class="btn btn-sm btn-default" id="btnskpdairtanah" onclick="cetakSKPDWordAirtanah()" type="button" style="display: none;">
										<i class="fa fa-print"></i> Cetak SKPD
									</button>
...
<script type="text/javascript">
	...
	function loadDataTable() {
		...
		$.ajax({
			url: 'pembukuandanpelaporan/cetak_daftar_ketetapan/cari',
			type: 'POST',
	...
	function cetakDaftarWordAirtanah() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/penetapan/cetak_ulang_ketetapan/cetakdaftarwordairtanah/?data=' + q +"&TBLPENDATAAN_THNPAJAK="+window.TBLPENDATAAN_THNPAJAK+"&TBLPENDATAAN_BLNPAJAK="+TBLPENDATAAN_BLNPAJAK+"&TBLDAFTREKLAME_TGLSKPD="+TBLDAFTREKLAME_TGLSKPD+"&TGLENTRI="+TGLENTRI+"&TGLENTRI2="+TGLENTRI2+"&TGLSKPD="+TGLSKPD);
	}
	...
	function cetakNotaWord() {
		...
		window.TGLENTRI2 = $('#TGLENTRI2').val();
		TGLSKPD = $('#TGLSKPD').val();
		...
		var q = btoa(daftaridPajak);
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/penetapan/cetak_ulang_ketetapan/cetaknotaword/?data=' + q +"&TBLDAFTREKLAME_JNSREKLAME="+window.TBLDAFTREKLAME_JNSREKLAME+"&TGLENTRI="+window.TGLENTRI+"&TGLENTRI2="+window.TGLENTRI2);
	}

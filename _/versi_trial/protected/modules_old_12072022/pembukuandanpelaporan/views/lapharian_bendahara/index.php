			...
			<div>
				...
				<div class="table-responsive" style="max-width: 100%; height: 800px!important; overflow: auto;">
					<button class="btn btn-sm btn-default" onclick="cetak('html')">
						<i class="fa fa-print"></i> Cetak Browser
					</button>
	...
	<script type="text/javascript">
		...
		function cetak (jenis) {
			...
			if ($('#tgl_setor').val()=='') {
				...
				window.open('<?php echo Yii::app()->getBaseUrl(1) ?>/pembukuandanpelaporan/lapharian_bendahara/Cetak?tgl_setor='+tgl_setor+'&jenis='+jenis);
				$('#id_respencarian').hide();
			}
		}

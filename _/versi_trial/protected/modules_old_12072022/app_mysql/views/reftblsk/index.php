...
<div class="well">
	<form class="form-horizontal" id="tambah_tabelsk">
		<fieldset>
			<p><b class="font-lg">Tabel SK</b> <br>Buat tabel baru</p>
			<div class="form-group">
				<label class="col-md-3 control-label">Nama Tabel:</label>
				<div class="col-md-4">							
				<div class="input-group">
					<span class="input-group-addon">tblsk_</span>
					...
					<select class="form-control" id="nama_tabel" name="nama_tabel" type="text">
						<option value="0"> === Silahkan Pilih Tabel=== </option>
							<?php
									...
									echo '<option value="'.$tabel['tblskizin_tabelvariabel_id'].'">'.$tabel['tblskizin_tabelsk'].'</option>';
									}
							?>
						</select>
				</div>

...
<div class="well well-sm well-light">
	<h1 class="text-center font-lg"><i class="fa fa-book"></i> Entry Phonebook</h1>
</div>
<!-- widget grid -->
				  ...
				  <div class="widget-body no-padding">
					<form action="" id="login-form" class="smart-form" novalidate="novalidate">
						...
						<fieldset>
							...
							<section>
								<div class="row">
									<label class="label col col-2">Nama</label>
									<div class="col col-3">
										<label class="input">
							...
							<section>
								<div class="row">
									<label class="label col col-2">Status No</label>
									<div class="col col-3">
										<label class="select"> 											
											<select id="statsuno">
					  ...
					  <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
						  <thead>			                
							  <tr>
								 ...
								 <th width="25%" data-class="expand"><i class=" text-muted hidden-md hidden-sm hidden-xs"></i> Nama </th>
								  ...
								  <th width="11%" data-hide="phone,tablet">Group Phonebook </th>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class="fa fa-fw fa-2x fa-file-text-o"></i>&nbsp;Form Entry Phoebook</h4>
			</div>
			<form action="" id="form_izin" class="smart-form" novalidate>
				...
				<fieldset>
					...
					<section>
						<div class="row">
							<label class="label col col-3">Nomor HP</label>
							<div class="col col-4">
								<label class="input">
									<input type="text" id="nohp">
								</label>

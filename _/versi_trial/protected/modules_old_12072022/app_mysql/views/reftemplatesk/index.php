...
<div class="well well-sm well-light">	
	...
	<a href="#app/reftblsk" class="btn btn-labeled btn-primary">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class="fa fa-check"></i>&nbsp;Form Template SK</h4>
			</div>
				...
				<fieldset>
					<div class="row">
						<section class="col col-3">
							<p>Tabel variabel template SK </p>
						</section>
							...
							<label class="select">
								...
								<option value="0">===Silahkan Pilih Table===</option>
										<?php
											...
											echo '<option value="'.$table['tblskizin_tabelvariabel_id'].'">'.$table['tblskizin_tabelsk'].'</option>';
											}
										?>
								</select> <i></i>  
							</label>
			...
			<form method="post" enctype="multipart/form-data" class="smart-form" action="app/Reftemplatesk/SimpanFileTemplateSK" id="form-upload-sk">
			<fieldset>
				<div class="row">
					<section class="col col-6">
						<label class="label">Upload Template SK</label>
						<label for="file" class="input input-file">
								<div class="button">
									...
									<b class="tooltip tooltip-top-right">Upload Template SK</b>
						</label>
						<input type="hidden" name="namafilenya_sk" id="namafilenya_sk" value="">
					</section>
				</div>
		...
		var options = { 
		    ...
		    success: function(respon) 
		    {
		    	...
		    	if (respon.responseText!='failed'){
					...
					notifikasi("Sukses","Data berhasil disimpan","success",false,0);
					reload();
				}
				else
					notifikasi("Gagal","Data gagal disimpan","failed",false,0);
...
function getvariabel (tabel) {
	$.ajax({
		url: 'app/reftemplatesk/InfoVariabel',
		type: 'post',
		data: {tabel: tabel},
		success:function(respon){
...
function getJenisPermohonan(idizin) {
		$.ajax({
                type: 'POST',
                url: 'app/reftemplatesk/GetJenisPermohonan',
                dataType: 'html',
                data: {
                	id: idizin
                },

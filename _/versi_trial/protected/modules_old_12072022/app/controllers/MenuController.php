...
class MenuController extends Controller
{
	...
	public function actionSimpan()
	{
		...
		$model->TBLMENU_ICON = strval($_REQUEST['TBLMENU_ICON'])!='' ? strval($_REQUEST['TBLMENU_ICON']) : ''; 
		$model->TBLMENU_KODE = strval($_REQUEST['TBLMENU_KODE'])!='' ? strval($_REQUEST['TBLMENU_KODE']) : ''; 

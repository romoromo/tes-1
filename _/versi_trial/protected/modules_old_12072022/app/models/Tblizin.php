 ...
 * @property string $tblizin_adaceklap
 * @property string $tblizin_adarekomendasi
...
class Tblizin extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('tblizin_lama, tblrole_id', 'numerical', 'integerOnly'=>true),
			array('tblizin_nama, tblizin_icon', 'length', 'max'=>255),
			array('tblizin_adaretribusi, tblizin_adaceklap, tblizin_adarekomendasi, tblizin_terstruktur, tblizin_isaktif', 'length', 'max'=>1),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('tblizin_id, tblizin_nama, tblizin_lama, tblizin_icon, tblizin_adaretribusi, tblizin_adaceklap, tblizin_adarekomendasi, tblizin_terstruktur, tblrole_id, tblizin_isaktif', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'tblizin_adaceklap' => 'Tblizin Adaceklap',
			'tblizin_adarekomendasi' => 'Tblizin Adarekomendasi',
	...
	public function search()
	{
		...
		$criteria->compare('tblizin_adaceklap',$this->tblizin_adaceklap,true);
		$criteria->compare('tblizin_adarekomendasi',$this->tblizin_adarekomendasi,true);

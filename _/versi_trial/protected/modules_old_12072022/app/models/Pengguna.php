...
class Pengguna extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('TBLPENGGUNA_NAMA, TBLPENGGUNA_USERNAME', 'required'),
			array('TBLROLE_ID', 'numerical', 'integerOnly'=>true),
			array('TBLPENGGUNA_NAMA, TBLPENGGUNA_USERNAME, TBLPENGGUNA_PASSWORD', 'length', 'max'=>255),
			array('TBLPENGGUNA_IDSUBUNIT', 'length', 'max'=>15),
			array('TBLPENGGUNA_STATUS', 'length', 'max'=>1),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('TBLPENGGUNA_ID, TBLPENGGUNA_NAMA, TBLPENGGUNA_USERNAME, TBLPENGGUNA_PASSWORD, TBLROLE_ID, TBLPENGGUNA_IDSUBUNIT, TBLPENGGUNA_STATUS, TBLPENGGUNA_MODIFIED, TBLPENGGUNA_CREATED', 'safe', 'on'=>'search'),
		);
	}

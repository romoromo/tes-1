						...
						<table id="dt_basic_pipeline" class="table table-striped table-bordered table-hover" width="100%">
							<thead>
								<tr>
									...
									<th data-hide="phone,tablet">Uraian Jabatan</th>
									<th data-hide="phone,tablet">Penanda Tangan A/N</th>
									<th></th>
								</tr>
							</thead>
							<tbody>
			...
			<div class="modal-body no-padding">
				...
				<form id="form-data" class="smart-form">
					...
					<fieldset>
						...
						<section>
							<div class="row">
								<label class="label col col-4">Uraian Jabatan</label>
								<div class="col col-10">
									<label class="input"> <i class="icon-append fa fa-square"></i>
										<input value="" type="text" name="param[TBLPEJABAT_URAIAN]" id="TBLPEJABAT_URAIAN">
									</label>
								</div>
							</div>
						</section>
						...
						<section>
							<div class="row">
								<label class="label col col-4">Tanda Tangan A/N</label>
								<div class="col col-10">
									<label class="select">
												<select class="select2" id="REFJABATAN_ID" name="param[REFJABATAN_ID]" >
...
// DO NOT REMOVE : GLOBAL FUNCTIONS!
	...
	$("#TBLPEJABAT_NAMA, #TBLPEJABAT_URAIAN").keyup(function(evt){
	...
	function runFormValidation() {
		var $FormData = $("#form-data").validate({
				...
				messages : {
					...
					,"param[TBLPEJABAT_URAIAN]" : {
						required : 'Mohon isikan Uraian Jabatan'
					}

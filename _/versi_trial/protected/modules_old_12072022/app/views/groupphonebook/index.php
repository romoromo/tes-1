...
<div class="well well-sm well-light">
	<h1 class="text-center font-lg"><i class="fa fa-book"></i> Group Phonebook</h1>
</div>
<!-- widget grid -->
				  ...
				  <div class="widget-body no-padding">
					<form action="" id="login-form" class="smart-form" novalidate="novalidate">
						...
						<fieldset>
							<section>
								<div class="row">
									<label class="label col col-2">Kode Group</label>
									<div class="col col-3">
										<label class="input">
							...
							<section>
								<div class="row">
									<label class="label col col-2">Nama Group</label>
									<div class="col col-3">
										<label class="input">
					  ...
					  <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
						  <thead>			                
							  <tr>
								 ...
								 <th width="25%" data-class="expand"><i class=" text-muted hidden-md hidden-sm hidden-xs"></i> Kode Group </th>
								  <!-- <th width="9%" data-hide="phone"><i class=" text-muted hidden-md hidden-sm hidden-xs"></i>Lama Proses</th> -->
								  <th width="24%">Nama Group</th>

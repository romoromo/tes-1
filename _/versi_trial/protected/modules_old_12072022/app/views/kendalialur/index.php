...
<!-- Modal -->
<div class="modal fade" id="kendali-form" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					...
					<fieldset>
							...
							<div class="row">
								...
								<div class="col col-10">
									<label class="select"> <i class="icon-append fa fa-user"></i>
										<select class="select2" name="jenis_izin" id="jenis_izin">
						...
						<section>
							<div class="row">
								...
								<div class="col col-10">
									<label class="select"> <i class="icon-append fa fa-user"></i>
										<select class="select2" name="bloksistem" id="bloksistem">
						...
						<section>
							<div class="row">
								<label class="label col col-4">Urut</label>
								<div class="col col-10">
						...
						<section>
							<div class="row">
								<label class="label col col-4">Jml hari batas waktu</label>
								<div class="col col-10">
									<label class="input"> <i class="icon-append fa fa-user"></i>
										<input value="" type="text" name="hari" id="hari"> 
						...
						<section>
							<div class="row">
								<label class="label col col-4">Jml jam batas waktu</label>
								<div class="col col-10">
									<label class="input"> <i class="icon-append fa fa-user"></i>
										<input value="" type="text" name="waktu" id="waktu">
									</label>
			...
			<div class="modal-body no-padding">
				...
				<form class="smart-form" id="form-alur">
					...
					<fieldset>
						...
						<section>
							<div class="row">
								<label class="label col col-6">Urutan</label>

								<label class="label col col-6">Bloksistem</label>
						...
						<section>
							<div class="row">
								<label class="label col col-4">Batas Hari</label>

								<label class="label col col-4">Batas Jam</label>

								<label class="label col col-4">Aktifkan?</label>

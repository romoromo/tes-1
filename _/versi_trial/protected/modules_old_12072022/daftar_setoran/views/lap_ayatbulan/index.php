		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			>
				...
				<header>
					...
					<h2>Form Cetak Buku Pembantu Per Rinci Obyek Pajak</h2>
								...
								<section class="col col-md-2">
									<label class="select">
										<select name="rekening" id="rekening">
											...
											<option value="8">Pajak Sarang Burung Walet</option>
											<option value="9">Pajak Bumi Dan Bangunan</option>
											<option value="10">Pajak BPHTB</option>
											<option value="11">Sewa Aset</option>
											<option value="12" >Sewa Aset</option>
										</select> <i></i> 
									</label>
								</section>
							</div>

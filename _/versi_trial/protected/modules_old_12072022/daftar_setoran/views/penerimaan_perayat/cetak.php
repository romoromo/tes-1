     ...
     <!--  <thead>  
      ...
      <tbody>
        <tr>
          ...
          <td> : </td>
          <td> Dinas Pajak Daerah Dan Pengelolaan Keuangan </td>
          <tr>
            <td align="left" width="15%">Pengguna Anggaran</td>
            <td> : </td>
            <td> Drs. Kadri Renggono,M.SI </td>
          </tr>
          <tr>
...
<table width="100%" border="0" style="border-collapse:collapse;" cellpadding="0" cellspacing="0" class="table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" >
  ...
  <?php $totalppj = $totalppj+$list['TBLDAFTHOTEL_PAJAKPERIKSAPJ'];?>
  <?php $totalppjbngdnd = $totalppjbngdnd+$list['BNGDNDPPJ'];?>
  <?php $totalparkir = $totalparkir+$list['TBLDAFTHOTEL_PAJAKPERIKSAARKIR'];?>
  ...
  <?php $totalburungbngdnd = $totalburungbngdnd+$list['BNGDNDWALET'];?>
    <tr>
      ...
      <td><div align="right"><?php echo LokalIndonesia::ribuan($list['TBLDAFTHOTEL_PAJAKPERIKSAPJ'] )?><br><?php echo LokalIndonesia::ribuan($list['BNGDNDPPJ'] )?></div></td> <!-- P.P.J -->
      <td><div align="right"><?php echo LokalIndonesia::ribuan($list['TBLDAFTHOTEL_PAJAKPERIKSAARKIR'] )?><br><?php echo LokalIndonesia::ribuan($list['BNGDNDPARKIR'] )?></div></td> <!-- Pajak Parkir -->

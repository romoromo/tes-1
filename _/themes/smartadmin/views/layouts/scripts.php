		...
		<script src="<?php echo ASSETS_URL; ?>/js/plugin/offline/offline.min.js"></script>
		<link rel="stylesheet" type="text/css" href="<?php echo ASSETS_URL; ?>/js/plugin/offline/offline-theme-slide.css">
		<link rel="stylesheet" type="text/css" href="<?php echo ASSETS_URL; ?>/js/plugin/offline/offline-language-english.css">

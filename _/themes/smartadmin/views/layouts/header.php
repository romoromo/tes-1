<?php
	...
	$page_body_prop = array("class"=>"fixed-header fixed-navigation smart-style-2"); //optional properties for <body>
	if( defined('LOGIN') ) 
		...
		<header id="header" style="background-image: linear-gradient(to bottom,#1B7150,rgba(32, 139, 103, 1));border-bottom: 2px solid #D5C7C7;box-shadow: 1px 1px 2px #DDDB18;">
			...
			<div class="pull-right">
				...
				<div id="kembali" class="btn-header transparent pull-right">
					<span> <a href="<?php echo APP_URL; ?>/site/login" title="Log Out" data-logout-msg="Terima Kasih, telah menggunakan aplikasi ini. Klik Ya untuk logout." ><i class="fa fa-sign-out"></i> </a> </span>
				</div>
				<!-- end kembali button -->

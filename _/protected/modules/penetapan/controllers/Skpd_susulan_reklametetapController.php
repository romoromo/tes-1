...
class Skpd_susulan_reklametetapController extends Controller
{
	var $KODE_GOL = 2;
	var $PAJAK_AYAT = 4;
	...
	public function cekPernahDaftar($thn, $lokasi, $nopok)
	{
		$model = Yii::app()->db->createCommand('SELECT COUNT(TBLPENDATAAN_THNPAJAK) AS JML FROM TBLDAFTREKLAME WHERE TBLPENDATAAN_THNPAJAK ='.$thn.' AND TBLPENDATAAN_PAJAKKE='.$lokasi.' AND TBLDAFTAR_NOPOK='.$nopok)->queryScalar();
		return $model;
	}

...
class Skpdlb_airtanahController extends Controller
{
    var $KODE_GOL    = 1;
    var $PAJAK_AYAT  = 8;
    var $PAJAK_REK   = '4.1.1.8.0';
    var $MODUL_URL   = 'penetapan/skpdlb_airtanah';

    public $namatabel  = 'TBLDAFTTANAH';
    public $PAJAK_NAMA = 'AIR TANAH';
    ...
    {
        $model = Yii::app()->db->createCommand("SELECT TBLSETOR_NOMORSSPD FROM TBLSETOR WHERE TBLPENDATAAN_THNPAJAK ='$thn' AND TBLPENDATAAN_BLNPAJAK='$bulan' AND NVL(TBLPENDATAAN_TGLPAJAK, 0)={$TGL} AND TBLDAFTAR_NOPOK='$nopok' AND TRIM(TBLSETOR_JNSBAYAR) = 'SKPD'")->queryScalar();
        return $model;
    }

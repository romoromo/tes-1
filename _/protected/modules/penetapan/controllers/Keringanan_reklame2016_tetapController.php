...
class Keringanan_reklame2016_tetapController extends Controller
{
	var $KODE_GOL = 2;
	var $PAJAK_AYAT = 4;
	...
	public function actionupdatenomordaftizin()
	{
		...
		$where = 'TBLPENDATAAN_THNPAJAK ='.$THNPAJAK.' AND NVL(TBLPENDATAAN_BLNPAJAK, 0)=0 AND NVL(TBLPENDATAAN_TGLPAJAK, 0)=0 AND TBLPENDATAAN_PAJAKKE='.$PAJAKKE.' AND TBLDAFTAR_NOPOK='.$NOPOKOK;
		$simpan = $insert->update('TBLDAFTREKLAME', $arrayData, $where);

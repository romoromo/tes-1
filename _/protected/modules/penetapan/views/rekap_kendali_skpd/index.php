...
<div class="well well-sm well-light bg-color-greenLight txt-color-white">
            <h4><i class="fa fa-file-text-o"></i> Cetak Laporan Realisasi SKPD </h4>
</div>
</div>
</div>
                  ...
                  <section class="col col-3">
                      <label class="select">
                              <select class="input-md" enabled="enabled">
                                ...
                                <option value="3" >PAJAK REKLAME</option>
                                <option value="4" >PAJAK PENERANGAN JALAN</option>
                                <option value="5" >PAJAK PARKIR</option>
                                <option value="6" >PAJAK AIR TANAH</option>
                                <option value="7" >PAJAK SARANG BURUNG WALET</option>
                  ...
                  <section class="col col-3">
                      <label class="select">
                              <select class="input-md" enabled="enabled">
                                ...
                                <option value="1" >HOTEL BINTANG</option>
                                <option value="2" >HOTEL MELATI DUA</option>
                                <option value="3" >LOSMENT/PENGINAPAN</option>
                                <option value="4" >TUNGGAKAN PAJAK HOTEL</option>
                                <option value="5" >HOTEL BINTANG LIMA</option>
                                <option value="6" >HOTEL BINTANG EMPAT</option>
                                <option value="7" >HOTEL BINTANG TIGA</option>
                                <option value="8" >HOTEL BINTANG DUA</option>
                                <option value="9" >HOTEL BINTANG SATU</option>
                                <option value="10" >HOTEL MELATI TIGA</option>
                                <option value="11" >HOTEL MELATI SATU</option>
                              </select><i></i>
                      </label>
                  </section>
</div>
...
<script type="text/javascript">
    ...
    function cetak () {
    window.open(window.APP_URL+'/penetapan/rekap_kendali_skpd/cetak');
}
</script>
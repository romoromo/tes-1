...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Entry Pendataan Pajak Reklame Insidentil</h4>
		</div>
	</div>
</div>
						...
						<form id="form-pendataan-reklame2016_tetap" class="smart-form">
							<fieldset>
								...
								<div class="row">
									...
									<section class="col col-md-2">
										<label class="input">
											<input value="1" type="number" id="TBLPENDATAAN_PAJAKKE" name="param[TBLPENDATAAN_PAJAKKE]" placeholder="Lokasi" maxlength="10">
										</label>
									</section>
								</div>
							...
							<footer>
								<div id="tbl_simpan">
									<button type="submit" class="btn btn-sm btn-primary" style="float: left;">
	...
	<script type="text/javascript">
		...
		function generateAutocompleteWP() {
			$('#TBLDAFTAR_NOPOK').autocomplete({
				serviceUrl: 'penetapan/keringanan_reklame_insidentil/autocompletewp',
		...
		function cari() {
			...
			if (TBLDAFTAR_NOPOK=='') {
				...
				$.ajax({
					url: 'penetapan/keringanan_reklame_insidentil/getdata',
					type: 'POST',
					dataType: 'json',
					data: {
...
function simpanPendataan() {
	...
	$.ajax({
		url: 'penetapan/keringanan_reklame_insidentil/simpanPendataan',
		type: 'POST',
		dataType: 'json',

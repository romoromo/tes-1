...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file fa-fw"></i> SPT Pajak Air Tanah 2017</h4>
		</div>
	</div>
</div>
...
function generateAutocompleteWPAirTanah() {
	...
	serviceUrl: 'penetapan/pajak_airtanah2017/autocompletewpairtanah',
...
function WPAirTanah2(nopokok) {
	$.ajax({
		url: 'penetapan/pajak_airtanah2017/autocompletewpairtanah2',
		type: 'POST',
		dataType: 'json',
		data: {
			nopokok : nopokok
...
function cekPernahDaftar() {
	...
	if (TBLDAFTAR_NOPOK=='') {
		...
		$.ajax({
			url: 'penetapan/pajak_airtanah2017/CekPernahDaftar',
			type: 'POST',
			dataType: 'json',
			data: {
...
function cari() {
	...
	if (TBLDAFTAR_NOPOK=='') {
		...
		$.ajax({
		url: 'penetapan/pajak_airtanah2017/GetWPAirTanah',
		type: 'POST',
		dataType: 'json',
		data: {
			 nopokok: $('#TBLDAFTAR_NOPOK').val()
...
function getTarifRekening(kodesubrek) {
	$.ajax({
		url: 'penetapan/pajak_airtanah2017/GetKodeRek',
		type: 'POST',
		dataType: 'json',
		data: {
...
function simpanairtanah () {
	$.ajax({
		url: 'penetapan/pajak_airtanah2017/SimpanAirTanah',
		type: 'post',
		dataType: "json",
...
function getTglBatas(THNPAJAK,BLNPAJAK,KODEREK) {
	$.ajax({
		url: 'penetapan/pajak_airtanah2017/GetTGLBatas',
		type: 'POST',
		dataType: 'json',
		data: {
			 THNPAJAK : THNPAJAK

		...
		<tr>
			<td>
				...
				<?php else: ?>
					<div align="center">
						<label class="checkbox">
							<input checked="" class="cbx_tetapkan" value="<?php echo $rowtap['TBLDAFTAR_NOPOK'] ?>-<?php echo $rowtap['TBLPENDATAAN_THNPAJAK'] ?>-<?php echo $rowtap['LOKASI'] ?>-<?php echo $no; ?>-<?php echo $rowtap['PAJAK'] ?>-<?php echo $rowtap['TBLPENDATAAN_TGLPAJAK'] ?>-<?php echo $rowtap['TBLPENDATAAN_BLNPAJAK'] ?>" name="nopokPajak" type="checkbox">
							<i></i>
						</label>
					</div>
				<?php endif; ?>

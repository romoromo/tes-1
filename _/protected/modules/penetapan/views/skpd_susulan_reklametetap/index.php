...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> SKPD Susulan Pajak Reklame Tetap</h4>
		</div>
	</div>
</div>
									...
									<div id="myTabReklameContent" class="tab-content padding-10">
										<div class="tab-pane fade in active" id="tabrek1">
											...
											<div class="row">
												...
												<section class="col col-md-3">
													<label class="input">
														<input class="input-sm text-align-right" type="number" id="" name="">
													</label>
												</section>
												<section class="col col-md-2">
													<p>Kd Jalan</p>
	...
	<script type="text/javascript">
		...
		function generateAutocompleteWP() {
			$('#TBLDAFTAR_NOPOK').autocomplete({
				serviceUrl: 'penetapan/skpd_susulan_reklametetap/autocompletewp',
		...
		function cari() {
			...
			if (TBLDAFTAR_NOPOK=='') {
				...
				$.ajax({
					url: 'penetapan/skpd_susulan_reklametetap/getdata',
					type: 'POST',
					dataType: 'json',
					data: {
...
function simpanPendataan() {
	...
	$.ajax({
		url: 'penetapan/skpd_susulan_reklametetap/simpanPendataan',
		type: 'POST',
		dataType: 'json',

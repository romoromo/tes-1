...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Reklame Tetap Perda 2016</h4>
		</div>
	</div>
</div>
	...
	<script type="text/javascript">
		...
		function generateAutocompleteWP() {
			$('#TBLDAFTAR_NOPOK').autocomplete({
				serviceUrl: 'penetapan/reklametetap_perda2016/autocompletewp',
		...
		function cari() {
			...
			if (TBLDAFTAR_NOPOK=='') {
				...
				$.ajax({
					url: 'penetapan/reklametetap_perda2016/getdata',
					type: 'POST',
					dataType: 'json',
					data: {
...
function simpanPendataan() {
	...
	$.ajax({
		url: 'penetapan/reklametetap_perda2016/simpanPendataan',
		type: 'POST',
		dataType: 'json',

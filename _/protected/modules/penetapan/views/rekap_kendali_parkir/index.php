...
<div class="well well-sm well-light bg-color-greenLight txt-color-white">
            <h4><i class="fa fa-file-text-o"></i> Cetak Laporan Kendali Parkir </h4>
</div>
</div>
</div>
...
<div class="jarviswidget jarviswidget-color-teal" id="wid-id-validasi_penyetoran" 
      ...
      <header role="heading">
        <span class="widget-icon"><i class="fa fa-list-ul"></i></span>
          <h2>Daftar Kartu Data Pajak Parkir </h2>
                  ...
                  <section class="col col-3">
                      <label class="select">
                              <select class="input-md" enabled="enabled">
                                ...
                                <option value="1" >PAJAK PARKIR</option>
                              </select><i></i>
                      </label>
                  </section>
</div>
                  ...
                  <section class="col col-3">
                      <label class="select">
                              <select class="input-md" enabled="enabled">
                                ...
                                <option value="1" >TUNGGAKAN PAJAK PARKIR</option>
                                <option value="2" >SEKATEN (PARKIR)</option>
                              </select><i></i>
                      </label>
                  </section>
</div>
...
<script type="text/javascript">
    ...
    function cetak () {
    window.open(window.APP_URL+'/penetapan/rekap_kendali_parkir/cetak');
}
</script>
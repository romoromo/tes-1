						...
						<div class="widget-body no-padding">
							<div class="widget-body-toolbar">
								...
								<div class="group_button_proses pull-right" style="display: none;">
									...
									<button class="btn btn-sm btn-default" onclick="cetakSKPD()" type="button">
...
<script type="text/javascript">
	...
	function cari() {
		...
		if (THNPAJAK=='' || BLNPAJAK=='') {
			...
			$.ajax({
				url: 'penetapan/penetapanabt_berdasarnpwp/GetData',
				type: 'POST',
	...
	function tetapkan() {
		...
		if (count>0) {
			...
			if (ButtonPressed === "Ya") {
				$.ajax({
					url: 'penetapan/penetapanabt_berdasarnpwp/TetapkanPajakAir',
					type: 'POST',
					dataType: 'json',
					data: {
	...
	function getNoNota(tahun) {
		$.ajax({
			url: 'penetapan/penetapanabt_berdasarnpwp/GetNoNotaAkhir',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun: tahun
	...
	function cetakNota() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/penetapan/penetapanabt_berdasarnpwp/cetakskpd/?data=' + q);
	}

...
<body lang=EN-US style='tab-interval:36.0pt;text-justify-trim:punctuation'>
 ...
 0cm 5.4pt 0cm 5.4pt;mso-border-insideh:none;mso-border-insidev:none'>
  ...
  normal'><span lang=IN style='font-family:"Courier New"'>BADAN PENGELOLAAN
      ...
      <td width=81 valign=top style='width:60.85pt;padding:0cm 5.4pt 0cm 5.4pt'>
        <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-family:"Courier New"'>
            <o:p>&nbsp;</o:p>
          </span></p>
      </td>
  ...
  normal'><span lang=IN style='font-family:"Courier New"'>20<?php echo sprintf('%02d', $data['tahunpajak']) ?><o:p></o:p></span></p>
        </td>
      <?php else : ?>
        <td width=228 colspan=3 valign=top style='width:171.25pt;padding:0cm 5.4pt 0cm 5.4pt'>
          <p class=MsoNormal align=left style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-family:"Courier New"'>20<?php echo sprintf('%02d', $data['tahunpajak']) ?> S/D 20<?php echo sprintf('%02d', $data['tahunpajak2']) ?><o:p></o:p></span></p>
        </td>
      <?php endif ?>
  ...
  <?php $no = 1;
  $idbefore = array('jenis' => '');
  foreach ($data['hasil'] as $rowPage) : ?>
    <?php if ($rowPage['TBLSETOR_JNSBAYAR'] != $idbefore['jenis']) : ?>
      <?php $totalskpd = 0; ?>
      <?php $totalsspd = 0; ?>
      <?php $idbefore['jenis'] = $rowPage['TBLSETOR_JNSBAYAR']; ?>
      <div class=Section<?= $no++ ?>>


        <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt'><span lang=IN style='font-family:"Courier New"'>
            <o:p>&nbsp;</o:p>
          </span></p>

        <table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0 width=792 style='width:593.7pt;border-collapse:collapse;border:none;mso-yfti-tbllook:
 1184;mso-padding-alt:0cm 5.4pt 0cm 5.4pt;mso-border-insideh:none;mso-border-insidev:
 none'>
          <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:28.6pt'>
            <td width=90 valign=top style='width:100.75pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:28.6pt'>
              <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
  font-family:"Courier New"'>MASA PAJAK<o:p></o:p></span></p>
            </td>
  ...
  height:28.6pt'>
              <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span lang=IN style='font-size:10.0pt;
  mso-bidi-font-size:11.0pt;font-family:"Courier New"'>RUPIAH SSPD<o:p></o:p></span></p>
            </td>
  ...
  mso-bidi-font-size:11.0pt;font-family:"Courier New"'>KET<o:p></o:p></span></p>
          ...
          <tr style='mso-yfti-irow:1;height:14.2pt'>
            <?php if ($rowPage['TBLSETOR_JNSBAYAR'] == 'SKPDKB' || $rowPage['TBLSETOR_JNSBAYAR'] == 'SKPDKB di angsur') : ?>
              ...
              <?php else : ?>
              <td width=792 colspan=11 valign=top style='width:593.7pt;padding:0cm 5.4pt 0cm 5.4pt;height:14.2pt'>
              <?php endif ?>
              <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
  font-family:"Courier New"'>
          ...
          <?php foreach ($data['hasil'] as $row) : ?>
            <?php if ($idbefore['jenis'] == $row['TBLSETOR_JNSBAYAR']) : ?>
              <tr style='mso-yfti-irow:2;height:11.35pt'>
                <td width=90 valign=top style='width:70.75pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:11.35pt'>
                  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
  font-family:"Courier New"'><?= LokalIndonesia::getBulan($row['BLP']) ?> 20<?= sprintf('%02d', $row['TBLPENDATAAN_THNPAJAK']) ?><o:p></o:p></span></p>
                </td>
  ...
  font-family:"Courier New"'>
                      ...
                      <?php if ($row[$data['namatbl'] . '_TGLSPTPD'] > '0') : ?>
  ...
  mso-bidi-font-size:11.0pt;font-family:"Courier New"'>
                      <?php if ($row['TBLPENDATAAN_TGLPAJAK'] > '1') : ?>
                        PAJAK COMPLEMENT
                      <?php endif ?>
                    </span></p>
                </td>
  ...
  <td width=130 valign=top style='width:3.0cm;padding:0cm 5.4pt 0cm 5.4pt;
  height:14.2pt'>
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
 ...
 <tr style='mso-yfti-irow:5;height:14.2pt'>
  ...
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
  font-family:"Courier New"'>JML SSPD<o:p></o:p></span></p>
  </td>
  <td width=19 valign=top style='width:14.15pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:14.2pt'>
  <p class=MsoNormal align=right style='margin-bottom:0cm;margin-bottom:.0001pt;
 ...
 <tr height=0>
  ...
  <td width=69 style='border:none'></td>
        ...
        <p class=MsoNormal><span lang=IN style='font-family:"Courier New"'>
            <o:p>&nbsp;</o:p>
          </span></p>

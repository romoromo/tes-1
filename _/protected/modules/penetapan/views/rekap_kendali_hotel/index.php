...
<div class="well well-sm well-light bg-color-greenLight txt-color-white">
            <h4><i class="fa fa-file-text-o"></i> Cetak Laporan Kendali Hotel </h4>
</div>
</div>
</div>
...
<div class="jarviswidget jarviswidget-color-teal" id="wid-id-validasi_penyetoran" 
      ...
      <header role="heading">
        <span class="widget-icon"><i class="fa fa-list-ul"></i></span>
          <h2>Daftar Kartu Data Pajak Hotel </h2>
...
<script type="text/javascript">
    ...
    function cetak () {
    window.open(window.APP_URL+'/penetapan/rekap_kendali_hotel/cetak');
}
</script>
...
<script type="text/javascript">
	...
	function cari() {
		...
		$.ajax({
			url: 'penetapan/cek_data_perwptahunv2/cetak',
			type: 'POST',
			data: {
	...
	function tampil() {
		...
		$.ajax({
			url: 'penetapan/cek_data_perwptahunv2/cari',
			type: 'POST',
			data: {
				rekening: $("#TREKENINGSUB_KODE").val()
				, TBLPENDATAAN_THNPAJAK: $("#masapajak_tahun").val()
	...
	function cetak(jenis) {
		...
		window.open(URL_APLIKASI+"/penetapan/cek_data_perwptahunv2/cetak?jenis="+jenis+"&TBLPENDATAAN_THNPAJAK="+window.TBLPENDATAAN_THNPAJAK+"&TBLDAFTAR_NOPOK="+window.TBLDAFTAR_NOPOK+"&rekening="+window.rekening);

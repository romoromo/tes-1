								...
								<section class="col col-md-3">
									<label class="select">
										<select id="JENIS_PAJAK" name="JENIS_PAJAK" class="select2">
											...
											?>
											<!-- <option value="<?php // echo $list['REFKECAMATAN_KODE'] 
																?>"><?php // echo $list['REFKECAMATAN_NAMA'] 
																	?></option> -->
											<?php // endforeach 
											?>
										</select>
								...
								<section class="col col-md-2">
									<label class="select">
										<select id="TBLDAFTREKLAME_JNSREKLAME" name="param[TBLDAFTREKLAME_JNSREKLAME]" class="select2">
											...
											<?php $data['listjns'] = array('T', 'I');
											foreach ($data['listjns'] as $jns) : ?>
							...
							<div class="row">
								...
								<section class="col col-md-3">
									<label class="input"> <i class="icon-append fa fa-calendar"></i>
										<input type="text" value="" name="TGLENTRI" class="datepicker" data-dateformat="dd-mm-yy" id="TGLENTRI">
									</label>
								</section>
							</div>
							<div class="row">
								...
								<section class="col col-md-3">
									<label class="input"> <i class="icon-append fa fa-calendar"></i>
										<input type="text" value="" name="TGLSKPD" class="datepicker" data-dateformat="dd-mm-yy" id="TGLSKPD">
									</label>
								</section>
							</div>
	...
	<div class="well well-sm well-light">
		<div class="row">
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-fsdfgs12441278d" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
					<header>
						...
						<section>
							<div class="row">
								...
								<div class="col col-10">
									...
									<!-- ,Kel. --> <label id="TBLKELURAHAN_NAMA"></label>,
									<!-- Kec. --> <label id="TBLKECAMATAN_NAMA"></label>
								</div>
							</div>
						</section>
...
<script type="text/javascript">
	...
	function cari() {
		...
		if (TGLENTRI == '' && TGLSKPD == '') {
			notifikasi('Informasi', 'Mohon isikan salah satu isian tanggal', 'failed', 1, 0);
		} else {
			...
			$("html, body").animate({
				scrollTop: $("#widget-grid-tetapan").offset().top - 100
			}, "slow");
	...
	function getNoKukuh(tgl) {
		$.post('pelayanan/verifikasi/generateNOKUKUH', {
			tgl: tgl,
			obyid: window.idKukuh
		}, function(respon) {

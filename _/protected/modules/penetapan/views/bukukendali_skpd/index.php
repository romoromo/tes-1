                ...
                <footer id="footer_cetakdata">
                  <section class="col col-md-5">
                    <button type="button" class="btn btn-sm btn-primary" onclick="cetak()" >
                      <i class="fa fa-save"></i> Cetak Daftar Kendali
                    </button> 
...
<script type="text/javascript">
  ...
  function cetak () {
        ...
        window.open(window.APP_URL+'/penetapan/Bukukendali_skpd/cetak?masapajak='+window.masapajak+'&TBLREKENING_KODE='+window.TBLREKENING_KODE+'&cara_penetapan='+window.cara_penetapan+'&TBLKECAMATAN_ID='+window.TBLKECAMATAN_ID+'&JALAN='+window.JALAN+'&bulan='+window.bulan+'&cutoff='+window.cutoff);
      }
  }    
      ...
      window.open('<?= Yii::app()->getBaseUrl(1); ?>/penetapan/Bukukendali_skpd/cetakword?'+ param);

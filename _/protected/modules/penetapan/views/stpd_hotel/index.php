	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="well well-sm well-light bg-color-greenLight txt-color-white">
				<h4><i class="fa fa-file-text-o"></i> STPD - Pajak Hotel </h4>
			</div>
		</div>
	</div>
				...
				<div class="jarviswidget jarviswidget-color-teal" id="wid-id-kiosss" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
					...
					<div>
						...
						<div class="widget-body no-padding">
							<form id="form-stpd-hotel" class="smart-form">
								<fieldset>
									...
									<hr><br>
									<div class="row">
										<section class="col col-md-12"><h4 align="center">Entry STPD Pajak Hotel</h4></section>
									</div>
									...
									<div class="row">
										...
										<section class="col col-md-2">
											<label class="input"> <i class="icon-append fa fa-calendar"></i>
												<input style="background: #e4e4e4;" type="text" value="<?= date('d-m-Y') ?>" name="TBLDAFTHOTEL_TGLPERIKSA" id="TBLDAFTHOTEL_TGLPERIKSA" readonly="">
											</label>
										</section>
										<section class="col col-md-2" style="margin-left: 2%;">Nomor Pemeriksaan</section>
										<section class="col col-md-2">
											<label class="input">
												<input style="background: #e4e4e4;" class="form-control" type="text" id="TBLDAFTHOTEL_NOMORPERIKSA" name="TBLDAFTHOTEL_NOMORPERIKSA" readonly="">
											</label>
										</section>
									</div>
									<div class="row">
										...
										<section class="col col-md-4">
											<label class="input">
												<input style="background: #e4e4e4;" class="form-control format-rupiah" type="text" id="TBLDAFTHOTEL_PAJAKPERIKSA" name="TBLDAFTHOTEL_PAJAKPERIKSA" readonly="">
											</label>
										</section>
									</div>
									<div class="row">
									...
									<div class="row">
										...
										<section class="col col-md-2">
											<label class="input">
												<input class="form-control" type="text" id="TBLDAFTHOTEL_NOSURATTAGIHAN" name="TBLDAFTHOTEL_NOSURATTAGIHAN">
											</label>
										</section>
										<section class="col col-md-2">Tanggal STPD</section>
										<section class="col col-md-2">
											<label class="input"> <i class="icon-append fa fa-calendar"></i>
												<input type="text" value="<?= date('d-m-Y') ?>" name="TBLDAFTHOTEL_TGLSURATTAGIHAN" class="datepicker" data-dateformat="dd-mm-yy" id="TBLDAFTHOTEL_TGLSURATTAGIHAN">
											</label>
										</section>
									</div>
									<div class="row">
										...
										<section class="col col-md-4">
											<label class="input">
												<input class="form-control format-rupiah" type="text" id="TBLDAFTHOTEL_BUNGATAGIHAN" name="TBLDAFTHOTEL_BUNGATAGIHAN">
											</label>
										</section>
									...
									<div class="row">
										...
										<section class="col col-md-4">
											<label class="input">
												<input class="form-control format-rupiah" type="text" id="TBLDAFTHOTEL_RUPIAHTAGIHAN" name="TBLDAFTHOTEL_RUPIAHTAGIHAN">
											</label>
										</section>
									</div>
									<div class="row">
										...
										<section class="col col-md-2">
											<label class="input"> <i class="icon-append fa fa-calendar"></i>
												<input type="text" name="TBLDAFTHOTEL_TGLBTSTAGIHAN" class="datepicker" data-dateformat="dd-mm-yy" id="TBLDAFTHOTEL_TGLBTSTAGIHAN">
											</label>
										</section>
									</div>
								</fieldset>
...
<br>
	...
	<script type="text/javascript">
		...
		function setMoment() {
			moment.locale('id');
			$("#TBLDAFTHOTEL_TGLSURATTAGIHAN").trigger('change');
		}
		...
		jQuery(document).ready(function($) {
			...
			$('#TBLDAFTHOTEL_TGLSURATTAGIHAN').val(today);
		...
		function getNoSKPDKB(tahun) {
			$.ajax({
				url: 'penetapan/stpd_hotel/GetNoSKPDKB',
				type: 'POST',
				dataType: 'json',
				data: {
					tahun: tahun
				...
				success: function(respon) {
					if (respon=='') {
						$('#TBLDAFTHOTEL_NOSURATTAGIHAN').val(1);
						
					}
					else{
						$('#TBLDAFTHOTEL_NOSURATTAGIHAN').val(respon.NOKB);
						if ($('#TBLDAFTHOTEL_TGLBTSTAGIHAN').val()=='') {
							$("#TBLDAFTHOTEL_TGLSURATTAGIHAN").trigger('change');
						}
					}
				}
		...
		$("#TBLDAFTHOTEL_TGLSURATTAGIHAN").change(function(event) {
			var tglbatas = moment( $("#TBLDAFTHOTEL_TGLSURATTAGIHAN").val().split("-").reverse().join("-") ).add(1, "days");
			$("#TBLDAFTHOTEL_TGLBTSTAGIHAN").val( tglbatas.format('L') );
		});

		function generateAutocompleteWPHotel() {
			$('#TBLDAFTAR_NOPOK').autocomplete({
				serviceUrl: 'penetapan/stpd_hotel/autocompletewphotel',
		...
		function reset_form(){
			$("#form-stpd-hotel")[0].reset();
			$("#form-stpd-hotel .select2").select2('val', '');
			setMoment();
		...
		function runFormValidation() {
			var $FormData = $("#form-stpd-hotel").validate({
		...
		function cetak () {
			...
			window.open('<?php echo Yii::app()->getBaseUrl(1); ?>/penetapan/stpd_hotel/cetak?'+param);
		}
		...
		function cetakWord () {
			...
			window.open('<?php echo Yii::app()->getBaseUrl(1); ?>/penetapan/stpd_hotel/cetakword?'+param);
		}
		...
		function HitungSKPDKB() {
			...
			$(".TBLDAFTHOTEL_BUNGATAGIHAN").html(toRp(RUPIAHKB));
			$("#TBLDAFTHOTEL_BUNGATAGIHAN").val(RUPIAHKB.toFixed(0));

			console.log('RUPIAHKB='+RUPIAHKB);
			// $("#TBLDAFTHOTEL_RUPIAHTAGIHAN").val( RUPIAHKB.toFixed(2) );
		}

		function Hitungtotal(){
			PAJAK = toAngka($('#res_jumlah_pajak_tetap_wp').val());
			
			$(".TBLDAFTHOTEL_RUPIAHTAGIHAN").html(toRp(PAJAK));
			$("#TBLDAFTHOTEL_RUPIAHTAGIHAN").val(PAJAK);
		...
		function cari () {
			...
			if (CARI_NOPOK=='') {
				...
				$.ajax({
					url: 'penetapan/stpd_hotel/getdata',
					type: 'POST',
					dataType: 'json',
					data: {
					...
					success: function(respon) {
						if (respon.data=='sudah entri') {
							...
							$.SmartMessageBox({
								...
								buttons : '[Tidak][Ya]' // pengaturan tombol
									...
									if (ButtonPressed === "Ya") {
										...
										$('#res_tanggal_pajak_tetap_wp').val(respon.TBLDAFTHOTEL_TGLSKPD +'-'+ respon.TBLDAFTHOTEL_BLNSKPD +'-20'+ respon.TBLDAFTHOTEL_THNSKPD);
										$('#res_nomor_pajak_tetap_wp').val('');
										$('#res_jumlah_pajak_tetap_wp').val(respon.TBLDAFTHOTEL_PAJAK);
										$('#res_tanggal_pajak_setor_wp').val(respon.TBLDAFTHOTEL_TGLENTRISETOR +'-'+ respon.TBLDAFTHOTEL_BLNENTRISETOR +'-20'+ respon.TBLDAFTHOTEL_THNENTRISETOR);
										$('#res_nomor_pajak_setor_wp').val(respon.TBLDAFTHOTEL_REGSETOR);
										$('#res_jumlah_pajak_setor_wp').val(respon.TBLDAFTHOTEL_RUPIAHSETOR);
										$('#TBLDAFTHOTEL_PAJAKPERIKSA').val(respon.TBLDAFTHOTEL_PAJAKPERIKSA);
										$('#TBLDAFTHOTEL_BUNGATAGIHAN').val(respon.TBLDAFTHOTEL_BUNGATAGIHAN);
										...
										$('#TBLDAFTHOTEL_RUPIAHTAGIHAN').val(respon.TBLDAFTHOTEL_RUPIAHTAGIHAN);
										$('#TBLDAFTHOTEL_BLNKBAKHIR').val(respon.TBLDAFTHOTEL_BLNKBAKHIR);
										$('#TBLDAFTHOTEL_NOMORPERIKSA').val(respon.TBLDAFTHOTEL_NOMORPERIKSA);
										$('#TBLDAFTHOTEL_TGLPERIKSA').val(respon.TBLDAFTHOTEL_TGLPERIKSA +'-'+ respon.TBLDAFTHOTEL_BLNPERIKSA +'-20'+ respon.TBLDAFTHOTEL_THNPERIKSA);
										$('#TBLDAFTHOTEL_NOSURATTAGIHAN').val(respon.TBLDAFTHOTEL_NOSURATTAGIHAN);
										$('#TBLDAFTHOTEL_TGLSURATTAGIHAN').val(respon.TBLDAFTHOTEL_TGLSURATTAGIHAN +'-'+ respon.TBLDAFTHOTEL_BLNSURATTAGIHAN +'-20'+respon.TBLDAFTHOTEL_THNSURATTAGIHAN);
										$('#TBLDAFTHOTEL_TGLBTSTAGIHAN').val(respon.TBLDAFTHOTEL_TGLBTSTAGIHAN +'-'+ respon.TBLDAFTHOTEL_BLNBTSTAGIHAN +'-20'+ respon.TBLDAFTHOTEL_THNBTSTAGIHAN);
							...
							$('#res_nomor_pajak_setor_wp').val(respon.TBLDAFTHOTEL_REGSETOR);
							$('#res_jumlah_pajak_setor_wp').val(respon.TBLDAFTHOTEL_RUPIAHSETOR);
							$('#TBLDAFTHOTEL_BUNGATAGIHAN').val('');
							$('#TBLDAFTHOTEL_RUPIAHTAGIHAN').val('');
							$('#TBLDAFTHOTEL_PAJAKPERIKSA').val(respon.TBLDAFTHOTEL_PAJAKPERIKSA);
							$('#TBLDAFTHOTEL_NOMORPERIKSA').val(respon.TBLDAFTHOTEL_NOMORPERIKSA);
							$('#TBLDAFTHOTEL_TGLPERIKSA').val(respon.TBLDAFTHOTEL_TGLPERIKSA +'-'+ respon.TBLDAFTHOTEL_BLNPERIKSA +'-20'+ respon.TBLDAFTHOTEL_THNPERIKSA);
							$('#footer-hotel').show('fast');
							$('#btncetak').show('fast');
							setPriceFormat();
							var tglbatas = moment( $("#TBLDAFTHOTEL_TGLSURATTAGIHAN").val().split("-").reverse().join("-") ).add(1, "months");
							$("#TBLDAFTHOTEL_TGLBTSTAGIHAN").val( tglbatas.format('L') );
							$('#btnsimpan').removeAttr('disabled');
		...
		function simpanskpdkb () {
			...
			$.ajax({
				url: 'penetapan/stpd_hotel/SimpanSKPDKBHotel',
				type: 'post',
				dataType: "json",
				data:  $("#form-stpd-hotel").serialize(),
		...
		function hapuskb() {
			...
			$.SmartMessageBox({
				...
				buttons : '[Tidak][Ya]' // pengaturan tombol
					...
					if (ButtonPressed === "Ya") {
						$.ajax({
							url: 'penetapan/stpd_hotel/HapusSKPDKB',
							type: 'post',
							dataType: "json",
							data:  $("#form-stpd-hotel").serialize(),
							success: function(data) {

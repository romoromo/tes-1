							...
							$.SmartMessageBox({
								...
								buttons : '[Tidak][Ya]' // pengaturan tombol
									...
									if (ButtonPressed === "Ya") {
										...
										$('#TBLDAFTHIBURAN_TGLSURATTAGIHAN').val(respon.TBLDAFTHIBURAN_TGLSURATTAGIHAN +'-'+ respon.TBLDAFTHIBURAN_BLNSURATTAGIHAN +'-20'+respon.TBLDAFTHIBURAN_THNSURATTAGIHAN);
										$('#TBLDAFTHIBURAN_TGLBTSTAGIHAN').val(respon.TBLDAFTHIBURAN_TGLBTSTAGIHAN +'-'+ respon.TBLDAFTHIBURAN_BLNBTSTAGIHAN +'-20'+ respon.TBLDAFTHIBURAN_THNBTSTAGIHAN);

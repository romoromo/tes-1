...
<table width="100%" class="table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="dt_basic" border="0">
  <thead>  
    <tr>
      ...
      <td align="center"><strong>SKPDKB<br>(SURAT KETETAPAN PAJAK DAERAH <br>KURANG BAYAR) <br> <h4> Tahun : 20<?php echo $data['cetak']['TBLDAFTHOTEL_THNKURANGBAYAR']; ?><br> <div> Bulan : November s/d Desember</div></strong></td>
...
<table width="100%" class="table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="dt_basic" border="0">
  <thead>
    <tr>
      ...
      <td align="left" width="5%">:</td>
      <td align="left">01.20.01.20.26.00.00.04.01.01.01.09 <?php echo $data['cetak']['NMREK']; ?></td>
    </tr>
  </thead>
</table>
<br>
<table width="100%" class="table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="dt_basic" border="0">
  <thead>
    <tr>
      ...
      <td align="left">:</td>
      <td align="left"> November s/d Desember</td>
    </tr>
  </thead>
</table>
...
<table width="100%" border="1" style="border-collapse:collapse;" cellpadding="0" cellspacing="0" class="table table-bordered table-striped table-condensed table-hover smart-form has-tickbox">
  ...
  <tbody>
    <tr>
      ...
      <td align="center"><?php // echo $data['cetak']['TBLDAFTHOTEL_RUPIAHSETOR']; ?></td>

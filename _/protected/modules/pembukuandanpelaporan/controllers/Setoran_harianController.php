...
class Setoran_harianController extends Controller
{
	...
	public function actionCetakatashtml()
	{
		...
		TBLDAFTAR.TBLDAFTAR_BADANUSAHANAMA AS BNAMA,
		TBLDAFTAR.TBLDAFTAR_BADANUSAHAALAMAT,
		TBLDAFTAR.TBLDAFTAR_GOLONGAN,
		REFBADANUSAHA_90.REFBADANUSAHA_REKKETERANGAN_90 AS BBU,
		...
		INNER JOIN REFBADANUSAHA_90 ON TBLDAFTAR.REFBADANUSAHA_IDBADANUSAHA = REFBADANUSAHA_90.REFBADANUSAHA_ID
		WHERE
		...
		TBLSETOR.TBLSETOR_TGLSETOR ASC,
		TBLSETOR.TBLDAFTAR_NOPOK,
	...
	$tglakhir = trim($_REQUEST['tglakhir'])!='' ? date('Y-m-d', strtotime($_REQUEST['tglakhir']) ) : "";
		...
		ORDER BY REFBADANUSAHA_90.REFBADANUSAHA_REKKETERANGAN_90,
		TBLSETOR.TBLSETOR_TGLSETOR ASC, TBLSETOR.TBLDAFTAR_NOPOK, TBLSETOR_BLNSETOR ASC";
		// echo $sqlbawah;
		$data['bawah'] = $bawah = Yii::app()->db->createCommand($sqlbawah)->queryAll();

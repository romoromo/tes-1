...
class TunggakanpajakController extends Controller
{
	...
	public function actionCetak()
	{
		...
		AND TBLSETOR.TBLSETOR_BLNSETOR = 8
		...
		*
		...
		$data['tunggakan'] = $skpda = Yii::app()->db->createCommand($sqlhotel)->queryAll();
		...
		*
		...
		INNER JOIN TBLANGSURAN ON TBLDAFTRMAKAN.TBLPENDATAAN_THNPAJAK = TBLANGSURAN.TBLPENDATAAN_THNPAJAK
		AND TBLDAFTRMAKAN.TBLPENDATAAN_BLNPAJAK = TBLANGSURAN.TBLPENDATAAN_BLNPAJAK
		AND TBLDAFTRMAKAN.TBLDAFTAR_NOPOK = TBLANGSURAN.TBLDAFTAR_NOMORPOKOK
		WHERE
		TBLDAFTAR.TBLDAFTAR_BADANUSAHANAMA IS NOT NULL
		AND TBLDAFTRMAKAN.TBLDAFTRMAKAN_REKPENDAPATAN = 4
		AND TBLDAFTRMAKAN.TBLDAFTRMAKAN_REKPAD = 1
		AND TBLDAFTRMAKAN.TBLDAFTRMAKAN_REKPAJAK = 1
		AND TBLDAFTRMAKAN.TBLDAFTRMAKAN_REKAYAT = '$TBLREKENING_KODE'
		AND TBLANGSURAN.TBLANGSURAN_THNBATASKETETAPAN = '$tahun'
		GROUP BY
		TBLDAFTRMAKAN.TBLPENDATAAN_THNPAJAK,
		TBLDAFTAR.TBLDAFTAR_NOPOK,
		...
		$data['tunggakan'] = $skpda = Yii::app()->db->createCommand($sqlrestoran)->queryAll();
		...
		*
		...
		INNER JOIN TBLANGSURAN ON TBLDAFTHIBURAN.TBLPENDATAAN_THNPAJAK = TBLANGSURAN.TBLPENDATAAN_THNPAJAK
		AND TBLDAFTHIBURAN.TBLPENDATAAN_BLNPAJAK = TBLANGSURAN.TBLPENDATAAN_BLNPAJAK
		AND TBLDAFTHIBURAN.TBLDAFTAR_NOPOK = TBLANGSURAN.TBLDAFTAR_NOMORPOKOK
		WHERE
		TBLDAFTAR.TBLDAFTAR_BADANUSAHANAMA IS NOT NULL
		AND TBLDAFTHIBURAN.TBLDAFTHIBURAN_REKPENDAPATAN = 4
		AND TBLDAFTHIBURAN.TBLDAFTHIBURAN_REKPAD = 1
		AND TBLDAFTHIBURAN.TBLDAFTHIBURAN_REKPAJAK = 1
		AND TBLDAFTHIBURAN.TBLDAFTHIBURAN_REKAYAT = '$TBLREKENING_KODE'
		AND TBLANGSURAN.TBLANGSURAN_THNBATASKETETAPAN = '$tahun'
		GROUP BY
		TBLDAFTHIBURAN.TBLPENDATAAN_THNPAJAK,
		TBLDAFTAR.TBLDAFTAR_NOPOK,
		...
		$data['tunggakan'] = $skpda = Yii::app()->db->createCommand($sqlhiburan)->queryAll();
		...
		*
		...
		FROM
		TBLDAFTAR
		INNER JOIN TBLDAFTREKLAME ON TBLDAFTREKLAME.TBLDAFTAR_NOPOK = TBLDAFTAR.TBLDAFTAR_NOPOK
		INNER JOIN TBLANGSURAN ON TBLDAFTREKLAME.TBLPENDATAAN_THNPAJAK = TBLANGSURAN.TBLPENDATAAN_THNPAJAK
		AND TBLDAFTREKLAME.TBLPENDATAAN_BLNPAJAK = TBLANGSURAN.TBLPENDATAAN_BLNPAJAK
		AND TBLDAFTREKLAME.TBLDAFTAR_NOPOK = TBLANGSURAN.TBLDAFTAR_NOMORPOKOK
		WHERE
		TBLDAFTAR.TBLDAFTAR_BADANUSAHANAMA IS NOT NULL
		AND TBLDAFTREKLAME.TBLDAFTREKLAME_REKPENDAPATAN = 4
		AND TBLDAFTREKLAME.TBLDAFTREKLAME_REKPAD = 1
		AND TBLDAFTREKLAME.TBLDAFTREKLAME_REKPAJAK = 1
		AND TBLDAFTREKLAME.TBLDAFTREKLAME_REKAYAT = '$TBLREKENING_KODE'
		AND TBLANGSURAN.TBLANGSURAN_THNBATASKETETAPAN = '$tahun'
		GROUP BY
		TBLDAFTREKLAME.TBLPENDATAAN_THNPAJAK,
		TBLDAFTAR.TBLDAFTAR_NOPOK,
		...
		$data['tunggakan'] = $skpda = Yii::app()->db->createCommand($sqlreklame)->queryAll();
		...
		*
		...
		INNER JOIN TBLANGSURAN ON TBLDAFTPARKIR.TBLPENDATAAN_THNPAJAK = TBLANGSURAN.TBLPENDATAAN_THNPAJAK
		AND TBLDAFTPARKIR.TBLPENDATAAN_BLNPAJAK = TBLANGSURAN.TBLPENDATAAN_BLNPAJAK
		AND TBLDAFTPARKIR.TBLDAFTAR_NOPOK = TBLANGSURAN.TBLDAFTAR_NOMORPOKOK
		WHERE
		TBLDAFTAR.TBLDAFTAR_BADANUSAHANAMA IS NOT NULL
		AND TBLDAFTPARKIR.TBLDAFTPARKIR_REKPENDAPATAN = 4
		AND TBLDAFTPARKIR.TBLDAFTPARKIR_REKPAD = 1
		AND TBLDAFTPARKIR.TBLDAFTPARKIR_REKPAJAK = 1
		AND TBLDAFTPARKIR.TBLDAFTPARKIR_REKAYAT = '$TBLREKENING_KODE'
		AND TBLANGSURAN.TBLANGSURAN_THNBATASKETETAPAN = '$tahun'
		GROUP BY
		TBLDAFTPARKIR.TBLPENDATAAN_THNPAJAK,
		TBLDAFTAR.TBLDAFTAR_NOPOK,
		...
		$data['tunggakan'] = $skpda = Yii::app()->db->createCommand($sqlparkir)->queryAll();
		...
		*
		...
		INNER JOIN TBLANGSURAN ON TBLDAFTTANAH.TBLPENDATAAN_THNPAJAK = TBLANGSURAN.TBLPENDATAAN_THNPAJAK
		AND TBLDAFTTANAH.TBLPENDATAAN_BLNPAJAK = TBLANGSURAN.TBLPENDATAAN_BLNPAJAK
		AND TBLDAFTTANAH.TBLDAFTAR_NOPOK = TBLANGSURAN.TBLDAFTAR_NOMORPOKOK
		WHERE
		TBLDAFTAR.TBLDAFTAR_BADANUSAHANAMA IS NOT NULL
		AND TBLDAFTTANAH.TBLDAFTTANAH_REKPENDAPATAN = 4
		AND TBLDAFTTANAH.TBLDAFTTANAH_REKPAD = 1
		AND TBLDAFTTANAH.TBLDAFTTANAH_REKPAJAK = 1
		AND TBLDAFTTANAH.TBLDAFTTANAH_REKAYAT = '$TBLREKENING_KODE'
		AND TBLANGSURAN.TBLANGSURAN_THNBATASKETETAPAN = '$tahun'
		GROUP BY
		TBLDAFTTANAH.TBLPENDATAAN_THNPAJAK,
		TBLDAFTAR.TBLDAFTAR_NOPOK,
		...
		$data['tunggakan'] = $skpda = Yii::app()->db->createCommand($sqltanah)->queryAll();
		...
		*
		...
		INNER JOIN TBLANGSURAN ON TBLDAFTBURUNG.TBLPENDATAAN_THNPAJAK = TBLANGSURAN.TBLPENDATAAN_THNPAJAK
		AND TBLDAFTBURUNG.TBLPENDATAAN_BLNPAJAK = TBLANGSURAN.TBLPENDATAAN_BLNPAJAK
		AND TBLDAFTBURUNG.TBLDAFTAR_NOPOK = TBLANGSURAN.TBLDAFTAR_NOMORPOKOK
		WHERE
		TBLDAFTAR.TBLDAFTAR_BADANUSAHANAMA IS NOT NULL
		AND TBLDAFTBURUNG.TBLDAFTBURUNG_REKPENDAPATAN = 4
		AND TBLDAFTBURUNG.TBLDAFTBURUNG_REKPAD = 1
		AND TBLDAFTBURUNG.TBLDAFTBURUNG_REKPAJAK = 1
		AND TBLDAFTBURUNG.TBLDAFTBURUNG_REKAYAT = '$TBLREKENING_KODE'
		AND TBLANGSURAN.TBLANGSURAN_THNBATASKETETAPAN = '$tahun'
		GROUP BY
		TBLDAFTBURUNG.TBLPENDATAAN_THNPAJAK,
		TBLDAFTAR.TBLDAFTAR_NOPOK,
		...
		$data['tunggakan'] = $skpda = Yii::app()->createCommand($sqlburung)->queryAll();

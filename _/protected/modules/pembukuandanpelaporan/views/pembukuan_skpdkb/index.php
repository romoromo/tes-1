<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Daftar Pembukuan SKPDKB </h4>
		</div>
	</div>
</div>
...
function generateAutocompleteWP() {
    ...
    $('#TBLDAFTAR_NOPOK').autocomplete({
      serviceUrl: 'pembukuandanpelaporan/pembukuan_skpdkb/autocompletewp',
...
function cari () {
			...
			$.ajax({
				url: 'pembukuandanpelaporan/pembukuan_skpdkb/Cari',
				type: 'POST',
				data: {
    ...
    function CetakExcel(){
      ...
      window.open('<?= Yii::app()->getBaseUrl(1); ?>/pembukuandanpelaporan/pembukuan_skpdkb/Cetak?'+ param);
    }
    ...
    function CetakWord(){
      ...
      window.open('<?= Yii::app()->getBaseUrl(1); ?>/pembukuandanpelaporan/pembukuan_skpdkb/CetakWord?'+ param);
    }

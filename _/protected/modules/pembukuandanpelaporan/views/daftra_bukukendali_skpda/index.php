...
<script type="text/javascript">
    ...
    function cetak () {
        ...
        window.open(window.APP_URL+'/pembukuandanpelaporan/Daftra_bukukendali_skpda/cetak?tahun='+window.tahun+'&TBLREKENING_KODE='+window.TBLREKENING_KODE+'&tahun_penetapan='+window.tahun_penetapan);
        }   
    }

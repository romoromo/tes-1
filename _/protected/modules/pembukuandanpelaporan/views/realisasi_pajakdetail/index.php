...
<div class="row">
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-8">
		<h1 class="page-title txt-color-blueDark"><i class="fa fa-file-text fa-fw "></i> 
			Realisasi Penerimaan Pajak Detail
		</h1>
	</div>
</div>
...
<div class="row">
		...
		data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-sortable="false">
			...
			<div>
				...
				<div class="table-responsive" style="max-width: 100%; height: 400px!important; overflow: auto;">
					...
					<button class="btn btn-sm btn-success" onclick="cetak('word')">
	...
	<script type="text/javascript">
		...
		function cari () {
			...
			$.ajax({
				url: 'pembukuandanpelaporan/realisasi_pajakdetail/Cari',
				type: 'POST',
				data: {
		...
		function cetak (jenis) {
			...
			if ($('#masapajak_tahun').val()=='') {
				notifikasi('Informasi','Mohon isikan Tanggal Setor','failed',1,0);
			}else{
				window.open('<?php echo Yii::app()->getBaseUrl(1) ?>/pembukuandanpelaporan/realisasi_pajakdetail/cetaknew?tahun='+tahun+'&jenis='+jenis+'&bulan='+bulan);
			}
		}

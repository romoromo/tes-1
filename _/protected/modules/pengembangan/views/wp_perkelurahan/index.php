...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Daftar Wajib Pajak Daerah per Kelurahan dan Kecamatan</h4>
		</div>
	</div>
</div>
				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<div class="alert alert-info"> 
								...
								<?php /*	<div><b>Badan Usaha</b></div><hr><br>
									<div class="row">
										<section class="col col-md-2">
											<p>Nama</p>
										</section>
					...
					<div>
						...
						<p class="alert alert-info"> 
							<button type="button" class="btn btn-default" onclick="cetak_daftar('html')">
								<i class="fa fa-print"></i> Cetak Daftar WP Per Kel&Kec
							</button>
...
<script type="text/javascript">
	...
	function generateAutocompleteWP() {
		$('#TBLDAFTAR_NOPOK').autocomplete({
			serviceUrl: 'pengembangan/wp_perkelurahan/autocompletewp',
	...
	function cari() {
			...
			$.ajax({
				url: 'pengembangan/wp_perkelurahan/GetData',
				type: 'POST',
				data:  {
	...
	function cetak() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pengembangan/wp_perkelurahan/cetak?' + param);
	}
	...
	function cetak_daftarWord() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pengembangan/wp_perkelurahan/cetakWord?' + param);
	}

	function cetak_daftar(tipe) {
        window.open('<?php echo Yii::app()->baseUrl; ?>/pengembangan/wp_perkelurahan/Cetak_daftar?tipe='+tipe);
	}
	...
	function cetak_status() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pengembangan/wp_perkelurahan/cetak_status?' + param);
	}
	...
	function loadDataTable() {
		...
		$.ajax({
			url: 'pengembangan/wp_perkelurahan/cari',
			type: 'POST',
	...
	function setRekening(val) {
		$.ajax({
			url: 'pengembangan/wp_perkelurahan/setRekening',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function getKelurahan(val) {
		$.ajax({
			url: 'pengembangan/wp_perkelurahan/getKelurahan',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function getKelurahanedit(val) {
		$.ajax({
			url: 'pengembangan/wp_perkelurahan/getKelurahanedit',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function getKelurahanedit2(val) {
		$.ajax({
			url: 'pengembangan/wp_perkelurahan/getKelurahanedit2',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function simpan () {
		$.ajax({
			url: 'pengembangan/wp_perkelurahan/Simpan',
			type: 'post',
			dataType: "json",

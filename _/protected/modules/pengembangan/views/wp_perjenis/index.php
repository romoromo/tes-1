...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Daftar Wajib Pajak Daerah per Jenis / Golongan Pajak </h4>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	...
	function generateAutocompleteWP() {
		$('#TBLDAFTAR_NOPOK').autocomplete({
			serviceUrl: 'pengembangan/wp_perjenis/autocompletewp',
	...
	function cari() {
			...
			$.ajax({
				url: 'pengembangan/wp_perjenis/GetData',
				type: 'POST',
				data:  {
	...
	function cetak() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pengembangan/wp_perjenis/cetak?' + param);
	}
	...
	function cetak_daftarWord() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pengembangan/wp_perjenis/cetakWord?' + param);
	}

  function cetak_grid(tipe) {
        window.open('<?php echo Yii::app()->baseUrl; ?>/pengembangan/wp_perjenis/Cetak_daftar?tipe='+tipe);
  }
	...
	function cetak_status() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pengembangan/wp_perjenis/cetak_status?' + param);
	}
	...
	function loadDataTable() {
		...
		$.ajax({
			url: 'pengembangan/wp_perjenis/cari',
			type: 'POST',
	...
	function setRekening(val) {
		$.ajax({
			url: 'pengembangan/wp_perjenis/setRekening',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function getKelurahan(val) {
		$.ajax({
			url: 'pengembangan/wp_perjenis/getKelurahan',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function getKelurahanedit(val) {
		$.ajax({
			url: 'pengembangan/wp_perjenis/getKelurahanedit',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function getKelurahanedit2(val) {
		$.ajax({
			url: 'pengembangan/wp_perjenis/getKelurahanedit2',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function simpan () {
		$.ajax({
			url: 'pengembangan/wp_perjenis/Simpan',
			type: 'post',
			dataType: "json",

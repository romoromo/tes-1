...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Daftar Per Wajib Pajak Daerah</h4>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	...
	function generateAutocompleteWP() {
		$('#TBLDAFTAR_NOPOK').autocomplete({
			serviceUrl: 'pengembangan/daftar_induk/autocompletewp',
	...
	function cari() {
			...
			$.ajax({
				url: 'pengembangan/daftar_induk/GetData',
				type: 'POST',
				data:  {
	...
	function cetak() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pengembangan/daftar_induk/cetak?' + param);
	}
	...
	function cetak_daftarWord() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pengembangan/daftar_induk/cetakWord?' + param);
	}
	...
	function cetak_status() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/pengembangan/daftar_induk/cetak_status?' + param);
	}
	...
	function loadDataTable() {
		...
		$.ajax({
			url: 'pengembangan/daftar_induk/cari',
			type: 'POST',
	...
	function setRekening(val) {
		$.ajax({
			url: 'pengembangan/daftar_induk/setRekening',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function cetak_grid(tipe) {
        window.open('<?php echo Yii::app()->baseUrl; ?>/pengembangan/daftar_induk/Cetak_daftar?tipe='+tipe);
	}

	function getKelurahan(val) {
		$.ajax({
			url: 'pengembangan/daftar_induk/getKelurahan',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function getKelurahanedit(val) {
		$.ajax({
			url: 'pengembangan/daftar_induk/getKelurahanedit',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function getKelurahanedit2(val) {
		$.ajax({
			url: 'pengembangan/daftar_induk/getKelurahanedit2',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function simpan () {
		$.ajax({
			url: 'pengembangan/daftar_induk/Simpan',
			type: 'post',
			dataType: "json",

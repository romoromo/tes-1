...
class Penerimaan_perayat_90Controller extends Controller
{
	var $MODULE_URL = 'daftar_setoran/penerimaan_perayat_90';
	...
	public function actionCetakWord()
	{
		...
		$namatpl = $path_tpl . 'rekap_penerimaan_per_ayat_pajak-ttdpejabat.docx';
		...
		SUM (
			...
			$footer['kaban_pejabat_nama'] = $GLOBALS['kaban_pejabat_nama'] = $pjbt_kaban ? $pjbt_kaban['TBLPEJABAT_NAMA'] : '';
			...
			$footer['bendahara_pejabat_nama'] = $GLOBALS['bendahara_pejabat_nama'] = $pjbt_bendahara ? $pjbt_bendahara['TBLPEJABAT_NAMA'] : '';

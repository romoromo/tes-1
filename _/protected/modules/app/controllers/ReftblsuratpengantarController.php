...
class ReftblsuratpengantarController extends Controller
{
	...
	public function actionSimpan()
	{
		...
		$tabel_baru = 'tblsp_'.trim($_POST['tabel_baru']);

		$cek = Reftabelsp::model()->find('tblspizin_tabelsp=:tabel', array(':tabel'=>$tabel_baru));

		if (count($cek)==0) {
			$model = new Reftabelsp;
			$model->tblspizin_tabelvariabel_id = "";			
			$model->tblspizin_tabelsp = $tabel_baru;
	...
	public function actionHapusTabel()
	{
		...
		$cari = Reftabelsp::model()->find('tblspizin_tabelsp=:tabel', array(':tabel'=>$tabel));

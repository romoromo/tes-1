...
class Cetak_rekapwpController extends Controller
{
	...
	public function actionCetak()
    {
        ...
        // $TBLDAFTAR_PEMILIKNAMA = $_REQUEST['TBLDAFTAR_PEMILIKNAMA'] ? $_REQUEST['TBLDAFTAR_PEMILIKNAMA'] : '';
        // $TBLDAFTAR_BADANUSAHANAMA = $_REQUEST['TBLDAFTAR_BADANUSAHANAMA'] ? $_REQUEST['TBLDAFTAR_BADANUSAHANAMA'] : '';
        // $TBLDAFTAR_GOLONGAN = $_REQUEST['TBLDAFTAR_GOLONGAN'] ? $_REQUEST['TBLDAFTAR_GOLONGAN'] : '';
        ...
        $select = "
			...
			TBLDAFTAR.TBLDAFTAR_NOPOK,
				...
				NVL(TBLKELURAHAN_IDBADANUSAHA, 0) AS TBLKELURAHAN_IDBADANUSAHA,
				NVL(TBLKECAMATAN_IDBADANUSAHA, 0) AS TBLKECAMATAN_IDBADANUSAHA,
	...
	public function actionGetData()
    {
        ...
        $TBLDAFTAR_JENISPENDAPATAN = !empty(DMOrcl::getRequest('param', 'TBLDAFTAR_JENISPENDAPATAN')) ? (int)DMOrcl::getRequest('param', 'TBLDAFTAR_JENISPENDAPATAN') : '';
        $TBLKECAMATAN_IDPEMILIK = !empty(DMOrcl::getRequest('param', 'TBLKECAMATAN_IDPEMILIK')) ? (int)DMOrcl::getRequest('param', 'TBLKECAMATAN_IDPEMILIK') : '';

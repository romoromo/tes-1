...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Entry Pendataan Pajak Reklame Kendaraan, Selebaran 2016</h4>
		</div>
	</div>
</div>
						...
						<form id="form-pendataan-reklame2016_tetap" class="smart-form">
							<fieldset>
								...
								<div class="row">
									...
									<section class="col col-md-2">
										<label class="input">
											<input value="<?php echo date('d') ?>" type="number" id="TBLPENDATAAN_TGLPAJAK" name="param[TBLPENDATAAN_TGLPAJAK]" placeholder="Tanggal" maxlength="2">
										</label>
									</section>
								...
								<div class="row">
									...
									<section class="col col-md-2">
										<label class="input">
											<input value=""  type="text" id="TBLPENDATAAN_PAJAKKE" name="param[TBLPENDATAAN_PAJAKKE]" placeholder="Lokasi" maxlength="10">
										</label>
									</section>
									...
									<section class="col col-md-2">
										<label class="select">
											<select class="select2" id="KODE" name="param[KODE]">
												<option value="">-- Pilih Kode --</option>
													<?php foreach ($data['rek'] as $list): ?>
													<option value="<?php echo $list['TREKENING_KODE'] ?>" namarek="<?php echo substr($list['TREKENING_NAMA'],0,1) ?>"><?php echo substr($list['TREKENING_NAMA'],0,1) ?></option>
												<?php endforeach ?>
											</select>
										</label>
									</section>
								...
								<div class="row">
									<section class="col col-md-2">
										<p>Jenis Reklame menurut SIM Perizinan</p>
									</section>
									<section class="col col-md-5">
									...
									<div id="myTabReklameContent" class="tab-content padding-10">
										<div class="tab-pane fade in active" id="tabrek1">
											...
											<div class="row">
												...
												<section class="col col-md-2">
													<p>Sudut pandang menurut SIM Perizinan</p>
												</section>
												<section class="col col-md-3">
													<p id="muka_sisi"></p>
												</section>
												...
												<div style="display: none;">												
													...
													<section class="col col-md-3">
														<label class="select">
															...
															<?php foreach ($data['rek'] as $list): ?>
																<option value="<?php echo substr($list['TREKENING_NAMA'],0,1) ?>" namarek="<?php echo substr($list['TREKENING_NAMA'],0,1) ?>"><?php echo substr($list['TREKENING_NAMA'],0,1) ?></option>
															<?php endforeach ?>
															</select><i></i>
														</label>
													</section>
											...
											<div class="row">
												...
												<section class="col col-md-3">
													<label class="input">
														<input class="input-sm text-align-right" type="number" id="TBLDAFTREKLAME_NILAISTRATEGIS" name="param[TBLDAFTREKLAME_NILAISTRATEGIS]">
													</label>
												</section>
												<section class="col col-md-2">
													<p>&nbsp;</p>
										...
										<div class="tab-pane fade in" id="tabrek2">
											...
											<div class="row">
												...
												<section class="col col-md-2 font-md text-align-right">
													<label>
														<input type="text" id="TBLDAFTREKLAME_NILAISTRATEGIS2" name="param[TBLDAFTREKLAME_NILAISTRATEGIS2]">
													</label>
												</section>
											</div>
											...
											<div class="row">
												...
												<section class="col col-md-2 font-md text-align-right">
													<label>
														<input type="text" id="TBLDAFTREKLAME_RPTARIF" name="TBLDAFTREKLAME_RPTARIF" class="format-rupiah">
													</label>
												</section>
											</div>
											...
											<div class="row">
												...
												<section class="col col-md-6 font-md">
													<label class="col col-sm-1">=</label>
													<label class="col col-md-4 text-align-right TBLDAFTREKLAME_NSL"></label>
													...
													<label class="col col-sm-1">Hari</label>
												</section>
											</div>
											...
											<div class="row">
												...
												<section class="col col-md-5 font-md">
													...
													<input type="hidden" name="param[TBLDAFTREKLAME_LUAS]" id="TBLDAFTREKLAME_LUAS" value="">
													<label class="col col-sm-1">X</label>
	...
	$(document).ready(function() {
		...
		function generateAutocompleteWP() {
			$('#TBLDAFTAR_NOPOK').autocomplete({
				serviceUrl: 'pendataan/reklame2016_dll_integrasi/autocompletewp',
		...
		function cekPernahDaftar() {
			...
			if (TBLDAFTAR_NOPOK=='') {
			...
			} else if (TBLPENDATAAN_THNPAJAK=='' || TBLPENDATAAN_BLNPAJAK=='') {
				...
				$.ajax({
					url: 'pendataan/reklame2016_dll_integrasi/CekPernahDaftar',
					type: 'POST',
					dataType: 'json',
					data: {
						 NOPOKOK: TBLDAFTAR_NOPOK
						,TAHUN: TBLPENDATAAN_THNPAJAK
						,BULAN: TBLPENDATAAN_BLNPAJAK
					...
					success : function (respon) {
						if (respon.status=='sudah') {
							$.SmartMessageBox({
								...
								content : "Data dengan Nomor Pokok "+TBLDAFTAR_NOPOK+", Masa Pajak 20"+TBLPENDATAAN_TGLPAJAK+" dengan pendataan ke "+TBLPENDATAAN_PAJAKKE+" sudah pernah didata. <br> Apakah anda ingin mengubah data ini?", // konten dari smart alert
		...
		function cekNospt() {
			...
			var TBLPENDATAAN_TGLPAJAK = $('#TBLPENDATAAN_TGLPAJAK').val();
				$.ajax({
					url: 'pendataan/reklame2016_dll_integrasi/cekNospt',
					type: 'POST',
					dataType: 'json',
					data: {
						NOPOKOK: TBLDAFTAR_NOPOK
		...
		function cari() {
			...
			var TBLPENDATAAN_BLNPAJAK = $('#TBLPENDATAAN_BLNPAJAK').val();
			var TBLPENDATAAN_TGLPAJAK = $('#TBLPENDATAAN_TGLPAJAK').val();
			var KODE = $("#KODE option:selected").attr('namarek');

			$('#TREKENINGSUB_KODE').select2('val', $('#KODE').select2('val'));

			$('#TBLDAFTREKLAME_JNSREKLAME').select2('val', $("#KODE option:selected").attr('namarek'));
			...
			if (KODE=='M') {
				$('#TBLDAFTREKLAME_NILAISTRATEGIS').val('3.4');
			} else if (KODE=='S') {
				$('#TBLDAFTREKLAME_NILAISTRATEGIS').val('3.4');
			} else if (KODE=='B') {
				$('#TBLDAFTREKLAME_NILAISTRATEGIS').val('2.5');
			} else if (KODE=='U') {
				$('#TBLDAFTREKLAME_NILAISTRATEGIS').val('4.5');
			} else if (KODE=='R') {
				$('#TBLDAFTREKLAME_NILAISTRATEGIS').val('');
			} else if (KODE=='P') {
				$('#TBLDAFTREKLAME_NILAISTRATEGIS').val('');
			} else {
				$('#TBLDAFTREKLAME_NILAISTRATEGIS').val('');
			...
			if (KODE==undefined) {
				notifikasi('Informasi','Jenis reklame tidak boleh kosong !!!','failed',1,0);
				return false;
			}
				...
				$.ajax({
					url: 'pendataan/reklame2016_dll_integrasi/getdata',
					type: 'POST',
					dataType: 'json',
					data: {
...
function HitungPajak() {
	...
	KODE = $('#KODE option:selected').attr('namarek');
	if (KODE=='M') {
		ns = 3.4;
	} else if (KODE=='S') {
		ns = 3.4;
	...
	$('#TBLDAFTREKLAME_NILAISTRATEGIS2').val($('#TBLDAFTREKLAME_NILAISTRATEGIS').val());
	...
	ISIREK = 'JML ' + jmlrek + ' BH, ' + rekpanjang + 'M X ' + reklebar + 'M';
	...
	$(".TBLDAFTREKLAME_JUMLAHHARI").text(JUMLAHHARI);

	NISEWA = Math.round((NSL * jmlrek * rekluas * JUMLAHHARI)/365);
	
	// NISEWA = NSL * jmlrek * JUMLAHHARI;
	$("#TBLDAFTREKLAME_NILAISEWA").val(NISEWA);
	$(".TBLDAFTREKLAME_NILAISEWA").text(toRp(NISEWA));

	buffpajak = Math.round((NISEWA * (PERSENTARIF/100)));
	console.log("NISEWA");
	$("#TBLDAFTREKLAME_PAJAKINDEX").val(buffpajak);
...
function cetakPengambilan() {
	window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/reklame2016_tetap/cetakPengambilan?');
}

function cetakJabong() {
	window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/reklame2016_tetap/cetakJabong?');
}

function cetakIzinReklame() {
	window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/reklame2016_tetap/cetakIzinReklame?');
}
...
function simpanPendataan() {
	...
	$.ajax({
		url: 'pendataan/reklame2016_dll_integrasi/simpanPendataan',
		type: 'POST',
		dataType: 'json',
...
$("#TBLDAFTREKLAME_NODAFTARIZIN").change(function(event) {
	...
	var n = str.search("REK-P");
	// if (n!=4) {
	if (!str.includes('REK-P')) {
...
function getDataReklame(CALLBACK_FUNCTION) {
	...
	$.ajax({
		url: 'pendataan/reklame2016_dll_integrasi/GetDataReklame',
		type: 'POST',
		dataType: 'json',
		data: {
			 nodaftar: nodaftar

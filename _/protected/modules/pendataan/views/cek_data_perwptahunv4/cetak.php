...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:3'>
  ...
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-family:"Courier New"'>TAHUN PAJAK<o:p></o:p></span></p>
  </td>
  <td width=19 valign=top style='width:14.2pt;padding:0cm 1.4pt 0cm 1.4pt'>
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-family:"Courier New"'>:<o:p></o:p></span></p>
  </td>
  <?php if ($data['tahunpajak2']-$data['tahunpajak']==0): ?>
  <td width=228 colspan=3 valign=top style='width:171.25pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=left style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-family:"Courier New"'>20<?= $data['tahunpajak'] ?><o:p></o:p></span></p>
  </td>
  <?php else: ?>
  <td width=228 colspan=3 valign=top style='width:171.25pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=left style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-family:"Courier New"'>20<?= $data['tahunpajak'] ?> S/D 20<?= $data['tahunpajak2'] ?><o:p></o:p></span></p>
  </td>
  <?php endif ?>
  ...
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-family:"Courier New"'><?php echo $data['wp']['TBLDAFTAR_GOLONGAN']?>.<?php echo sprintf('%07d',$data['wp']['TBLDAFTAR_NOPOK'])?>.<?php echo sprintf('%02d',$data['wp']['TBLKECAMATAN_IDBADANUSAHA'])?>.<?php echo sprintf('%02d',$data['wp']['TBLKELURAHAN_IDBADANUSAHA'])?></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:4'>
  ...
  <td width=247 colspan=4 valign=top style='width:184.9pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span style='font-family:"Courier New";mso-ansi-language:EN-US'><?php echo $data['wp']['TBLDAFTAR_BADANUSAHAALAMAT'] ?></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:5;mso-yfti-lastrow:yes'>
  ...
  <td width=247 colspan=4 valign=top style='width:184.9pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-family:"Courier New"'><?php echo $data['wp']['TBLDAFTAR_PEMILIKALAMAT']?></span></p>
  </td>
<!-- <?php //endif ?> -->
 </tr>
...
<?php if($rowPage['TBLSETOR_JNS2']!=$idbefore['jenis']): ?>
 <?php $totalskpd=0; ?>
 <?php $totalsspd=0; ?>
 <?php $totalestimasibayar=0; ?>
 <?php $totalestimasidenda=0; ?>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0 width=792
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:28.6pt'>
  ...
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
  font-family:"Courier New"'>SKPD<o:p></o:p></span></p>
  </td>
  ...
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
  font-family:"Courier New"'>TGL JATUH<o:p></o:p></span></p>
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
  font-family:"Courier New"'>TEMPO<o:p></o:p></span></p>
  </td>

  <?php if ($rowPage['TBLSETOR_JNSBAYAR']=='SKPDKB' || $rowPage['TBLSETOR_JNSBAYAR']=='SKPDKB di angsur'): ?>
  <td width=138 valign=top style='width:103.3pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:28.6pt'>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  ...
  <?php if ($rowPage['TBLSETOR_TGLSETOR']!=0 || $rowPage['TBLSETOR_JNSBAYAR']=='SKPD-A'): ?>
  ...
  <td width=95 colspan=1 valign=top style='width:70.9pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:28.6pt'>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span lang=IN style='font-size:10.0pt;
  ...
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
  font-family:"Courier New"'>TOTAL<o:p></o:p></span></p>
  </td>
  <?php endif ?>
  ...
  <?php if ($rowPage['TBLSETOR_TGLSETOR']==0 && $rowPage['TBLSETOR_JNSBAYAR']!='SKPDKB di angsur'): ?>
  <td width=95 valign=top style='width:70.9pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:28.6pt'>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span lang=IN style='font-size:10.0pt;
  mso-bidi-font-size:11.0pt;font-family:"Courier New"'>ESTIMASI<o:p></o:p></span></p>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span lang=IN style='font-size:10.0pt;
  mso-bidi-font-size:11.0pt;font-family:"Courier New"'>DENDA<o:p></o:p></span></p>
  </td>
  ...
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span lang=IN style='font-size:10.0pt;
  mso-bidi-font-size:11.0pt;font-family:"Courier New"'>BAYAR<o:p></o:p></span></p>
  </td>
  <?php elseif ($rowPage['TBLSETOR_JNSBAYAR']=='SKPD-A'): ?>
   <td width=95 valign=top style='width:70.9pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:28.6pt'>
 ...
 <tr style='mso-yfti-irow:2;height:11.35pt'>
  ...
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
  font-family:"Courier New"'><?= $row['TIPE'] ?> KE <?= $row['BLP1'] ?><o:p></o:p></span></p>
  </td>
  <?php endif ?>
  ...
  <?php if($row['BLP2']!=0):?>
  <?= LokalIndonesia::getBulan($row['BLP1']) ?> S/D <?= LokalIndonesia::getBulan($row['BLP2']) ?> 20<?= sprintf('%02d', $row['TBLPENDATAAN_THNPAJAK']) ?>
  <?php else: ?>
  <?= LokalIndonesia::getBulan($row['BLP']) ?> 20<?= sprintf('%02d', $row['TBLPENDATAAN_THNPAJAK']) ?>
  <?php endif ?>
  ...
  <?php if($row['TBLSETOR_JNSBAYAR']=='SKPDKB' || $row['TBLSETOR_JNSBAYAR']=='SKPDKB di angsur'): ?>
  <?php echo $row[$data['namatbl'].'_TGLKURANGBAYAR'] . '/' . $row[$data['namatbl'].'_BLNKURANGBAYAR'] . '/20' . sprintf('%02d', $row[$data['namatbl'].'_THNKURANGBAYAR']) ?>
  <?php elseif($row['TBLSETOR_JNSBAYAR']=='SPTPD'): ?>
  <?php echo !empty($row[$data['namatbl'].'_TGLSPTPD']) ? $row[$data['namatbl'].'_TGLSPTPD'] . '/' . $row[$data['namatbl'].'_BLNSPTPD'] . '/20' . sprintf('%02d', $row[$data['namatbl'].'_THNSPTPD']) : '' ?>
  <?php else: ?>
  <?php echo !empty($row[$data['namatbl'].'_TGLSKPD']) ? $row[$data['namatbl'].'_TGLSKPD'] . '/' . $row[$data['namatbl'].'_BLNSKPD'] . '/20' . sprintf('%02d', $row[$data['namatbl'].'_THNSKPD']) : '' ?> 
  <?php endif ?>
  ...
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
  font-family:"Courier New"'>
  <?php echo $row[$data['namatbl'].'_TGLBATASSKPD'] . '/' . $row[$data['namatbl'].'_BLNBATASSKPD'] . '/20' . sprintf('%02d', $row[$data['namatbl'].'_THNBATASSKPD']) ?>
  </span></p>
  </td>
  ...
  <?php elseif ($row['TBLSETOR_JNSBAYAR']=='SKPD-A'): ?>
    ...
    <p class=MsoNormal align=right style='margin-bottom:0cm;margin-bottom:.0001pt;
    text-align:right;line-height:normal'><span lang=IN style='font-size:10.0pt;
    mso-bidi-font-size:11.0pt;font-family:"Courier New"'><?php echo LokalIndonesia::ribuan($row['BUNGA']+$row['PAJAK']); ?></span></p>
    </td>
  <?php endif ?>

  <?php if ($row['TBLSETOR_TGLSETOR']!=0 || $row['TBLSETOR_JNSBAYAR']=='SKPD-A'): ?>
  <td width=80 valign=top style='width:59.7pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:11.35pt'>
  <p class=MsoNormal align=right style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:right;line-height:normal'><span lang=IN style='font-size:10.0pt;
  ...
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
  font-family:"Courier New"'><?= !empty($row['TBLSETOR_TGLSETOR']) ? sprintf('%02d', $row['TBLSETOR_TGLSETOR']) . '/' . sprintf('%02d', $row['TBLSETOR_BLNSETOR']) . '/20' . sprintf('%02d', $row['TBLSETOR_THNSETOR']) : '' ?></span></p>
  </td>
  <td width=85 valign=top style='width:63.75pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:11.35pt'>
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
  font-family:"Courier New"'>
      <?php if ($row['TBLSETOR_JNSBAYAR']=='SKPD-A'): ?>
        <?php $totalsspd+=$row['TBLSETOR_RUPIAHSETOR']+$row['SETORANBUNGA']; ?><?= LokalIndonesia::ribuan($row['TBLSETOR_RUPIAHSETOR']+$row['SETORANBUNGA']) ?>
       <?php else: ?>  
          <?php $totalsspd+=$row['TBLSETOR_RUPIAHSETOR']; ?><?= LokalIndonesia::ribuan($row['TBLSETOR_RUPIAHSETOR']) ?>
      <?php endif ?>
  ...
  <p class=MsoNormal align=right style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:right;line-height:normal'><span lang=IN style='font-size:10.0pt;
  mso-bidi-font-size:11.0pt;font-family:"Courier New"'><?= LokalIndonesia::ribuan($row['TBLSETOR_RUPIAHSETOR']) ?></span></p>
  </td>
  <td width=123 valign=top style='width:92.15pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:11.35pt'>
  <p class=MsoNormal align=right style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:right;line-height:normal'><span lang=IN style='font-size:10.0pt;
  mso-bidi-font-size:11.0pt;font-family:"Courier New"'><?= LokalIndonesia::ribuan($row['SETORANBUNGA']) ?></span></p>
  </td>
  <?php endif ?>
  ...
  Diangsur <?= $this->getCountAngsuran($row['TBLDAFTAR_NOPOK'],$row['TBLPENDATAAN_THNPAJAK']); ?> kali</span></p>
  </td>
  <?php endif ?>

  <?php if ($rowPage['TBLSETOR_TGLSETOR']==0 && $rowPage['TBLSETOR_JNSBAYAR']=='SKPDKB'): ?>
  <td width=95 valign=top style='width:70.9pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:11.35pt'>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span lang=IN style='font-size:10.0pt;
  ...
  <?php
    $tglbatas = date('Y-m-d', strtotime('20'.sprintf('%02d', $row[$data['namatbl'].'_THNBATASSKPD']).'-'.$row[$data['namatbl'].'_BLNBATASSKPD'].'-'.$row[$data['namatbl'].'_TGLBATASSKPD']));
  ...
  <?php elseif ($row['TBLSETOR_JNSBAYAR']=='SKPD-A' && $row['TBLSETOR_TGLSETOR']==0): ?>
  <td width=95 valign=top style='width:70.9pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:11.35pt'>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span lang=IN style='font-size:10.0pt;
  ...
  <?php
    $tglbatas = date('Y-m-d', strtotime('20'.sprintf('%02d', $row[$data['namatbl'].'_THNBATASSKPD']).'-'.$row[$data['namatbl'].'_BLNBATASSKPD'].'-'.$row[$data['namatbl'].'_TGLBATASSKPD']));
    $tglhitungdenda = date('Y-m-d');
    $pokok =$row['PAJAK']+$row['BUNGA'];
    $faktor =$row['FAKTORPENGURANGDND']; // add faktor penghilang denda angsur 1-4-2021 rahmat
    ...
    if ($faktor>0) {
      ...
      $totaldenda = $pokok*$jmlbulandenda*(2/100); // add faktor penghilang denda angsur 1-4-2021 rahmat
    } 
  ...
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span lang=IN style='font-size:10.0pt;
  mso-bidi-font-size:11.0pt;font-family:"Courier New"'>0</span></p>
  <td width=95 valign=top style='width:70.9pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:11.35pt'>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span lang=IN style='font-size:10.0pt;
  mso-bidi-font-size:11.0pt;font-family:"Courier New"'>LUNAS</span></p>
  </td>
  <?php endif ?>
...
<tr style='mso-yfti-irow:4;height:14.2pt'>
      ...
      <?php if ($rowPage['TBLSETOR_JNSBAYAR']=='SKPDKB' && $rowPage['TBLSETOR_TGLSETOR']==0): ?>
      <td width=130 colspan=11 valign=top style='width:3.0cm;padding:0cm 5.4pt 0cm 5.4pt;
      height:14.2pt'>
      <p class=MsoNormal align=right style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
      normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
      font-family:"Courier New"'><o:p></o:p></span></p>
      </td>
      <?php elseif ($rowPage['TBLSETOR_JNSBAYAR']=='SKPDKB' && $rowPage['TBLSETOR_TGLSETOR']!=0): ?>
        <td width=130 colspan=12 valign=top style='width:3.0cm;padding:0cm 5.4pt 0cm 5.4pt;
      height:14.2pt'>
      <p class=MsoNormal align=right style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
      normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
      font-family:"Courier New"'><o:p></o:p></span></p>
      </td>
      <?php elseif ($rowPage['TBLSETOR_JNSBAYAR']=='SKPDKB di angsur'): ?>
        <td width=130 colspan=10 valign=top style='width:3.0cm;padding:0cm 5.4pt 0cm 5.4pt;
      height:14.2pt'>
      <p class=MsoNormal align=right style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
      normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
      font-family:"Courier New"'><o:p></o:p></span></p>
      ...
      <?php elseif ($rowPage['TBLSETOR_JNSBAYAR']=='SKPD-A'): ?>
        <td width=130 colspan=15 valign=top style='width:3.0cm;padding:0cm 5.4pt 0cm 5.4pt;
      height:14.2pt'>
      <p class=MsoNormal align=right style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
      normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
      font-family:"Courier New"'><o:p></o:p></span></p>
...
<?php if ($rowPage['TBLSETOR_JNSBAYAR']<>'SKPDKB di angsur'): ?>
  ...
  <?php if ($rowPage['TBLSETOR_JNSBAYAR']=='SKPD-A'): ?>
      <tr style='mso-yfti-irow:4;height:14.2pt'>
      <td width=130 colspan=14 valign=top style='width:3.0cm;padding:0cm 5.4pt 0cm 5.4pt;
      height:14.2pt'>
      <p class=MsoNormal align=right style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
      normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
      font-family:"Courier New"'>DARI POKOK KURANG BAYAR :<o:p></o:p></span></p>
      </td>
      <td width=170 colspan=1 valign=top style='width:127.6pt;padding:0cm 5.4pt 0cm 5.4pt;
      height:14.2pt'>
 ...
 <tr style='mso-yfti-irow:4;height:14.2pt'>
  ...
  <p class=MsoNormal align=right style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
  font-family:"Courier New"'>KETETAPAN SKPD-ANGSURAN :<o:p></o:p></span></p>
  </td>
  <?php elseif ($rowPage['TBLSETOR_JNSBAYAR']=='SKPDKB' && $rowPage['TBLSETOR_TGLSETOR']==0): ?>
  <td width=130 colspan=10 valign=top style='width:3.0cm;padding:0cm 5.4pt 0cm 5.4pt;
  height:14.2pt'>
  <p class=MsoNormal align=right style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
  font-family:"Courier New"'>KETETAPAN SKPD :<o:p></o:p></span></p>
  </td>
  <?php elseif ($rowPage['TBLSETOR_JNSBAYAR']=='SKPDKB' && $rowPage['TBLSETOR_TGLSETOR']!=0): ?>
  <td width=130 colspan=11 valign=top style='width:3.0cm;padding:0cm 5.4pt 0cm 5.4pt;
  height:14.2pt'>
 ...
 <tr style='mso-yfti-irow:5;height:14.2pt'>
  ...
  <?php if($totalskpd-$totalsspd<0 && $rowPage['TBLSETOR_JNSBAYAR']=='SKPDKB'):?>
   <tr style='mso-yfti-irow:5;height:14.2pt'>
  <td width=241 colspan=12 valign=top style='width:180.75pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:14.2pt'>
  <p class=MsoNormal align=right style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
  font-family:"Courier New"'>
  * Sudah Termasuk Denda Keterlambatan <?= LokalIndonesia::ribuan($totalsspd-$totalskpd) ?>
  <o:p></o:p></span></p>
    </td>
  </tr>
  <?php endif ?>
 ...
 <tr style='mso-yfti-irow:6;mso-yfti-lastrow:yes;height:14.2pt'>
  ...
  0
  <?php else: ?>
  <?= LokalIndonesia::ribuan($totalskpd-$totalsspd) ?>
  <?php endif ?>
  <o:p></o:p></span></p>
  </td>
  ...
  <?php if($totalskpd-$totalsspd!=0):?>
  <tr style='mso-yfti-irow:6;mso-yfti-lastrow:yes;height:14.2pt'>

  <?php if ($rowPage['TBLSETOR_JNSBAYAR']=='SKPD-A'): ?>
  <td width=241  colspan=14 valign=top style='width:180.75pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:14.2pt'>
  <p class=MsoNormal align=right style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
  ...
  <?php elseif ($rowPage['TBLSETOR_JNSBAYAR']=='SKPDKB' && $rowPage['TBLSETOR_TGLSETOR']==0): ?>
  <td width=241  colspan=10 valign=top style='width:180.75pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:14.2pt'>
  <p class=MsoNormal align=right style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
  font-family:"Courier New"'><o:p>
  ...
  <td width=46 colspan=1 valign=top style='width:34.25pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:14.2pt'>
  <p class=MsoNormal align=right style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
  font-family:"Courier New"'><o:p>
  <?= LokalIndonesia::ribuan($totalestimasidenda) ?>
 ...
 <?php if($totalskpd-$totalsspd!=0):?>
  ...
  normal'><span lang=IN style='font-size:10.0pt;mso-bidi-font-size:11.0pt;
  font-family:"Courier New"'><o:p>
  <?= LokalIndonesia::ribuan($totalestimasibayar) ?>

...
<script type="text/javascript">
	...
	function generateAutocompleteWP() {
		...
		$('#nopok').autocomplete({
			serviceUrl: 'pendataan/cek_data_perwptahunv4/autocompletewpv2',
	...
	function cari() {
		...
		$.ajax({
			url: 'pendataan/cek_data_perwptahunv4/cari',
			type: 'POST',
			data: {
	...
	function caribulanan() {
		...
		$.ajax({
			url: 'pendataan/cek_data_perwptahunv4/caribulanan',
			type: 'POST',
			data: {
				rekening: $("#TREKENINGSUB_KODE").val()
				, TBLPENDATAAN_THNPAJAK: ($('#th_pajak').prop('checked') ? $("#masapajak_tahun").val() :'')
	...
	function cetak2() {
		...
		$.ajax({
			url: 'pendataan/cek_data_perwptahunv4/cetak',
			type: 'POST',
			data: {
				rekening: $("#TREKENINGSUB_KODE").val()
				, TBLPENDATAAN_THNPAJAK: ($('#th_pajak').prop('checked') ? $("#masapajak_tahun").val() :'')
	...
	function cetak() {
		...
		window.open(URL_APLIKASI+"/pendataan/cek_data_perwptahunv4/cetak?TBLPENDATAAN_THNPAJAK2="+TBLPENDATAAN_THNPAJAK2+"&TBLPENDATAAN_THNPAJAK="+TBLPENDATAAN_THNPAJAK+"&TBLDAFTAR_NOPOK="+TBLDAFTAR_NOPOK+"&rekening="+rekening);
	...
	function cetakbulanan() {
		...
		var TBLDAFTAR_NOPOK = $("#nopok ").val();
		var URL_APLIKASI = "<?php echo Yii::app()->getBaseUrl(1); ?>";
		window.open(URL_APLIKASI+"/pendataan/cek_data_perwptahunv4/cetak2?TBLPENDATAAN_THNPAJAK2="+TBLPENDATAAN_THNPAJAK2+"&TBLPENDATAAN_THNPAJAK="+TBLPENDATAAN_THNPAJAK+"&TBLDAFTAR_NOPOK="+TBLDAFTAR_NOPOK+"&rekening="+rekening);

...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i>Salin SPT Air Tanah</h4>
		</div>
	</div>
</div>
										...
										<label class="select">
											<select class="select2" id="TREKENING_KODE" name="TREKENING_KODE">
												...
												<?php foreach ($data['rek'] as $list): ?>
													<?php /* ?>
													<option  selected="" value="<?php echo $list['TBLREKENING_REKAYAT'] ?>">[<?php echo $list['TBLREKENING_KODE'] ?>] <?php echo $list['TBLREKENING_NAMAREKENING'] ?></option>
													<?php */ ?>
													<option  selected="" value="<?php echo $list['TBLREKENING_REKAYAT'] ?>"><?php echo $list['TBLREKENING_NAMAREKENING'] ?></option>
												<?php endforeach ?>
											</select>
										</label>
									</section>
...
<script type="text/javascript">
	...
	function generateAutocompleteWP() {
		...
		$('#TBLDAFTAR_NOPOK').autocomplete({
			serviceUrl: 'pendataan/salin_airtanah/autocompletewp',
	...
	function cari() {
		...
		$.ajax({
			url: 'pendataan/salin_airtanah/cari',
			type: 'POST',
			data: {
	...
	function simpan_salin() {
		...
		if (count>0) {
			...
			if (ButtonPressed === "Ya") {
				$.ajax({
					url: 'pendataan/salin_airtanah/SalinData',
					type: 'POST',
					dataType: 'json',
					data: {

	...
	<script type="text/javascript">
		...
		function generateAutocompleteWP() {
			$('#TBLDAFTAR_NOPOK').autocomplete({
				serviceUrl: 'pendataan/reklamelama_insidentil/autocompletewp',
		...
		function cari() {
			...
			if (TBLDAFTAR_NOPOK=='') {
				...
				$.ajax({
					url: 'pendataan/reklamelama_insidentil/getdata',
					type: 'POST',
					dataType: 'json',
					data: {
...
function simpanPendataan() {
	...
	$.ajax({
		url: 'pendataan/reklamelama_insidentil/simpanPendataan',
		type: 'POST',
		dataType: 'json',

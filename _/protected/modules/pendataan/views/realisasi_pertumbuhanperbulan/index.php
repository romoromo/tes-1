...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <div class="well well-sm well-light bg-color-greenLight txt-color-white">
      <h4><i class="fa fa-file-text-o"></i> Realisasi dan Pertumbuhan Pajak Daerah Perbulan  </h4>
    </div>
  </div>
</div>
    ...
    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      >
              ...
              <header role="heading">
                ...
                <h2> Realisasi dan Pertumbuhan Pajak Daerah Perbulan</h2>
...
<script type="text/javascript">
  ...
  function cetak (tipe) {
     window.open('<?php echo Yii::app()->baseUrl; ?>/pendataan/Realisasi_pertumbuhanperbulan/Cetak_daftar?tipe='+tipe);
  }

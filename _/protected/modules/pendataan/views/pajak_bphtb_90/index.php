						...
						<form id="form_sumber_pajak" class="smart-form" novalidate="">
							...
							<fieldset id="form_perhitungan" style="display: none;">
								...
								<div class="row">
									...
									<section class="col col-md-2">
									<a onclick="detail_nop()" class="btn btn-sm btn-primary pull-left">
								...
								<div class="row">
									...
									<section class="col col-md-3">
										<label class="input">
											<input class="input-sm form-control format-rupiah text-align-right" type="text" id="njpbb" name="njpbb">
										</label>
									</section>
								</div>
								<!-- <div class="row">
								...
								<div class="row">
									...
									<section class="col col-md-2">
										<label class="input">
											...
											<input class="input-sm form-control text-align-left" readonly="" style="background: #e4e4e4;" type="hidden" id="refbadanusaha_reksubjenis" name="refbadanusaha_reksubjenis">
										</label>
									</section>
								</div>
								...
								<div class="row">
									...
									<section class="col col-md-3">
										<label class="input">
											<input class="input-sm form-control text-align-right format-rupiah" type="text" id="npop" name="npop">
										</label>
									</section>
								</div>
								<div class="row">
									...
									<section class="col col-md-3">
										<label class="input">
											<input class="input-sm form-control text-align-right format-rupiah" type="text" id="npop_2" name="npop_2">
										</label>
									</section>
									<section class="col col-md-1">
										<p>X</p>
									...
									<section class="col col-md-1">
										<label class="input">
											<input name="persen" id="persen" type="text" class="input-sm form-control">
										</label>
									</section>
									<section class="col col-md-1">
								...
								<div class="row">
									...
									<section class="col col-md-3">
										<label class="input">
											<input class="input-sm form-control text-align-right format-rupiah" type="text" id="bayar" name="bayar">
										</label>
									</section>
								</div>
...
<script type="text/javascript">
								...
								buttons : '[Tidak][Ya]' // pengaturan tombol
									...
									if (ButtonPressed === "Ya") {
										...
										if (respon.data=='proses selanjutnya') {
											...
											$('#refbadanusaha_reksubjenis').val(respon.REFBADANUSAHA_REKSUBJENIS);
	...
	function kosongkan_rupiah(NOPOK,TGLENTRI){
		$.ajax({
			url: '<?= $this->MODULE_URL ?>/kosongkan_rp',
			type: 'POST',
			dataType: 'json',
			data: {
				 NOPOK : NOPOK

									...
									<div class="row">
										...
										<section class="col col-md-2">
											<label class="input">
												...
												<input class="input-sm" type="hidden" id="refbadanusaha_reksubjenis" name="refbadanusaha_reksubjenis">
											</label>
										</section>
									</div>
									<div class="row">
...
<script type="text/javascript">
	...
	function generateAutocompleteWPPPJ() {
		$('#nomor_pajak').autocomplete({
			serviceUrl: '<?= $this->MODULE_URL ?>/autocompletewpppj',
...
function simpan() {
	...
	$.ajax({
		...
		data: {
			...
			refbadanusaha_reksubjenis : $('#refbadanusaha_reksubjenis').val(),

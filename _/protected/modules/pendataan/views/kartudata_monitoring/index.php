...
<section id="widget-grid-tetapan" style="" class="">
	...
	<script type="text/javascript">
		...
		function cetakword () {
			...
			var q = daftaridPajak;
			window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/kartudata_monitoring/cetakword/?data=' + q +"&TBLPENDATAAN_THNPAJAK="+$('#TBLPENDATAAN_THNPAJAK').val()+"&TBLPENDATAAN_BLNPAJAK="+$('#TBLPENDATAAN_BLNPAJAK').val()+"&TBLDAFTAR_NOPOK="+$('#TBLDAFTAR_NOPOK').val()+"&TBLREKENING_KODE="+$('#TBLREKENING_KODE').val()+"&tglawal="+$('#tglawal').val()+"&tglakhir="+$('#tglakhir').val());

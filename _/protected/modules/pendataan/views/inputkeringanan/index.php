...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light">
			<h1 align="center" class="page-title txt-color-blueDark"><i class="fa fa-pencil"></i>
				Input Permohonan Keringanan Ketetapan Pajak</h1>
		</div>
	</div>
</div>
<div class="row">
					...
					<fieldset>
						...
						<section>
							<div class="row">
								...
								<div class="col col-10">
									<label class="input">
										<input class="input" type="text" value="" class="form-control" id="namapemohon" name="namapemohon">
									</label>
								</div>
							</div>
						</section>
						...
						<section>
							<div class="row">
								...
								<div class="col col-10">
									<label class="input">
										<input class="input" type="text" value="" class="form-control" id="jabatanpemohon" name="jabatanpemohon">
									</label>
								</div>
							</div>
						</section>
						...
						<section>
							<div class="row">
								...
								<div class="col col-10">
									<label class="input">
										<input class="input" type="number" value="" class="form-control" id="teleponpemohon" name="teleponpemohon">
									</label>
								</div>
							</div>
						</section>
						...
						<section>
							<div class="row">
								...
								<div class="col col-10">
									<label class="select">
										<select style="width:100%" class="select2" id="jenisketetapan" name="jenisketetapan">
						...
						<section>
							<div class="row">
								...
								<div class="col col-10">
									<label class="select">
										<select style="width:100%" class="select2" id="jenisringan" name="jenisringan">
							...
							<div class="row">
								...
								<div class="col col-10">
									<label class="textarea">
										<textarea class="textarea" rows="3" name="alasan" id="alasan"></textarea>
									</label>
								</div>
							</div>
						</section>
...
<script type="text/javascript">
	...
	function generateAutocomplete() {
		$('#nopok').autocomplete({
			serviceUrl: 'pendataan/inputkeringanan/Autocomplete',
	...
	function edit(id) {
		...
		$.ajax({
				url: 'pendataan/inputkeringanan/editdata',
				type: 'POST',
				dataType: 'json',
				data: param,
			})
	...
	function simpan() {
		...
		$.ajax({
				url: 'pendataan/inputkeringanan/simpan',
				type: 'post',
				dataType: "json",
	...
	function hapus(id) {
		$.SmartMessageBox({
			...
			if (ButtonPressed === "Ya") {
				$.ajax({
					url: 'pendataan/inputkeringanan/hapus',
					type: 'post',
					dataType: 'json',
					data: {
						id: id,
	...
	function GetMasapajak() {
		...
		if (nopok == '' || jenispajak == '' || jenisketetapan == '') {
			...
			$.ajax({
					url: 'pendataan/inputkeringanan/LoadMasapajak',
					type: 'POST',
					data: {
						nopok: $('#nopok').val(),
	...
	function listDetail() {
		...
		for (var i in daftarmasapajak) {
			...
			$("#_listDetail_").append(
				...
				+
				'<td>' +
				'<center><a class="btn btn-sm btn-danger" onclick="hapusDetail(' + i + ')">' +
	...
	function loadDataTable() {
		var totalRecords = '';
		var ajaxUrl = "pendataan/inputkeringanan/DTJSON"; // url that fetches the data for the table
		COLUMN = [{
			"data": "num"
		}, {
			"data": "TGLINPUT"

...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Verifikasi Teguran</h4>
		</div>
	</div>
</div>
				...
				<div class="widget-body no-padding">
					...
					<form action="" id="form_sumber_pajak" class="smart-form" novalidate>
						<fieldset>
							...
							<footer>
								<button type="button" onclick="cetakWord()" class="btn btn-sm btn-primary hidden">
			...
			<div>
				...
				<div class="widget-body no-padding">
					<p class="alert alert-info">
						<button type="button" class="btn btn-default" onclick="verifikasi_teguran_semua()">
							<i class="fa fa-check-square"></i> Verifikasi Semua Teguran
						</button>
					</p>
					<div id="tabel" class="">
...
<script type="text/javascript">
	...
	function cari() {
		...
		reloadDT('dt_basic');
		$.ajax({
			url: 'pendataan/verifikasi_teguran/cari',
			type: 'POST',
			data: {
	...
	function cetak() {
		...
		window.open('<?php echo Yii::app()->getBaseUrl(1); ?>/pendataan/verifikasi_teguran/cetak?' + param);
	}
	...
	function cetakWord(jenis) {
		...
		window.open('<?php echo Yii::app()->getBaseUrl(1); ?>/pendataan/verifikasi_teguran/cetakWord?' + param);
	}
    ...
    function cetak_record(nopokok, nomor_surat, tahun, bulan, rek_ayat) {
    	...
    	if ($('#nomor_surat').val()=='') {
			...
			var param = {
				...
				TBLPENDATAAN_BLNPAJAK: bulan,
				nomor_surat: nomor_surat,
				rekening: rek_ayat,
				is_draft: 'T',
			}
			window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/cetak_suratteguran_90/cetaksuratteguran/?' + $.param(param) );
    	}
	}

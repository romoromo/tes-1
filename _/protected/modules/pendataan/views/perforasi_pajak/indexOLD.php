        ...
        <div class="modal-content">
            ...
            <div class="modal-body no-padding">
                ...
                <div class="modal-footer">
					...
					<button type="button" onclick='simpantiket()' class="btn btn-primary" id="simpan" >
						Simpan
					</button>
				</div>                       
            </div>
...
<script type="text/javascript">
	...
	function LoadTableNotabill(rekkode,tahun,bln,nopok,tglentri) {
		...
		$.ajax({
            url: 'pendataan/perforasi_pajak/GetTabelHotel',
            type: 'POST',
            dataType: 'html',
            data: {
            	rekkode:rekkode,
	...
	function LoadTableTiket(rekkode,tahun,bln,nopok,tglentri) {
		...
		$.ajax({
            url: 'pendataan/perforasi_pajak/GetTabelHiburan',
            type: 'POST',
            dataType: 'html',
            data: {
            	rekkode:rekkode,
	...
	function GetDetailHotel(tahun,bln,nopok) {
		...
		$.ajax({
            url: 'pendataan/perforasi_pajak/GetdetailHotel',
            type: 'POST',
            dataType: 'json',
            data: {
				tahun:tahun
	...
	function GetDetailHiburan(tahun,bln,nopok) {
		...
		$.ajax({
            url: 'pendataan/perforasi_pajak/GetdetailHiburan',
            type: 'POST',
            dataType: 'json',
            data: {
				tahun:tahun
	...
	function editdatahiburan(id) {
		window.cmd = 'edit';
		$.ajax({
            url: 'pendataan/perforasi_pajak/GetdataHiburan',
            type: 'POST',
            dataType: 'json',
            data: {
            	id:id
	...
	function hapusdatahiburan(id) {
		...
		$.SmartMessageBox({
			...
			if (ButtonPressed === "Ya") {
				$.ajax({
					url: 'pendataan/perforasi_pajak/HapusKamarHiburan',
					type: 'POST',
					dataType: 'json',
					data: {
						id : id
	...
	function simpannotabill() {
		...
		$.ajax({
            url: 'pendataan/perforasi_pajak/SimpanKamarHotel',
            type: 'POST',
            dataType: 'json',
	...
	function simpantiket() {
		...
		$.ajax({
            url: 'pendataan/perforasi_pajak/SimpanKamarHiburan',
            type: 'POST',
            dataType: 'json',
	...
	function GetDataResto(tahun,bln,nopok) {
		...
		$.ajax({
            url: 'pendataan/perforasi_pajak/GetdataResto',
            type: 'POST',
            dataType: 'json',
            data: {
				tahun:tahun
	...
	function simpanresto() {
		...
		$.ajax({
            url: 'pendataan/perforasi_pajak/SimpanDetailResto',
            type: 'POST',
            dataType: 'json',
	...
	function simpandetailhotel() {
		...
		$.ajax({
            url: 'pendataan/perforasi_pajak/SimpanDetailHotel',
            type: 'POST',
            dataType: 'json',
	...
	function simpandetailhiburan() {
		...
		$.ajax({
            url: 'pendataan/perforasi_pajak/SimpanDetailHiburan',
            type: 'POST',
            dataType: 'json',

...
<section id="widget-grid" class="">
	...
	<div class="row">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget jarviswidget-color-teal" id="wid-id-monitoring-pajak" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-custombutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false" data-widget-togglebutton="false">
				<header>
				...
				<form class="smart-form" id="form-modal-notabill">
					<fieldset>
						...
						<div class="row">
							...
							<section class="col col-sm-9">
								<label for="address" class="input">
									<input class="form-control" type="text" name="notabill_awal" id="notabill_awal"></input>
								</label>
							</section>
						</div>
				...
				<form class="smart-form" id="form-modal-tiket">
					<fieldset>
						...
						<div class="row">
							...
							<section class="col col-sm-9">
								<label for="address" class="input">
									<input class="form-control" type="text" name="tiket_awal" id="tiket_awal"></input>
								</label>
							</section>
						</div>
...
<script type="text/javascript">
	...
	function simpantiketkarcis() {
		...
		var nopok = $('#nopok').val();
		var tglentri = $('#tglentri').val();
		var angkarupiah = toAngka($('#tiket_nilai').val());

		$.ajax({
			url: 'pendataan/perforasi_pajak/Simpantiket',
			type: 'POST',
			dataType: 'json',
			data: $("#form-modal-tiket").serialize() + '&rekkode=' + rekkode + '&tahun=' + tahun + '&bln=' + bln + '&nopok=' + nopok + '&tglentri=' + tglentri + '&cmd=' + window.cmd + '&id=' + window.id +'&angkarupiah=' + angkarupiah,
			success: function(respon) {
				if (respon.pesan == 'success') {
					notifikasi('Informasi', 'Data berhasil disimpan', 'success', 1, 0);

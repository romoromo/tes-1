	...
	<thead>
		...
		<tbody>
			<?php 
				...
				$jsspd += $row['TBLSETOR_RUPIAHSETOR'];
			...
			<tr>
				...
				<td style="text-align:right;"><?php LokalIndonesia::ribuan($row[$data['namatbl'].'_PAJAKSKPD']); ?></td>
				<td>
				...
				<td style="text-align:right;"><?php LokalIndonesia::ribuan($row['TBLSETOR_RUPIAHSETOR']); ?></td>
				<td><?= $row['TBLPENDATAAN_BLNPAJAK']; ?></td>
				<td><?php $row[$data['namatbl'].'_REGKURANGBAYAR']; ?></td>
				<td style="text-align:right;">
					<?php //if (!empty($row[$data['namatbl'].'_RUPIAHKRGBAYAR'])): ?>	
						<?php //$row[$data['namatbl'].'_RUPIAHKRGBAYAR']; ?>
					<?php //else: ?>
						0
					<?php //endif ?>
				</td>
				...
				<td style="text-align:right;"><?php // LokalIndonesia::ribuan($row[$data['namatbl'].'_RUPIAHKRGBAYAR']); ?></td>
			</tr>
		<?php endforeach ?>
	</tbody>
	<tfoot>

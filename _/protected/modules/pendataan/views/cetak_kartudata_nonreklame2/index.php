					...
					<form action="" id="form_sumber_pajak" class="smart-form" novalidate>
						<fieldset>
							<div class="row">
									...
									<section class="col col-md-2">
										<label class="input">
											<input maxlength="2" type="number" id="TBLPENDATAAN_THNPAJAK" name="param[TBLPENDATAAN_THNPAJAK]" placeholder="Tahun" maxlength="4">
										</label>
									</section>
									<section class="col col-md-2">
										<label class="select">
...
<script type="text/javascript">
	...
	function cari() {
		...
		reloadDT('dt_basic');
		$.ajax({
			url: 'pendataan/cetak_kartudata_nonreklame2/cari',
			type: 'POST',
			data: {
	...
	function cetak() {
		...
		window.open('<?php echo Yii::app()->getBaseUrl(1); ?>/pendataan/cetak_kartudata_nonreklame2/cetak?' + param);
	}
	...
	function cetakWord(jenis) {
		...
		window.open('<?php echo Yii::app()->getBaseUrl(1); ?>/pendataan/cetak_kartudata_nonreklame2/cetakWord?' + param);
	}

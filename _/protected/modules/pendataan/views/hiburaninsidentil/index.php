...
<script type="text/javascript">
	...
	function generateAutocompleteWPHiburan() {
		$('#TBLDAFTAR_NOPOK').autocomplete({
			serviceUrl: 'pendataan/hiburaninsidentil/autocompletewphiburan',
	...
	function cekPernahDaftar() {
		...
		if (TGLPAJAK=='') {
			...
			$.ajax({
				url: 'pendataan/hiburaninsidentil/CekPernahDaftar',
				type: 'POST',
				dataType: 'json',
				data: {
	...
	function getTglBatas(THNPAJAK,BLNPAJAK,KODEREK) {
		$.ajax({
			url: 'pendataan/hiburaninsidentil/GetTGLBatas',
			type: 'POST',
			dataType: 'json',
			data: {
				 THNPAJAK : THNPAJAK
	...
	function cari() {
		...
		if (TBLDAFTAR_NOPOK=='') {
			...
			$.ajax({
				url: 'pendataan/hiburaninsidentil/GetWPHiburan',
				type: 'POST',
				dataType: 'json',
				data: {
					 nopokok: window.nopokok
	...
	function getTarifRekening(kodesubrek) {
		$.ajax({
			url: 'pendataan/hiburaninsidentil/GetKodeRek',
			type: 'POST',
			dataType: 'json',
			data: {
	...
	function simpanhiburan () {
		$.ajax({
			url: 'pendataan/hiburaninsidentil/SimpanHiburan',
			type: 'post',
			dataType: "json",

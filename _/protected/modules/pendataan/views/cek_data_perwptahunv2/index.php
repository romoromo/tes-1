...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Check Data Per-WP Per-Tahun V2</h4>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	...
	function generateAutocompleteWP() {
		...
		$('#nopok').autocomplete({
			serviceUrl: 'pendataan/cek_data_perwptahunv2/autocompletewpv2',
	...
	function cari() {
		...
		$.ajax({
			url: 'pendataan/cek_data_perwptahunv2/cetak',
			type: 'POST',
			data: {
	...
	function tampil() {
		...
		$.ajax({
			url: 'pendataan/cek_data_perwptahunv2/cari',
			type: 'POST',
			data: {
				rekening: $("#TREKENINGSUB_KODE").val()
				, TBLPENDATAAN_THNPAJAK: $("#masapajak_tahun").val()
	...
	// 	}
	// 	);
	// 	window.open('<?= Yii::app()->getBaseUrl(1); ?>/pendataan/cek_data_perwptahunv2/cetak?' + param);
	// }
	...
	function cetak(jenis) {
		...
		window.open(URL_APLIKASI+"/pendataan/cek_data_perwptahunv2/cetak?jenis="+jenis+"&TBLPENDATAAN_THNPAJAK="+window.TBLPENDATAAN_THNPAJAK+"&TBLDAFTAR_NOPOK="+window.TBLDAFTAR_NOPOK+"&rekening="+window.rekening);

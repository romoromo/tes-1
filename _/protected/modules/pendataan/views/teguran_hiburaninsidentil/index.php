...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file fa-fw"></i> Entry Pendataan Pajak Hiburan Insidentil</h4>
		</div>
	</div>
</div>
								...
								<section class="col col-md-2">
									<label class="select">
										<select class="select" id="TBLDAFTHIBURAN_JNSHIBURAN" name="TBLDAFTHIBURAN_JNSHIBURAN" readonly="readonly">
											<option value="I" selected="selected">Insidentil</option>
										</select><i></i>
									</label>
								</section>
							</div>
						...
						<fieldset id="form-data-perhitungan" style="display: none;">
							...
							<div class="row">
								...
								<section class="col col-md-3">
									<label class="input">
										<input readonly="readonly" style="background-color: #eeeeee;" type="text" onkeyup="hitungPajakHari()" class="format-rupiah" id="TBLDAFTHIBURAN_PENJUALANHARI" name="TBLDAFTHIBURAN_PENJUALANHARI">
									</label>
								</section>
								<section class="col col-md-2">
									<p>Jumlah Hari</p>
								...
								<section class="col col-md-3">
									<label class="input">
										<input readonly="readonly" style="background-color: #eeeeee;" type="text" onkeyup="hitungPajakHari()" class="format-ribuan" id="TBLDAFTHIBURAN_JUMLAHHARIJUAL" name="TBLDAFTHIBURAN_JUMLAHHARIJUAL">
									</label>
								</section>
							</div>
							...
							<div class="row">
								...
								<section class="col col-md-3">
									<label class="input">
										<input readonly="readonly" style="background-color: #eeeeee;" type="text" onkeyup="hitungPajakBulan()" class="format-rupiah" id="TBLDAFTHIBURAN_OMSETPAJAK" name="TBLDAFTHIBURAN_OMSETPAJAK">
									</label>
								</section>
								<section class="col col-md-2">
									<p>Keringanan</p>
							...
							<div class="row">
								...
								<section class="col col-md-2">
									<div class="input-group">
										...
										<input readonly="readonly" style="background-color: #eeeeee;" class="form-control format-ribuan format-rupiah" id="TBLDAFTHIBURAN_PAJAK" name="TBLDAFTHIBURAN_PAJAK" type="text">
									</div>
								</section>
								...
								<section class="col col-md-2">
									<div class="input-group">
										<span class="input-group-addon">Rp</span>
										<input readonly="readonly" style="background-color: #eeeeee;" class="form-control format-ribuan format-rupiah" id="TBLDAFTHIBURAN_BUNGASPTPD" name="TBLDAFTHIBURAN_BUNGASPTPD" type="text">
									</div>
								</section>
...
<script type="text/javascript">
	...
	function generateAutocompleteWPHiburan() {
		$('#TBLDAFTAR_NOPOK').autocomplete({
			serviceUrl: 'pendataan/teguran_hiburaninsidentil/autocompletewphiburan',
	...
	function cekPernahDaftar() {
		...
		if (TGLPAJAK=='') {
			...
			$.ajax({
				url: 'pendataan/teguran_hiburaninsidentil/CekPernahDaftar',
				type: 'POST',
				dataType: 'json',
				data: {
					...
					,TGLPAJAK: $('#TBLPENDATAAN_TGLPAJAK').val()
				},
				success : function (respon) {
					...
					if (respon.status=='sudah') {
						$.SmartMessageBox({
							...
							content : "Data dengan Nomor Pokok "+window.nopokok+", Masa Pajak "+TGLPAJAK+"-"+BLNPAJAK+"-"+THNPAJAK+" sudah pernah mendaftar. <br> Apakah anda ingin mengubah data ini?", // konten dari smart alert
	...
	function getTglBatas(THNPAJAK,BLNPAJAK,KODEREK) {
		$.ajax({
			url: 'pendataan/teguran_hiburaninsidentil/GetTGLBatas',
			type: 'POST',
			dataType: 'json',
			data: {
				 THNPAJAK : THNPAJAK
	...
	function cari() {
		...
		if (TBLDAFTAR_NOPOK=='') {
			...
			$.ajax({
				url: 'pendataan/teguran_hiburaninsidentil/GetWPHiburan',
				type: 'POST',
				dataType: 'json',
				data: {
					 nopokok: window.nopokok
	...
	function getTarifRekening(kodesubrek) {
		$.ajax({
			url: 'pendataan/teguran_hiburaninsidentil/GetKodeRek',
			type: 'POST',
			dataType: 'json',
			data: {
	...
	function simpanhiburan () {
		$.ajax({
			url: 'pendataan/teguran_hiburaninsidentil/SimpanHiburan',
			type: 'post',
			dataType: "json",

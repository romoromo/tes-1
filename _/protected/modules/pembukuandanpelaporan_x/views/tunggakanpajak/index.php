...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="well well-sm well-light bg-color-greenLight txt-color-white">
            <h4><i class="fa fa-file-text-o"></i> Cetak Laporan Realisasi Tunggakan </h4>
        </div>
    </div>
</div>
                  ...
                  <form action="" id="form_sumber_pajak" class="smart-form" novalidate>
                      <fieldset>
                        ...
                        <section class="col col-sm-1">
                          <label class="input">
                             <input type="text" maxlength="4" id="tahun" name="tahun">
                         </label>
                     </section>
                 </div>
                 <div class="row">
...
<section class="col col-3">
  <label class="select">
      <select class="select2" enabled="enabled">
        ...
        <option value="8">JLN. PEMBLA TANAH AIR YK</option>
...
<script type="text/javascript">
    ...
    function cetak () {
        ...
        window.open(window.APP_URL+'/pembukuandanpelaporan/tunggakanpajak/cetak?tahun='+window.tahun+'&TBLREKENING_KODE='+window.TBLREKENING_KODE);
    }

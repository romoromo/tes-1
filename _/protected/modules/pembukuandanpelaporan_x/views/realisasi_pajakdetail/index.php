...
<div class="row">
	...
	<script type="text/javascript">
		...
		function cari () {
			...
			$.ajax({
				url: 'pembukuandanpelaporan/realisasi_pajakdatail/Cari',
				type: 'POST',
				data: {
		...
		function cetak () {
			...
			if ($('#tgl_setor').val()=='') {
				...
				window.open('<?php echo Yii::app()->getBaseUrl(1) ?>/pembukuandanpelaporan/realisasi_pajakdetail/Cetak?tgl_setor='+tgl_setor);
			}
		}

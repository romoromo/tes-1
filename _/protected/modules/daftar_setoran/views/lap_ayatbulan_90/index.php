			...
			<div>
				...
				<div class="widget-body no-padding">
					...
					<form action="" id="form_sumber_pajak" class="smart-form" novalidate>
						...
						<footer>
							<button type="button" class="btn btn-sm btn-primary" onclick="cetakWord()"> Cetak Word Rekening Baru</button>
							<button type="button" class="btn btn-sm btn-primary" onclick="cetakWord_lama()"> Cetak Word Rekening Lama</button>
						</footer>					
					</form>
...
function cetak(){ 
	...
	window.open(URL_APLIKASI+"/<?= $this->MODULE_URL ?>/cetak?tahun="+window.tahun+"&bulan="+window.bulan+"&rekening="+window.rekening);
}

...
<?php $totalsdhariini = 0; ?>
 <?php $no=1; foreach ($data['realisasibkp'] as $list) :?>                  
...
<?php $totalsdhariini = $totalsdhariini+$list['SD_HARIINI']; ?>
    <tr>
        ...
        <td><div align="center"><?php echo $list['TBLSETOR_REKPENDAPATAN']?>.<?php echo $list['TBLSETOR_REKPAD']?>.<?php echo $list['TBLSETOR_REKPAJAK']?>.<?php echo $list['TBLSETOR_REKAYAT'] ?>.<?php echo $list['TBLSETOR_REKJENIS'] ?></div> </td> <!-- No.Rek -->

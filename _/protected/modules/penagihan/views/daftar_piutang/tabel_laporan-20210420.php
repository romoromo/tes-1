...
<table width="100%" border="1" style="border-collapse:collapse;" cellpadding="0" cellspacing="0" class="table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" >
	<thead>
        <tr>
            <th colspan="17" style="text-align-last:left;">KARTU PIUTANG<br>
	...
	<tbody>
		...
		<tr>
			...
			<td><?php echo $list[$data['NamaTBL'].'_TGLKURANGBAYAR'] ?>/<?php echo $list[$data['NamaTBL'].'_BLNKURANGBAYAR'] ?>/20<?php echo sprintf('%02d', $list[$data['NamaTBL'].'_THNKURANGBAYAR']) ?></td>
			<td><?php echo $list[$data['NamaTBL'].'_TGLBTSKRGBAYAR'] ?>/<?php echo $list[$data['NamaTBL'].'_BLNBTSKRGBAYAR'] ?>/20<?php echo sprintf('%02d', $list[$data['NamaTBL'].'_THNBTSKRGBAYAR']) ?></td>
			<td><?php 

...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Telaah Keringanan SPTPD</h4>
		</div>
	</div>
</div>
									...
									<div class="row">
										...
										<section class="col col-md-5">
											<label class="textarea"> 										
												<textarea rows="3" name="tempat_undangan" id="tempat_undangan">
												</textarea> 
											</label>
										</section>  -->
									</div>
...
<script type="text/javascript">
  ...
  $('#pemohon').autocomplete({
    serviceUrl: '<?php echo Yii::app()->getBaseUrl(1); ?>/penagihan/keringanansptpd/AutocompletePegawai',

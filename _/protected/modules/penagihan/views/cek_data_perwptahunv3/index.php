...
<script type="text/javascript">
	...
	function generateAutocompleteWP() {
		...
		$('#nopok').autocomplete({
			serviceUrl: 'penagihan/cek_data_perwptahunv3/autocompletewpv2',
	...
	function cari() {
		...
		$.ajax({
			url: 'penagihan/cek_data_perwptahunv3/cetak',
			type: 'POST',
			data: {
	...
	function tampil() {
		...
		$.ajax({
			url: 'penagihan/cek_data_perwptahunv3/cari',
			type: 'POST',
			data: {
				rekening: $("#TREKENINGSUB_KODE").val()
				, TBLPENDATAAN_THNPAJAK: $("#masapajak_tahun").val()
	...
	function cetak(jenis) {
		...
		window.open(URL_APLIKASI+"/penagihan/cek_data_perwptahunv3/cetak?jenis="+jenis+"&TBLPENDATAAN_THNPAJAK="+window.TBLPENDATAAN_THNPAJAK+"&TBLDAFTAR_NOPOK="+window.TBLDAFTAR_NOPOK+"&rekening="+window.rekening);

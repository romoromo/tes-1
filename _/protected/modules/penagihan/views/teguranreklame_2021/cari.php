<table id="dt_basic" class="table table-bordered table-striped table-condensed table-hover smart-form has-tickbox">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?=$row['TBLPENDATAAN_THNPAJAK'];?></td><!--BNAMA-->
            <td><?=$row['TBLPENDATAAN_BLNPAJAK'];?></td><!--BALAMAT-->
            <td><?=$row['TBLPENDATAAN_TGLPAJAK'];?></td><!--KTRE1-->
            ...
            <td><?=$row['TBLDAFTAR_BADANUSAHANAMA'];?><!-- NAMA BU -->

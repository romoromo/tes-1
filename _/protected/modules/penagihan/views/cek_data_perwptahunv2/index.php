...
<script type="text/javascript">
	...
	function generateAutocompleteWP() {
		...
		$('#nopok').autocomplete({
			serviceUrl: 'penagihan/cek_data_perwptahunv2/autocompletewpv2',
	...
	function cari() {
		...
		$.ajax({
			url: 'penagihan/cek_data_perwptahunv2/cetak',
			type: 'POST',
			data: {
	...
	function tampil() {
		...
		$.ajax({
			url: 'penagihan/cek_data_perwptahunv2/cari',
			type: 'POST',
			data: {
				rekening: $("#TREKENINGSUB_KODE").val()
				, TBLPENDATAAN_THNPAJAK: $("#masapajak_tahun").val()
	...
	// 	}
	// 	);
	// 	window.open('<?= Yii::app()->getBaseUrl(1); ?>/penagihan/cek_data_perwptahunv2/cetak?' + param);
	// }
	...
	function cetak(jenis) {
		...
		window.open(URL_APLIKASI+"/penagihan/cek_data_perwptahunv2/cetak?jenis="+jenis+"&TBLPENDATAAN_THNPAJAK="+window.TBLPENDATAAN_THNPAJAK+"&TBLDAFTAR_NOPOK="+window.TBLDAFTAR_NOPOK+"&rekening="+window.rekening);

...
<section id="widget-grid" class="">
							...
							<form id="form_sumber_pajak" class="smart-form" novalidate="">
								<fieldset>
									<div class="row">
										...
										<section class="col col-md-2">
											<label class="input">
												<input type="number" value="<?php echo date('Y'); ?>" class="form-control" type="text" id="masapajak" name="masapajak" autocomplete="off" maxlength="4">
											</label>
										</section>
										...
										<section class="col col-md-2">
											<label class="input">
												<input type="number" value="<?php echo date('Y'); ?>" class="form-control" type="text" id="masapajak_akhir" name="masapajak_akhir" autocomplete="off" maxlength="4">
											</label>
										</section>
									</div>
									<div class="row">
	...
	<script type="text/javascript">
		...
		function cetak () {
			...
			window.masapajak_akhir = $('#masapajak_akhir').val();
			...
			window.open(window.APP_URL+'/penagihan/Daftar_tunggakan/cetak?masapajak='+window.masapajak+'&TBLREKENING_KODE='+window.TBLREKENING_KODE+'&REFKECAMATAN_ID='+window.REFKECAMATAN_ID+'&JALAN='+window.JALAN+'&cara_penetapan='+window.cara_penetapan+'&masapajak_akhir='+window.masapajak_akhir);
		}
	</script>
...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Daftar Induk WP/WR</h4>
		</div>
	</div>
</div>
								...
								<div class="row">
									...
									<!-- <section class="col col-md-4">
										<label class="input"> <i class="icon-append fa fa-calendar"></i>
											<input type="text" name="param[TBLDAFTAR_TANGGALKUKUH]" class="datepicker " data-dateformat="dd/mm/yy" id="TBLDAFTAR_TANGGALKUKUH">
										</label>
									</section> -->
									<section class="col col-md-2">
										<label class="input">
									...
									<section class="col col-md-2">
										...
										<?php $data['listbulan'] = array('Januari','Februari','Maret','April','Mei','Juni','Juli','Agustus','September','Oktober','November','Desember'); ?>
											...
											<!-- <input type="text" placeholder="Isikan Bulan" name="param[TBLDAFTAR_BULANKUKUH]" id="TBLDAFTAR_BULANKUKUH"> -->
										</label>
									</section>
									<section class="col col-md-2">
										<label class="input">
											<!-- <input type="number" value="<?php echo date('Y'); ?>" class="form-control" placeholder="Isikan Tahun" name="param[TBLDAFTAR_TAHUNKUKUH]" id="TBLDAFTAR_TAHUNKUKUH"> -->
											<input type="text" placeholder="Isikan Tahun, Contoh:18" name="param[TBLDAFTAR_TAHUNKUKUH]" id="TBLDAFTAR_TAHUNKUKUH">
										</label>
									</section>
								</div>
							</fieldset>		
					...
					<div>
						...
						<p class="alert alert-info"> 
							...
							<!-- <button type="button" class="btn btn-default" onclick="cetak_daftarWord()">
								<i class="fa fa-print"></i> Cetak Rekap Pengukuhan
							</button>	
...
<script type="text/javascript">
	...
	function generateAutocompleteWP() {
		$('#TBLDAFTAR_NOPOK').autocomplete({
			serviceUrl: 'penagihan/daftar_indukwpwr/autocompletewp',
	...
	function cari() {
			...
			$.ajax({
				url: 'penagihan/daftar_indukwpwr/GetData',
				type: 'POST',
				data:  {
	...
	function cetak() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/penagihan/daftar_indukwpwr/cetak?' + param);
	}
	...
	function cetak_daftarWord() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/penagihan/daftar_indukwpwr/cetakWord?' + param);
	}
	...
	function cetak_status() {
		...
		window.open('<?= Yii::app()->getBaseUrl(1); ?>/penagihan/daftar_indukwpwr/cetak_status?' + param);
	}
	...
	function loadDataTable() {
		...
		$.ajax({
			url: 'penagihan/daftar_indukwpwr/cari',
			type: 'POST',
	...
	function setRekening(val) {
		$.ajax({
			url: 'penagihan/daftar_indukwpwr/setRekening',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function getKelurahan(val) {
		$.ajax({
			url: 'penagihan/daftar_indukwpwr/getKelurahan',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function getKelurahanedit(val) {
		$.ajax({
			url: 'penagihan/daftar_indukwpwr/getKelurahanedit',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function getKelurahanedit2(val) {
		$.ajax({
			url: 'penagihan/daftar_indukwpwr/getKelurahanedit2',
			type: 'POST',
			dataType: 'html',
			data: {value: val},
			success: function(respon) {
	...
	function simpan () {
		$.ajax({
			url: 'penagihan/daftar_indukwpwr/Simpan',
			type: 'post',
			dataType: "json",

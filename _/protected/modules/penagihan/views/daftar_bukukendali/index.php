...
<script type="text/javascript">
  ...
  function cetak () {
        ...
        window.open(window.APP_URL+'/penagihan/Daftar_bukukendali/cetak?masapajak='+window.masapajak+'&TBLREKENING_KODE='+window.TBLREKENING_KODE+'&cara_penetapan='+window.cara_penetapan+'&TBLKECAMATAN_ID='+window.TBLKECAMATAN_ID+'&JALAN='+window.JALAN+'&bulan='+window.bulan+'&cutoff='+window.cutoff);
      }
  }    

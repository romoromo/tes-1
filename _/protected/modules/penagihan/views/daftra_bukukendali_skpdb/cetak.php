...
<!-- SKPD A -->
 <table width="100%" border="1" style="border-collapse:collapse;" cellpadding="0" cellspacing="0" class="table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" >
                <thead>
                <tr>
                <th colspan="17" style="text-align-last:left;">BUKU KENDALI SKPD ANGSUR  <?php echo $data['judul'] ?> TAHUN <?php echo  $tahunpjk = $_REQUEST['tahunpjk'] ?> <br>
                ...
                <?php $no=1; foreach ($data['skpdb'] as $list) :?>
                  <tr>

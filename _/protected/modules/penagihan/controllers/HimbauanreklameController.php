		...
		foreach ($data['simpan'] as $kolom) :
			...
			try {
				...
				if (empty($himbauanid)) {
					...
					$inserthistori = "INSERT INTO TBLHIMBAUAN (THP, BLP, HRP, KE, NOPOK, NOHIMBAUAN, TGLHIMBAUAN, NAMA_WP, ALAMAT, NPWPD, JENIS, STATUS_DATA, TBLPENGGUNA_ID) 
						VALUES (
						" . $kolom['TBLPENDATAAN_THNPAJAK'] . ",
						" . $kolom['TBLPENDATAAN_BLNPAJAK'] . ",
						" . $kolom['TBLPENDATAAN_TGLPAJAK'] . ",
						" . $kolom['TBLPENDATAAN_PAJAKKE'] . ",

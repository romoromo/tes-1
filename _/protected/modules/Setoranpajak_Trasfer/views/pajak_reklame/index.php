...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i>  Entri Setoran Transfer Pajak Reklame</h4>
		</div>
	</div>
</div>
...
<section id="widget-grid" class="">
	...
	<div class="row">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget jarviswidget-color-teal" id="wid-896da6s879d8id-pajak_reklame" 
					...
					<form action="" id="form_sumber_pajak" class="smart-form" novalidate>
						<fieldset>
							...
							<div class="row">
								...
								<section class="col col-md-2">
									<label class="input">
										<input class="input-sm" type="number" value="" id="tgl" name="tgl">
									</label>
								</section>
							</div>
							<div class="row">
...
<script type="text/javascript">
	...
	function cari() {
		...
		$("#btnCetakSSPD").hide();
		$.ajax({
			url: 'Setoranpajak_Trasfer/pajak_reklame/getdata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun : $('#tahun').val(),
...
function simpan() {
	...
	if (NOMOR_SSPD=='') {
		...
		$.ajax({
			url: 'Setoranpajak_Trasfer/pajak_reklame/simpandata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun : $('#tahun').val(),
...
function cetakSSPD() {
	...
	window.open('Setoranpajak_Trasfer/pajak_reklame/cetakSSPD/?'+jQuery.param(param));
}

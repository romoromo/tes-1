...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i> Entri Setoran Transfer Pajak Restoran</h4>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	...
	function generateAutocompleteWP() {
		$('#nopok').autocomplete({
			serviceUrl: 'Setoranpajak_Trasfer/pajak_restoran/autocomplete',
	...
	function cari() {
		...
		$.ajax({
			url: 'Setoranpajak_Trasfer/pajak_restoran/getdata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun: $('#tahun').val(),
			...
			success: function(respon) {
				/*if (respon.model.TOTALOMZET<500000) {
				...
				if (respon.data.validate == 'kurang') {
					...
					if (respon.model.<?php echo $this->namatabel; ?>_THNKURANGBAYAR) {
						...
						var tanggalbataskurangbayar = respon.model.<?php echo $this->namatabel; ?>_TGLBTSKRGBAYAR;
						...
						viewtanggalbataskurangbayar = isikiri(tanggalbataskurangbayar, "00");
						...
						$('#<?php echo $this->namatabel; ?>_TGLBTSKRGBAYAR').val(viewtanggalbataskurangbayar + '-' + viewbulanbataskurangbayar + '-' + viewtahunbataskurangbayar);
					} else {
	...
	function simpan() {
		...
		if (NOMOR_SSPD == '') {
			...
			$.ajax({
					url: 'Setoranpajak_Trasfer/pajak_restoran/simpandata',
					type: 'POST',
					dataType: 'json',
					data: {
						tahun: $('#tahun').val(),
	...
	function getrekening(kode) {
		$.ajax({
			url: 'Setoranpajak_Trasfer/pajak_restoran/getrekening',
			type: 'POST',
			dataType: 'json',
			data: {
				kode: kode,
	...
	function cetakSSPD() {
		...
		window.open('Setoranpajak_Trasfer/pajak_restoran/cetakSSPD/?' + jQuery.param(param));
	}
</script>
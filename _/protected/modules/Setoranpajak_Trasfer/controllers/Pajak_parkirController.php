...
class Pajak_parkirController extends Controller
{
	...
	public function actiongetdata()
	{
		...
		// var_dump($setbpd->params);
			...
			if ($jenis_setoran == 'SPTPD') {
				...
				$TBLSETOR_RUPIAHTAGIHAN = 0;
				$TBLSETOR_BUNGAKETETAPAN = $bunga_setor;
				$TBLSETOR_DENDAKURANGBAYAR = isset($setbpd[$NAMATABEL . 'NAKB']) ? $setbpd[$NAMATABEL . 'NAKB'] : 0;
				$TBLSETOR_DENDAKETETAPAN = (isset($setbpd[$NAMATABEL . 'NAKB']) ? $setbpd[$NAMATABEL . 'NAKB'] : 0) + $dendasetor;
			} elseif ($jenis_setoran == 'STPD') {
				$TBLSETOR_RUPIAHPAJAK = 0;
				$TBLSETOR_RUPIAHSETOR = $pajaksetor;
...
public function CetakWordSSPD($data=array())
{
	...
	$namafileDL = "SSPD-Transfer-Parkir.docx"; 
	...
	$otbs->NoErr = 0;
		...
		if (
			$jenis_setoran == 'STPD' || $jenis_setoran == 'SKPD' || $jenis_setoran == 'SKPDKB'
		) {

...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="well well-sm well-light bg-color-greenLight txt-color-white">
			<h4><i class="fa fa-file-text-o"></i>  Entri Setoran Pajak Reklame Insidentil</h4>
		</div>
	</div>
</div>
					...
					<div class="widget-body no-padding">
						...
						<form action="" id="form_sumber_pajak" class="smart-form" novalidate>
												...
												<div class="row">
													...
													<section class="col col-md-4">
														<label class="input"> <i class="icon-append fa fa-calendar"></i>
															<input disabled="disabled" style="background: #eee;" type="text" name="<?php echo $this->namatabel; ?>_TGLSPTPD" class="datepicker form-control" data-dateformat="dd-mm-yy" id="<?php echo $this->namatabel; ?>_TGLSPTPD">
														</label>
													</section>
													<section class="col col-md-1">Batas</section>
													<section class="col col-md-4">
														<label class="input"> <i class="icon-append fa fa-calendar"></i>
															<input disabled="disabled" style="background: #eee;" type="text" name="<?php echo $this->namatabel; ?>_TGLBATASSPTPD" class="datepicker form-control" data-dateformat="dd-mm-yy" id="<?php echo $this->namatabel; ?>_TGLBATASSPTPD">
														</label>
													</section>
												</div>
												<div class="row">
													...
													<section class="col col-md-9">
														<label class="input">
															<input class="form-control" style="background: #eee;" id="<?php echo $this->namatabel; ?>_URUTSKPD" disabled="disabled" type="text">
														</label>
													</section>
												</div>
												<div class="row">
													...
													<section class="col col-md-9">
														<label class="input">
															<input class="form-control" style="background: #eee;" id="<?php echo $this->namatabel; ?>_BUNGASPTPD" disabled="disabled" type="text">
														</label>
													</section>
												</div>
												<div class="row">
													...
													<section class="col col-md-9">
														<label class="input">
															<input class="form-control" style="background: #eee;" id="<?php echo $this->namatabel; ?>_PAJAK" disabled="disabled" type="text">
														</label>
													</section>
												</div>
											</div>
										...
										<div class="col-md-6">
											...
											<div  style="padding: 3%;">
												<div class="row">
													...
													<section class="col col-md-4">
														<label class="input"> <i class="icon-append fa fa-calendar"></i>
															<input disabled="disabled" type="text" style="background: #eee;" name="request" class="datepicker form-control" data-dateformat="dd-mm-yy" id="<?php echo $this->namatabel; ?>_TGLSURATTAGIHAN">
														</label>
													</section>
												</div>
												<div class="row">
													...
													<section class="col col-md-9">
														<label class="input">
															<input class="form-control" style="background: #eee;" disabled="disabled" type="text" id="<?php echo $this->namatabel; ?>_NOSURATTAGIHAN">
														</label>
													</section>
												</div>
												<div class="row">
													...
													<section class="col col-md-9">
														<label class="input">
															<input class="form-control" style="background: #eee;" disabled="disabled" id="<?php echo $this->namatabel; ?>_BUNGATAGIHAN" type="text">
														</label>
													</section>
												</div>
												<div class="row">
													...
													<section class="col col-md-9">
														<label class="input">
															<input class="form-control" style="background: #eee;" disabled="disabled" type="text" id="<?php echo $this->namatabel; ?>_DENDATAGIHAN">
														</label>
													</section>
												</div>
												<div class="row">
													...
													<section class="col col-md-9">
														<label class="input">	
															<input class="form-control" style="background: #eee;" disabled="disabled" type="text" id="<?php echo $this->namatabel; ?>_RUPIAHTAGIHAN">
														</label>
													</section>
												</div>
											</div>
										...
										<div class="col-md-6">
											...
											<div  style="padding: 3%;">
												<div class="row">
													...
													<section class="col col-md-4">
														<label class="input">
															<input type="text" style="background: #eee;" class="form-control" disabled="disabled" id="<?php echo $this->namatabel; ?>_TIPESETOR">
														</label>
													</section>
												...
												<div class="row">
													...
													<section class="col col-md-4">
														<label class="input">
															<input class="form-control" id="<?php echo $this->namatabel; ?>_TANGGALSETOR" disabled="disabled" style="background: #eee;" type="text">
														</label>
													</section>
												</div>
												<div class="row">
													...
													<section class="col col-md-10">
														<label class="input">	
															<input class="form-control" style="background: #eee;" disabled="disabled" id="bungasetor"  type="text">
														</label>
													</section>
												</div>
												<div class="row">
													...
													<section class="col col-md-10">
														<label class="input" >
															<input class="form-control" style="background: #eee;" disabled="disabled" id="dendasetor" type="text">
														</label>
													</section>
												</div>
												<div class="row">
													...
													<section class="col col-md-10">
														<label class="input">
															<input class="form-control" style="background: #eee;" disabled="disabled" id="pajaksetor" type="text">
														</label>
													</section>
												</div>
												<div class="row">
													...
													<section class="col col-md-10">
														<label class="input">
															<input style="background: #eee;" disabled="disabled" class="form-control" id="totalsetor" type="text">
														</label>
													</section>
												</div>
											</div>
										...
										<div class="col-md-6">
											...
											<div  style="padding: 3%;">
												<div class="row">
													...
													<section class="col col-md-4">
														<label class="input"> <i class="icon-append fa fa-calendar"></i>
															<input style="background: #eee;" disabled="disabled" type="text" name="request" class="datepicker form-control" data-dateformat="dd-mm-yy" id="<?php echo $this->namatabel; ?>_TGLKURANGBAYAR">
														</label>
													</section>
												</div>
												<div class="row">
													...
													<section class="col col-md-9">
														<label class="input-sm">	
															<input style="background: #eee;" class="form-control" disabled="disabled" type="text" id="<?php echo $this->namatabel; ?>_REGKURANGBAYAR">
														</label>
													</section>
												</div>
												<div class="row">
													...
													<section class="col col-md-9">
														<label class="input">
															<input style="background: #eee;" class="form-control" disabled="disabled" type="text" id="<?php echo $this->namatabel; ?>_BUNGAKRGBAYAR">
														</label>
													</section>
												</div>
												<div class="row">
													...
													<section class="col col-md-9">
														<label class="input">
															<input style="background: #eee;" class="form-control" disabled="disabled" type="text" id="<?php echo $this->namatabel; ?>_DENDAKRGBAYAR">
														</label>
													</section>
												</div>
												<div class="row">
													...
													<section class="col col-md-9">
														<label class="input">
															<input style="background: #eee;" class="form-control" disabled="disabled" type="text" id="<?php echo $this->namatabel; ?>_RUPIAHKRGBAYAR">
														</label>
													</section>
												</div>
											</div>
										...
										<div class="col col-md-12">
											<div class="row">
												...
												<div class="row">
													...
													<section class="col col-md-4">
														<label class="input"> <i class="icon-append fa fa-calendar"></i>
															<input type="text" class="datepicker" data-dateformat="dd-mm-yy" id="TANGGAL_ENTRY" name="TANGGAL_ENTRY">
														</label>
													</section>
												</div>
												<div class="row">
							...
							<footer id="footer_simpandata">
								<a onclick="simpan()" href="javascript:void(0)" class="btn btn-sm btn-primary" style="float: left;">
...
<script type="text/javascript">
	...
	function generateAutocompleteWPHotel() {
		$('#nopok').autocomplete({
			serviceUrl: 'penyetoran/entrisetoranpajakreklameinsidentil/autocomplete',
			...
			onSelect: function (suggestion) {
		        ...
		        window.alamat = suggestion.TBLDAFTAR_PEMILIKALAMAT;
	...
	function cari() {
		$.ajax({
			url: 'penyetoran/entrisetoranpajakreklameinsidentil/getdata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun : $('#tahun').val(),
			...
			success:function (respon) {
				if (respon.data.validate=='kurang') {
					...
					if(respon.model.<?php echo $this->namatabel; ?>_TAHUNSETOR) {
						var tahunsetor = respon.model.<?php echo $this->namatabel; ?>_TAHUNSETOR;
						var bulansetor = respon.model.<?php echo $this->namatabel; ?>_BULANSETOR;
						if(tahunsetor.length==1) {
							var viewtahunsetor = '200'+tahunsetor;
						} else {
							var viewtahunsetor = '20'+tahunsetor;
						}
						if(bulansetor.length==1) {
							var viewbulansetor = '0'+bulansetor;
						} else {
							var viewbulansetor = bulansetor;
						}
						...
						$('#<?php echo $this->namatabel; ?>_TANGGALSETOR').val('');
					}
					...
					if (respon.data.exist=='ada') {
						...
						if(respon.model.<?php echo $this->namatabel; ?>_TAHUNSETOR) {
							$('#TANGGAL_ENTRY').val(respon.model.<?php echo $this->namatabel; ?>_TANGGALSETOR+'-'+viewbulansetor+'-'+viewtahunsetor);
						} else {
							$('#TANGGAL_ENTRY').val('');
						}
	...
	function simpan() {
		$.ajax({
			url: 'penyetoran/entrisetoranpajakreklameinsidentil/simpandata',
			type: 'POST',
			dataType: 'json',
			data: {
				tahun : $('#tahun').val(),
	...
	function getrekening(kode) {
		$.ajax({
			url: 'penyetoran/entrisetoranpajakreklameinsidentil/getrekening',
			type: 'POST',
			dataType: 'json',
			data: {
				kode : kode,

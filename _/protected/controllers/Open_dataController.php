...
class Open_dataController extends Controller
{
	...
	public function actionget()
	{
		...
		$allowedMods = array(
			...
			,'kabkota_by_provbu' => 'kabkota_by_provbu'
			,'kec_by_kabkota' => 'kec_by_kabkota'
			,'kec_by_kabkotabu' => 'kec_by_kabkotabu'
			,'kel_by_kec' => 'kel_by_kec'
			,'kel_by_kecbu' => 'kel_by_kecbu'
	...
	public static function kabkota_by_provbu()
	{
		$select = '*';
		$from = 'TBLKABUPATEN';
		$filter = array(
	...
	public static function kec_by_kabkotabu()
	{
		$select = '*';
		$from = 'TBLKECAMATAN';
		$filter = array(
	...
	public static function kel_by_kecbu()
	{
		$select = '*';
		$from = 'TBLKELURAHAN';
		$filter = array(

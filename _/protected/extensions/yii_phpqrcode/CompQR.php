...
class CompQR extends CApplicationComponent
{
    public function tes($txt = '')
    {
        return strtoupper('UPPER ' . $txt);
    }
    ...
    public function create($data_string, $output = null) {
        ...
        // var_dump($this->image_path, file_exists($this->image_path));exit;
        $this->image_path = str_replace('qrv9.png/qrv9.png', 'qrv9.png', $this->image_path);
        $this->image_path = str_replace('qrv12.png/qrv12.png', 'qrv12.png', $this->image_path);
